	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001f9:	e8 82 1a 00 00       	call   801c80 <__umoddi3>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002fd:	ff 24 85 40 1f 80 00 	jmp    *0x801f40(,%eax,4)
  ...
  8003c1:	8b 14 85 a0 20 80 00 	mov    0x8020a0(,%eax,4),%edx
  8003c8:	85 d2                	test   %edx,%edx
  8003ca:	75 18                	jne    8003e4 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003cc:	50                   	push   %eax
  8003cd:	68 10 1e 80 00       	push   $0x801e10
  8003d2:	53                   	push   %ebx
  8003d3:	56                   	push   %esi
  ...
  8003e4:	52                   	push   %edx
  8003e5:	68 d1 21 80 00       	push   $0x8021d1
  8003ea:	53                   	push   %ebx
  8003eb:	56                   	push   %esi
  ...
  800409:	b8 09 1e 80 00       	mov    $0x801e09,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a84:	68 ff 20 80 00       	push   $0x8020ff
  800a89:	6a 23                	push   $0x23
  800a8b:	68 1c 21 80 00       	push   $0x80211c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b05:	68 ff 20 80 00       	push   $0x8020ff
  800b0a:	6a 23                	push   $0x23
  800b0c:	68 1c 21 80 00       	push   $0x80211c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b47:	68 ff 20 80 00       	push   $0x8020ff
  800b4c:	6a 23                	push   $0x23
  800b4e:	68 1c 21 80 00       	push   $0x80211c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b89:	68 ff 20 80 00       	push   $0x8020ff
  800b8e:	6a 23                	push   $0x23
  800b90:	68 1c 21 80 00       	push   $0x80211c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bcb:	68 ff 20 80 00       	push   $0x8020ff
  800bd0:	6a 23                	push   $0x23
  800bd2:	68 1c 21 80 00       	push   $0x80211c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c0d:	68 ff 20 80 00       	push   $0x8020ff
  800c12:	6a 23                	push   $0x23
  800c14:	68 1c 21 80 00       	push   $0x80211c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c4f:	68 ff 20 80 00       	push   $0x8020ff
  800c54:	6a 23                	push   $0x23
  800c56:	68 1c 21 80 00       	push   $0x80211c
...
sys_ipc_recv(void *dstva)
{
  ...
  800cb3:	68 ff 20 80 00       	push   $0x8020ff
  800cb8:	6a 23                	push   $0x23
  800cba:	68 1c 21 80 00       	push   $0x80211c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800da1:	ba a8 21 80 00       	mov    $0x8021a8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800dcc:	51                   	push   %ecx
  800dcd:	50                   	push   %eax
  800dce:	68 2c 21 80 00       	push   $0x80212c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800ff6:	53                   	push   %ebx
  800ff7:	50                   	push   %eax
  800ff8:	68 6d 21 80 00       	push   $0x80216d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8010cb:	53                   	push   %ebx
  8010cc:	50                   	push   %eax
  8010cd:	68 89 21 80 00       	push   $0x802189
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801180:	53                   	push   %ebx
  801181:	50                   	push   %eax
  801182:	68 4c 21 80 00       	push   $0x80214c
...
fsipc(unsigned type, void *dstva)
{
  ...
  801292:	e8 44 08 00 00       	call   801adb <ipc_find_env>
  ...
  8012ad:	e8 d5 07 00 00       	call   801a87 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8013d6:	68 b8 21 80 00       	push   $0x8021b8
  8013db:	68 bf 21 80 00       	push   $0x8021bf
  8013e0:	6a 7c                	push   $0x7c
  8013e2:	68 d4 21 80 00       	push   $0x8021d4
  8013e7:	e8 bd 05 00 00       	call   8019a9 <_panic>
	assert(r <= PGSIZE);
  8013ec:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8013f1:	7e 16                	jle    801409 <devfile_read+0x65>
  8013f3:	68 df 21 80 00       	push   $0x8021df
  8013f8:	68 bf 21 80 00       	push   $0x8021bf
  8013fd:	6a 7d                	push   $0x7d
  8013ff:	68 d4 21 80 00       	push   $0x8021d4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8014e2:	68 eb 21 80 00       	push   $0x8021eb
  8014e7:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80155e:	e8 b1 05 00 00       	call   801b14 <pageref>
  801563:	89 c3                	mov    %eax,%ebx
  801565:	89 3c 24             	mov    %edi,(%esp)
  801568:	e8 a7 05 00 00       	call   801b14 <pageref>
  ...
  801592:	50                   	push   %eax
  801593:	56                   	push   %esi
  801594:	68 f2 21 80 00       	push   $0x8021f2
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801836:	68 0a 22 80 00       	push   $0x80220a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8019c5:	56                   	push   %esi
  8019c6:	50                   	push   %eax
  8019c7:	68 18 22 80 00       	push   $0x802218
  ...
  8019d8:	e8 25 e7 ff ff       	call   800102 <vcprintf>
	cprintf("\n");
  8019dd:	c7 04 24 ec 1d 80 00 	movl   $0x801dec,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a42:	68 00 00 c0 ee       	push   $0xeec00000
  801a47:	e8 3f f2 ff ff       	call   800c8b <sys_ipc_recv>
  801a4c:	89 c2                	mov    %eax,%edx
		if (from_env_store) {
  801a4e:	83 c4 10             	add    $0x10,%esp
  801a51:	85 f6                	test   %esi,%esi
  801a53:	74 13                	je     801a68 <ipc_recv+0x79>
			*from_env_store = (r == 0) ? (thisenv->env_ipc_from) : 0;
  801a55:	b8 00 00 00 00       	mov    $0x0,%eax
  801a5a:	85 d2                	test   %edx,%edx
  801a5c:	75 08                	jne    801a66 <ipc_recv+0x77>
  ...
  801a6a:	74 06                	je     801a72 <ipc_recv+0x83>
			*perm_store = 0;
  ...
  801a76:	75 08                	jne    801a80 <ipc_recv+0x91>
		// system call fails, return the error
		return r;
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a99:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;
  801a9b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801aa0:	0f 44 d8             	cmove  %eax,%ebx

	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801aa3:	eb 1c                	jmp    801ac1 <ipc_send+0x3a>
		if (r != -E_IPC_NOT_RECV) {
  801aa5:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801aa8:	74 12                	je     801abc <ipc_send+0x35>
			panic("Sys ipc try send error: %e", r);
  801aaa:	50                   	push   %eax
  801aab:	68 3c 22 80 00       	push   $0x80223c
  801ab0:	6a 4f                	push   $0x4f
  801ab2:	68 57 22 80 00       	push   $0x802257
  801ab7:	e8 ed fe ff ff       	call   8019a9 <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801abc:	e8 fb ef ff ff       	call   800abc <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
  ...
  801ac5:	56                   	push   %esi
  801ac6:	57                   	push   %edi
  801ac7:	e8 9c f1 ff ff       	call   800c68 <sys_ipc_try_send>
  801acc:	83 c4 10             	add    $0x10,%esp
  801acf:	85 c0                	test   %eax,%eax
  801ad1:	78 d2                	js     801aa5 <ipc_send+0x1e>
...
ipc_find_env(enum EnvType type)
{
  ...
  801af4:	75 0d                	jne    801b03 <ipc_find_env+0x28>
			return envs[i].env_id;
  801af6:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801af9:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801afe:	8b 40 48             	mov    0x48(%eax),%eax
  801b01:	eb 0f                	jmp    801b12 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801b06:	3d 00 04 00 00       	cmp    $0x400,%eax
  801b0b:	75 d9                	jne    801ae6 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  801b1c:	c1 e8 16             	shr    $0x16,%eax
  801b1f:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801b2b:	f6 c1 01             	test   $0x1,%cl
  801b2e:	74 1d                	je     801b4d <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801b30:	c1 ea 0c             	shr    $0xc,%edx
  801b33:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801b3a:	f6 c2 01             	test   $0x1,%dl
  801b3d:	74 0e                	je     801b4d <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801b3f:	c1 ea 0c             	shr    $0xc,%edx
  801b42:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801b49:	ef 
  801b4a:	0f b7 c0             	movzwl %ax,%eax
}
  801b4d:	5d                   	pop    %ebp
  801b4e:	c3                   	ret    
  801b4f:	90                   	nop

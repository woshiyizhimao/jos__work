...
fsipc(unsigned type, void *dstva)
{
  ...
  80090d:	e8 a3 11 00 00       	call   801ab5 <ipc_find_env>
  ...
  800928:	e8 34 11 00 00       	call   801a61 <ipc_send>
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b5d:	68 b7 1e 80 00       	push   $0x801eb7
  800b62:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800bd9:	e8 10 0f 00 00       	call   801aee <pageref>
  800bde:	89 c3                	mov    %eax,%ebx
  800be0:	89 3c 24             	mov    %edi,(%esp)
  800be3:	e8 06 0f 00 00       	call   801aee <pageref>
  ...
  800c0d:	50                   	push   %eax
  800c0e:	56                   	push   %esi
  800c0f:	68 be 1e 80 00       	push   $0x801ebe
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800eb1:	68 d6 1e 80 00       	push   $0x801ed6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801040:	56                   	push   %esi
  801041:	50                   	push   %eax
  801042:	68 e4 1e 80 00       	push   $0x801ee4
  ...
  801053:	e8 54 00 00 00       	call   8010ac <vcprintf>
	cprintf("\n");
  801058:	c7 04 24 cf 1e 80 00 	movl   $0x801ecf,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801160:	e8 cb 09 00 00       	call   801b30 <__udivdi3>
  ...
  8011a3:	e8 b8 0a 00 00       	call   801c60 <__umoddi3>
  8011a8:	83 c4 14             	add    $0x14,%esp
  8011ab:	0f be 80 07 1f 80 00 	movsbl 0x801f07(%eax),%eax
  8011b2:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8012a7:	ff 24 85 40 20 80 00 	jmp    *0x802040(,%eax,4)
  ...
  80136b:	8b 14 85 a0 21 80 00 	mov    0x8021a0(,%eax,4),%edx
  801372:	85 d2                	test   %edx,%edx
  801374:	75 18                	jne    80138e <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  801376:	50                   	push   %eax
  801377:	68 1f 1f 80 00       	push   $0x801f1f
  80137c:	53                   	push   %ebx
  80137d:	56                   	push   %esi
  ...
  80138e:	52                   	push   %edx
  80138f:	68 9d 1e 80 00       	push   $0x801e9d
  801394:	53                   	push   %ebx
  801395:	56                   	push   %esi
  ...
  8013b3:	b8 18 1f 80 00       	mov    $0x801f18,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a1c:	68 00 00 c0 ee       	push   $0xeec00000
  801a21:	e8 e0 e8 ff ff       	call   800306 <sys_ipc_recv>
  801a26:	89 c2                	mov    %eax,%edx
		if (from_env_store) {
  801a28:	83 c4 10             	add    $0x10,%esp
  801a2b:	85 f6                	test   %esi,%esi
  801a2d:	74 13                	je     801a42 <ipc_recv+0x79>
			*from_env_store = (r == 0) ? (thisenv->env_ipc_from) : 0;
  801a2f:	b8 00 00 00 00       	mov    $0x0,%eax
  801a34:	85 d2                	test   %edx,%edx
  801a36:	75 08                	jne    801a40 <ipc_recv+0x77>
  ...
  801a44:	74 06                	je     801a4c <ipc_recv+0x83>
			*perm_store = 0;
  801a46:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
		}
	}
  ...
  801a4c:	89 d0                	mov    %edx,%eax
	...
	if (r)
  801a4e:	85 d2                	test   %edx,%edx
  801a50:	75 08                	jne    801a5a <ipc_recv+0x91>
		// system call fails, return the error
		return r;
  ...
  801a57:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a6d:	8b 75 0c             	mov    0xc(%ebp),%esi
  ...
  801a73:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;
  801a75:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801a7a:	0f 44 d8             	cmove  %eax,%ebx

	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801a7d:	eb 1c                	jmp    801a9b <ipc_send+0x3a>
		if (r != -E_IPC_NOT_RECV) {
  801a7f:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801a82:	74 12                	je     801a96 <ipc_send+0x35>
			panic("Sys ipc try send error: %e", r);
  801a84:	50                   	push   %eax
  801a85:	68 00 22 80 00       	push   $0x802200
  801a8a:	6a 4f                	push   $0x4f
  801a8c:	68 1b 22 80 00       	push   $0x80221b
  801a91:	e8 8e f5 ff ff       	call   801024 <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801a96:	e8 9c e6 ff ff       	call   800137 <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
  ...
  801a9f:	56                   	push   %esi
  801aa0:	57                   	push   %edi
  801aa1:	e8 3d e8 ff ff       	call   8002e3 <sys_ipc_try_send>
  801aa6:	83 c4 10             	add    $0x10,%esp
  801aa9:	85 c0                	test   %eax,%eax
  801aab:	78 d2                	js     801a7f <ipc_send+0x1e>
...
ipc_find_env(enum EnvType type)
{
  ...
  801ac0:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801ac3:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801ac9:	8b 52 50             	mov    0x50(%edx),%edx
  801acc:	39 ca                	cmp    %ecx,%edx
  801ace:	75 0d                	jne    801add <ipc_find_env+0x28>
			return envs[i].env_id;
  801ad0:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801ad3:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801ad8:	8b 40 48             	mov    0x48(%eax),%eax
  801adb:	eb 0f                	jmp    801aec <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
...
pageref(void *v)
{
  ...
  801af1:	8b 55 08             	mov    0x8(%ebp),%edx
	pte_t pte;

	if (!(uvpd[PDX(v)] & PTE_P))
  801af4:	89 d0                	mov    %edx,%eax
  801af6:	c1 e8 16             	shr    $0x16,%eax
  801af9:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801b05:	f6 c1 01             	test   $0x1,%cl
  801b08:	74 1d                	je     801b27 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801b0a:	c1 ea 0c             	shr    $0xc,%edx
  801b0d:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801b14:	f6 c2 01             	test   $0x1,%dl
  801b17:	74 0e                	je     801b27 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801b19:	c1 ea 0c             	shr    $0xc,%edx
  801b1c:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801b23:	ef 
  801b24:	0f b7 c0             	movzwl %ax,%eax
}
  801b27:	5d                   	pop    %ebp
  801b28:	c3                   	ret    

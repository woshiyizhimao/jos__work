...
fsipc(unsigned type, void *dstva)
{
  ...
  800921:	e8 a3 11 00 00       	call   801ac9 <ipc_find_env>
  ...
  80093c:	e8 34 11 00 00       	call   801a75 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a71:	68 cc 1e 80 00       	push   $0x801ecc
  800a76:	e8 bd 05 00 00       	call   801038 <_panic>
	assert(r <= PGSIZE);
  800a7b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800a80:	7e 16                	jle    800a98 <devfile_read+0x65>
  800a82:	68 d7 1e 80 00       	push   $0x801ed7
  800a87:	68 b7 1e 80 00       	push   $0x801eb7
  800a8c:	6a 7d                	push   $0x7d
  800a8e:	68 cc 1e 80 00       	push   $0x801ecc
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b71:	68 e3 1e 80 00       	push   $0x801ee3
  800b76:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800bed:	e8 10 0f 00 00       	call   801b02 <pageref>
  800bf2:	89 c3                	mov    %eax,%ebx
  800bf4:	89 3c 24             	mov    %edi,(%esp)
  800bf7:	e8 06 0f 00 00       	call   801b02 <pageref>
  ...
  800c21:	50                   	push   %eax
  800c22:	56                   	push   %esi
  800c23:	68 ea 1e 80 00       	push   $0x801eea
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ec5:	68 02 1f 80 00       	push   $0x801f02
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801054:	56                   	push   %esi
  801055:	50                   	push   %eax
  801056:	68 10 1f 80 00       	push   $0x801f10
  ...
  801067:	e8 54 00 00 00       	call   8010c0 <vcprintf>
	cprintf("\n");
  80106c:	c7 04 24 fb 1e 80 00 	movl   $0x801efb,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801174:	e8 c7 09 00 00       	call   801b40 <__udivdi3>
  ...
  8011b7:	e8 b4 0a 00 00       	call   801c70 <__umoddi3>
  8011bc:	83 c4 14             	add    $0x14,%esp
  8011bf:	0f be 80 33 1f 80 00 	movsbl 0x801f33(%eax),%eax
  8011c6:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8012bb:	ff 24 85 80 20 80 00 	jmp    *0x802080(,%eax,4)
  ...
  80137f:	8b 14 85 e0 21 80 00 	mov    0x8021e0(,%eax,4),%edx
  801386:	85 d2                	test   %edx,%edx
  801388:	75 18                	jne    8013a2 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  80138a:	50                   	push   %eax
  80138b:	68 4b 1f 80 00       	push   $0x801f4b
  801390:	53                   	push   %ebx
  801391:	56                   	push   %esi
  ...
  8013a2:	52                   	push   %edx
  8013a3:	68 c9 1e 80 00       	push   $0x801ec9
  8013a8:	53                   	push   %ebx
  8013a9:	56                   	push   %esi
  ...
  8013c7:	b8 44 1f 80 00       	mov    $0x801f44,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8019f2:	50                   	push   %eax
  8019f3:	e8 22 e9 ff ff       	call   80031a <sys_ipc_recv>
  ...
  801a35:	e8 e0 e8 ff ff       	call   80031a <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a98:	50                   	push   %eax
  801a99:	68 40 22 80 00       	push   $0x802240
  801a9e:	6a 4f                	push   $0x4f
  801aa0:	68 5b 22 80 00       	push   $0x80225b
  801aa5:	e8 8e f5 ff ff       	call   801038 <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801aaa:	e8 9c e6 ff ff       	call   80014b <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
  ...
  801ab3:	56                   	push   %esi
  801ab4:	57                   	push   %edi
  801ab5:	e8 3d e8 ff ff       	call   8002f7 <sys_ipc_try_send>

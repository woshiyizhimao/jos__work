...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8013c4:	68 d8 21 80 00       	push   $0x8021d8
  8013c9:	68 df 21 80 00       	push   $0x8021df
  8013ce:	6a 7c                	push   $0x7c
  8013d0:	68 f4 21 80 00       	push   $0x8021f4
  8013d5:	e8 bd 05 00 00       	call   801997 <_panic>
	assert(r <= PGSIZE);
  8013da:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8013df:	7e 16                	jle    8013f7 <devfile_read+0x65>
  8013e1:	68 ff 21 80 00       	push   $0x8021ff
  8013e6:	68 df 21 80 00       	push   $0x8021df
  8013eb:	6a 7d                	push   $0x7d
  8013ed:	68 f4 21 80 00       	push   $0x8021f4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8014d0:	68 0b 22 80 00       	push   $0x80220b
  8014d5:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801580:	50                   	push   %eax
  801581:	56                   	push   %esi
  801582:	68 12 22 80 00       	push   $0x802212
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801824:	68 2a 22 80 00       	push   $0x80222a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8019b3:	56                   	push   %esi
  8019b4:	50                   	push   %eax
  8019b5:	68 38 22 80 00       	push   $0x802238
  ...
  8019c6:	e8 25 e7 ff ff       	call   8000f0 <vcprintf>
	cprintf("\n");
  8019cb:	c7 04 24 23 22 80 00 	movl   $0x802223,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a98:	50                   	push   %eax
  801a99:	68 5c 22 80 00       	push   $0x80225c
  801a9e:	6a 4f                	push   $0x4f
  801aa0:	68 77 22 80 00       	push   $0x802277

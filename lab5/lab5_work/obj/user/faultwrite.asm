...
fsipc(unsigned type, void *dstva)
{
  ...
  800915:	e8 a3 11 00 00       	call   801abd <ipc_find_env>
  ...
  800930:	e8 34 11 00 00       	call   801a69 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a76:	68 cb 1e 80 00       	push   $0x801ecb
  800a7b:	68 ab 1e 80 00       	push   $0x801eab
  800a80:	6a 7d                	push   $0x7d
  800a82:	68 c0 1e 80 00       	push   $0x801ec0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b65:	68 d7 1e 80 00       	push   $0x801ed7
  800b6a:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800be1:	e8 10 0f 00 00       	call   801af6 <pageref>
  800be6:	89 c3                	mov    %eax,%ebx
  800be8:	89 3c 24             	mov    %edi,(%esp)
  800beb:	e8 06 0f 00 00       	call   801af6 <pageref>
  ...
  800c15:	50                   	push   %eax
  800c16:	56                   	push   %esi
  800c17:	68 de 1e 80 00       	push   $0x801ede
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800eb9:	68 f6 1e 80 00       	push   $0x801ef6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801048:	56                   	push   %esi
  801049:	50                   	push   %eax
  80104a:	68 04 1f 80 00       	push   $0x801f04
  ...
  80105b:	e8 54 00 00 00       	call   8010b4 <vcprintf>
	cprintf("\n");
  801060:	c7 04 24 ef 1e 80 00 	movl   $0x801eef,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801168:	e8 d3 09 00 00       	call   801b40 <__udivdi3>
  ...
  8011ab:	e8 c0 0a 00 00       	call   801c70 <__umoddi3>
  8011b0:	83 c4 14             	add    $0x14,%esp
  8011b3:	0f be 80 27 1f 80 00 	movsbl 0x801f27(%eax),%eax
  8011ba:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8012af:	ff 24 85 60 20 80 00 	jmp    *0x802060(,%eax,4)
  ...
  801373:	8b 14 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%edx
  80137a:	85 d2                	test   %edx,%edx
  80137c:	75 18                	jne    801396 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  80137e:	50                   	push   %eax
  80137f:	68 3f 1f 80 00       	push   $0x801f3f
  801384:	53                   	push   %ebx
  801385:	56                   	push   %esi
  ...
  801396:	52                   	push   %edx
  801397:	68 bd 1e 80 00       	push   $0x801ebd
  80139c:	53                   	push   %ebx
  80139d:	56                   	push   %esi
  ...
  8013bb:	b8 38 1f 80 00       	mov    $0x801f38,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8019e1:	74 3e                	je     801a21 <ipc_recv+0x50>
		r = sys_ipc_recv(pg);
  8019e3:	83 ec 0c             	sub    $0xc,%esp
  8019e6:	50                   	push   %eax
  8019e7:	e8 22 e9 ff ff       	call   80030e <sys_ipc_recv>
  8019ec:	89 c2                	mov    %eax,%edx

		if (from_env_store) {
  8019ee:	83 c4 10             	add    $0x10,%esp
  8019f1:	85 f6                	test   %esi,%esi
  8019f3:	74 13                	je     801a08 <ipc_recv+0x37>
			*from_env_store = (r == 0) ? (thisenv->env_ipc_from) : 0;
  8019f5:	b8 00 00 00 00       	mov    $0x0,%eax
  8019fa:	85 d2                	test   %edx,%edx
  8019fc:	75 08                	jne    801a06 <ipc_recv+0x35>
  8019fe:	a1 04 40 80 00       	mov    0x804004,%eax
  801a03:	8b 40 74             	mov    0x74(%eax),%eax
  801a06:	89 06                	mov    %eax,(%esi)
		}
		if (perm_store) {
  801a08:	85 db                	test   %ebx,%ebx
  801a0a:	74 48                	je     801a54 <ipc_recv+0x83>
			*perm_store = (r == 0) ? (thisenv->env_ipc_perm) : 0;
  801a0c:	b8 00 00 00 00       	mov    $0x0,%eax
  801a11:	85 d2                	test   %edx,%edx
  801a13:	75 08                	jne    801a1d <ipc_recv+0x4c>
  801a15:	a1 04 40 80 00       	mov    0x804004,%eax
  801a1a:	8b 40 78             	mov    0x78(%eax),%eax
  801a1d:	89 03                	mov    %eax,(%ebx)
  801a1f:	eb 33                	jmp    801a54 <ipc_recv+0x83>
		}
	}
	else {
  ...
  801a24:	68 00 00 c0 ee       	push   $0xeec00000
  801a29:	e8 e0 e8 ff ff       	call   80030e <sys_ipc_recv>
  801a2e:	89 c2                	mov    %eax,%edx
		if (from_env_store) {
  801a30:	83 c4 10             	add    $0x10,%esp
  801a33:	85 f6                	test   %esi,%esi
  801a35:	74 13                	je     801a4a <ipc_recv+0x79>
			*from_env_store = (r == 0) ? (thisenv->env_ipc_from) : 0;
  801a37:	b8 00 00 00 00       	mov    $0x0,%eax
  801a3c:	85 d2                	test   %edx,%edx
  801a3e:	75 08                	jne    801a48 <ipc_recv+0x77>
  ...
  801a4c:	74 06                	je     801a54 <ipc_recv+0x83>
			*perm_store = 0;
  801a4e:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
		}
	}
  ...
  801a58:	75 08                	jne    801a62 <ipc_recv+0x91>
		// system call fails, return the error
		return r;
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a7b:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;
  801a7d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  ...
  801a8c:	50                   	push   %eax
  801a8d:	68 20 22 80 00       	push   $0x802220
  801a92:	6a 4f                	push   $0x4f
  801a94:	68 3b 22 80 00       	push   $0x80223b
  801a99:	e8 8e f5 ff ff       	call   80102c <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801a9e:	e8 9c e6 ff ff       	call   80013f <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
  ...
  801aa7:	56                   	push   %esi
  801aa8:	57                   	push   %edi
  801aa9:	e8 3d e8 ff ff       	call   8002eb <sys_ipc_try_send>

...
num(int f, const char *s)
{
  ...
  80005c:	50                   	push   %eax
  80005d:	68 20 20 80 00       	push   $0x802020
  ...
  800090:	68 25 20 80 00       	push   $0x802025
  ...
  8000ae:	00 00 00 
{
  ...
  8000d3:	68 4b 20 80 00       	push   $0x80204b
  8000d8:	6a 18                	push   $0x18
  8000da:	68 40 20 80 00       	push   $0x802040
...
umain(int argc, char **argv)
{
  ...
  800114:	68 64 20 80 00       	push   $0x802064
  ...
  800146:	68 6c 20 80 00       	push   $0x80206c
  80014b:	6a 27                	push   $0x27
  80014d:	68 40 20 80 00       	push   $0x802040
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800201:	56                   	push   %esi
  800202:	50                   	push   %eax
  800203:	68 88 20 80 00       	push   $0x802088
  ...
  800214:	e8 54 00 00 00       	call   80026d <vcprintf>
	cprintf("\n");
  800219:	c7 04 24 a7 24 80 00 	movl   $0x8024a7,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800364:	e8 57 1b 00 00       	call   801ec0 <__umoddi3>
  800369:	83 c4 14             	add    $0x14,%esp
  80036c:	0f be 80 ab 20 80 00 	movsbl 0x8020ab(%eax),%eax
  800373:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800468:	ff 24 85 e0 21 80 00 	jmp    *0x8021e0(,%eax,4)
  ...
  80052c:	8b 14 85 40 23 80 00 	mov    0x802340(,%eax,4),%edx
  800533:	85 d2                	test   %edx,%edx
  800535:	75 18                	jne    80054f <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  800537:	50                   	push   %eax
  800538:	68 c3 20 80 00       	push   $0x8020c3
  80053d:	53                   	push   %ebx
  80053e:	56                   	push   %esi
  ...
  80054f:	52                   	push   %edx
  800550:	68 75 24 80 00       	push   $0x802475
  800555:	53                   	push   %ebx
  800556:	56                   	push   %esi
  ...
  800574:	b8 bc 20 80 00       	mov    $0x8020bc,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bef:	68 9f 23 80 00       	push   $0x80239f
  800bf4:	6a 23                	push   $0x23
  800bf6:	68 bc 23 80 00       	push   $0x8023bc
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c70:	68 9f 23 80 00       	push   $0x80239f
  800c75:	6a 23                	push   $0x23
  800c77:	68 bc 23 80 00       	push   $0x8023bc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cb2:	68 9f 23 80 00       	push   $0x80239f
  800cb7:	6a 23                	push   $0x23
  800cb9:	68 bc 23 80 00       	push   $0x8023bc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cf4:	68 9f 23 80 00       	push   $0x80239f
  800cf9:	6a 23                	push   $0x23
  800cfb:	68 bc 23 80 00       	push   $0x8023bc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d36:	68 9f 23 80 00       	push   $0x80239f
  800d3b:	6a 23                	push   $0x23
  800d3d:	68 bc 23 80 00       	push   $0x8023bc
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d78:	68 9f 23 80 00       	push   $0x80239f
  800d7d:	6a 23                	push   $0x23
  800d7f:	68 bc 23 80 00       	push   $0x8023bc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dba:	68 9f 23 80 00       	push   $0x80239f
  800dbf:	6a 23                	push   $0x23
  800dc1:	68 bc 23 80 00       	push   $0x8023bc
...
sys_ipc_recv(void *dstva)
{
  ...
  800e1e:	68 9f 23 80 00       	push   $0x80239f
  800e23:	6a 23                	push   $0x23
  800e25:	68 bc 23 80 00       	push   $0x8023bc
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800f0c:	ba 4c 24 80 00       	mov    $0x80244c,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800f37:	51                   	push   %ecx
  800f38:	50                   	push   %eax
  800f39:	68 cc 23 80 00       	push   $0x8023cc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801161:	53                   	push   %ebx
  801162:	50                   	push   %eax
  801163:	68 10 24 80 00       	push   $0x802410
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801236:	53                   	push   %ebx
  801237:	50                   	push   %eax
  801238:	68 2c 24 80 00       	push   $0x80242c
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8012eb:	53                   	push   %ebx
  8012ec:	50                   	push   %eax
  8012ed:	68 ec 23 80 00       	push   $0x8023ec
...
fsipc(unsigned type, void *dstva)
{
  ...
  8013fd:	e8 0e 09 00 00       	call   801d10 <ipc_find_env>
  ...
  801418:	e8 9f 08 00 00       	call   801cbc <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801541:	68 5c 24 80 00       	push   $0x80245c
  801546:	68 63 24 80 00       	push   $0x802463
  80154b:	6a 7c                	push   $0x7c
  80154d:	68 78 24 80 00       	push   $0x802478
  801552:	e8 8e ec ff ff       	call   8001e5 <_panic>
	assert(r <= PGSIZE);
  801557:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80155c:	7e 16                	jle    801574 <devfile_read+0x65>
  80155e:	68 83 24 80 00       	push   $0x802483
  801563:	68 63 24 80 00       	push   $0x802463
  801568:	6a 7d                	push   $0x7d
  80156a:	68 78 24 80 00       	push   $0x802478
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80175d:	68 8f 24 80 00       	push   $0x80248f
  801762:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8017d9:	e8 6b 05 00 00       	call   801d49 <pageref>
  8017de:	89 c3                	mov    %eax,%ebx
  8017e0:	89 3c 24             	mov    %edi,(%esp)
  8017e3:	e8 61 05 00 00       	call   801d49 <pageref>
  ...
  80180d:	50                   	push   %eax
  80180e:	56                   	push   %esi
  80180f:	68 96 24 80 00       	push   $0x802496
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801ab1:	68 ae 24 80 00       	push   $0x8024ae
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801c34:	74 3e                	je     801c74 <ipc_recv+0x50>
		r = sys_ipc_recv(pg);
  801c36:	83 ec 0c             	sub    $0xc,%esp
  801c39:	50                   	push   %eax
  801c3a:	e8 b7 f1 ff ff       	call   800df6 <sys_ipc_recv>
  801c3f:	89 c2                	mov    %eax,%edx

		if (from_env_store) {
  801c41:	83 c4 10             	add    $0x10,%esp
  801c44:	85 f6                	test   %esi,%esi
  801c46:	74 13                	je     801c5b <ipc_recv+0x37>
			*from_env_store = (r == 0) ? (thisenv->env_ipc_from) : 0;
  801c48:	b8 00 00 00 00       	mov    $0x0,%eax
  801c4d:	85 d2                	test   %edx,%edx
  801c4f:	75 08                	jne    801c59 <ipc_recv+0x35>
  801c51:	a1 08 40 80 00       	mov    0x804008,%eax
  801c56:	8b 40 74             	mov    0x74(%eax),%eax
  801c59:	89 06                	mov    %eax,(%esi)
		}
		if (perm_store) {
  801c5b:	85 db                	test   %ebx,%ebx
  801c5d:	74 48                	je     801ca7 <ipc_recv+0x83>
			*perm_store = (r == 0) ? (thisenv->env_ipc_perm) : 0;
  801c5f:	b8 00 00 00 00       	mov    $0x0,%eax
  801c64:	85 d2                	test   %edx,%edx
  801c66:	75 08                	jne    801c70 <ipc_recv+0x4c>
  801c68:	a1 08 40 80 00       	mov    0x804008,%eax
  801c6d:	8b 40 78             	mov    0x78(%eax),%eax
  801c70:	89 03                	mov    %eax,(%ebx)
  801c72:	eb 33                	jmp    801ca7 <ipc_recv+0x83>
		}
	}
	else {
  ...
  801c9f:	74 06                	je     801ca7 <ipc_recv+0x83>
			*perm_store = 0;
  801ca1:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
		}
	}
  ...
  801cab:	75 08                	jne    801cb5 <ipc_recv+0x91>
		// system call fails, return the error
		return r;
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801cce:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;
  801cd0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801cd5:	0f 44 d8             	cmove  %eax,%ebx

	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801cd8:	eb 1c                	jmp    801cf6 <ipc_send+0x3a>
		if (r != -E_IPC_NOT_RECV) {
  801cda:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801cdd:	74 12                	je     801cf1 <ipc_send+0x35>
			panic("Sys ipc try send error: %e", r);
  801cdf:	50                   	push   %eax
  801ce0:	68 ba 24 80 00       	push   $0x8024ba
  801ce5:	6a 4f                	push   $0x4f
  801ce7:	68 d5 24 80 00       	push   $0x8024d5
  801cec:	e8 f4 e4 ff ff       	call   8001e5 <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801cf1:	e8 31 ef ff ff       	call   800c27 <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
  ...
  801cfa:	56                   	push   %esi
  801cfb:	57                   	push   %edi
  801cfc:	e8 d2 f0 ff ff       	call   800dd3 <sys_ipc_try_send>
  801d01:	83 c4 10             	add    $0x10,%esp
  801d04:	85 c0                	test   %eax,%eax
  801d06:	78 d2                	js     801cda <ipc_send+0x1e>
...
ipc_find_env(enum EnvType type)
{
  ...
  801d1b:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801d1e:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801d24:	8b 52 50             	mov    0x50(%edx),%edx
  801d27:	39 ca                	cmp    %ecx,%edx
  801d29:	75 0d                	jne    801d38 <ipc_find_env+0x28>
			return envs[i].env_id;
  801d2b:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801d2e:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801d33:	8b 40 48             	mov    0x48(%eax),%eax
  801d36:	eb 0f                	jmp    801d47 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801d3b:	3d 00 04 00 00       	cmp    $0x400,%eax
  801d40:	75 d9                	jne    801d1b <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  801d51:	c1 e8 16             	shr    $0x16,%eax
  801d54:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801d60:	f6 c1 01             	test   $0x1,%cl
  801d63:	74 1d                	je     801d82 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  ...
  801d72:	74 0e                	je     801d82 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801d74:	c1 ea 0c             	shr    $0xc,%edx
  801d77:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801d7e:	ef 
  801d7f:	0f b7 c0             	movzwl %ax,%eax
}
  801d82:	5d                   	pop    %ebp
  801d83:	c3                   	ret    

...
fsipc(unsigned type, void *dstva)
{
  ...
  800d31:	e8 23 0e 00 00       	call   801b59 <ipc_find_env>
  ...
  800d4c:	e8 b4 0d 00 00       	call   801b05 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800e75:	68 28 1f 80 00       	push   $0x801f28
  800e7a:	68 2f 1f 80 00       	push   $0x801f2f
  800e7f:	6a 7c                	push   $0x7c
  800e81:	68 44 1f 80 00       	push   $0x801f44
  800e86:	e8 bd 05 00 00       	call   801448 <_panic>
	assert(r <= PGSIZE);
  800e8b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800e90:	7e 16                	jle    800ea8 <devfile_read+0x65>
  800e92:	68 4f 1f 80 00       	push   $0x801f4f
  800e97:	68 2f 1f 80 00       	push   $0x801f2f
  800e9c:	6a 7d                	push   $0x7d
  800e9e:	68 44 1f 80 00       	push   $0x801f44
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f81:	68 5b 1f 80 00       	push   $0x801f5b
  800f86:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800ffd:	e8 90 0b 00 00       	call   801b92 <pageref>
  801002:	89 c3                	mov    %eax,%ebx
  801004:	89 3c 24             	mov    %edi,(%esp)
  801007:	e8 86 0b 00 00       	call   801b92 <pageref>
  ...
  801031:	50                   	push   %eax
  801032:	56                   	push   %esi
  801033:	68 62 1f 80 00       	push   $0x801f62
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8012d5:	68 7a 1f 80 00       	push   $0x801f7a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801464:	56                   	push   %esi
  801465:	50                   	push   %eax
  801466:	68 88 1f 80 00       	push   $0x801f88
  ...
  801477:	e8 54 00 00 00       	call   8014d0 <vcprintf>
	cprintf("\n");
  80147c:	c7 04 24 73 1f 80 00 	movl   $0x801f73,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801584:	e8 47 06 00 00       	call   801bd0 <__udivdi3>
  ...
  8015c7:	e8 34 07 00 00       	call   801d00 <__umoddi3>
  8015cc:	83 c4 14             	add    $0x14,%esp
  8015cf:	0f be 80 ab 1f 80 00 	movsbl 0x801fab(%eax),%eax
  8015d6:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8016cb:	ff 24 85 e0 20 80 00 	jmp    *0x8020e0(,%eax,4)
  ...
  80178f:	8b 14 85 40 22 80 00 	mov    0x802240(,%eax,4),%edx
  801796:	85 d2                	test   %edx,%edx
  801798:	75 18                	jne    8017b2 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  80179a:	50                   	push   %eax
  80179b:	68 c3 1f 80 00       	push   $0x801fc3
  8017a0:	53                   	push   %ebx
  8017a1:	56                   	push   %esi
  ...
  8017b2:	52                   	push   %edx
  8017b3:	68 41 1f 80 00       	push   $0x801f41
  8017b8:	53                   	push   %ebx
  8017b9:	56                   	push   %esi
  ...
  8017d7:	b8 bc 1f 80 00       	mov    $0x801fbc,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801ac0:	68 00 00 c0 ee       	push   $0xeec00000
  801ac5:	e8 60 ec ff ff       	call   80072a <sys_ipc_recv>
  801aca:	89 c2                	mov    %eax,%edx
		if (from_env_store) {
  801acc:	83 c4 10             	add    $0x10,%esp
  801acf:	85 f6                	test   %esi,%esi
  801ad1:	74 13                	je     801ae6 <ipc_recv+0x79>
			*from_env_store = (r == 0) ? (thisenv->env_ipc_from) : 0;
  801ad3:	b8 00 00 00 00       	mov    $0x0,%eax
  801ad8:	85 d2                	test   %edx,%edx
  801ada:	75 08                	jne    801ae4 <ipc_recv+0x77>
  ...
  801ae8:	74 06                	je     801af0 <ipc_recv+0x83>
			*perm_store = 0;
  ...
  801af4:	75 08                	jne    801afe <ipc_recv+0x91>
		// system call fails, return the error
		return r;
  ...
  801afb:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b17:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;
  801b19:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801b1e:	0f 44 d8             	cmove  %eax,%ebx

	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801b21:	eb 1c                	jmp    801b3f <ipc_send+0x3a>
		if (r != -E_IPC_NOT_RECV) {
  801b23:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801b26:	74 12                	je     801b3a <ipc_send+0x35>
			panic("Sys ipc try send error: %e", r);
  801b28:	50                   	push   %eax
  801b29:	68 a0 22 80 00       	push   $0x8022a0
  801b2e:	6a 4f                	push   $0x4f
  801b30:	68 bb 22 80 00       	push   $0x8022bb
  801b35:	e8 0e f9 ff ff       	call   801448 <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801b3a:	e8 1c ea ff ff       	call   80055b <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
	...
	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801b3f:	ff 75 14             	pushl  0x14(%ebp)
  801b42:	53                   	push   %ebx
  801b43:	56                   	push   %esi
  801b44:	57                   	push   %edi
  801b45:	e8 bd eb ff ff       	call   800707 <sys_ipc_try_send>
  801b4a:	83 c4 10             	add    $0x10,%esp
  801b4d:	85 c0                	test   %eax,%eax
  801b4f:	78 d2                	js     801b23 <ipc_send+0x1e>
...
ipc_find_env(enum EnvType type)
{
  ...
  801b64:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801b67:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801b6d:	8b 52 50             	mov    0x50(%edx),%edx
  801b70:	39 ca                	cmp    %ecx,%edx
  801b72:	75 0d                	jne    801b81 <ipc_find_env+0x28>
			return envs[i].env_id;
  801b74:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801b77:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801b7c:	8b 40 48             	mov    0x48(%eax),%eax
  801b7f:	eb 0f                	jmp    801b90 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801b84:	3d 00 04 00 00       	cmp    $0x400,%eax
  801b89:	75 d9                	jne    801b64 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;

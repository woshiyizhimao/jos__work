	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800377:	e8 54 19 00 00       	call   801cd0 <__udivdi3>
  ...
  8003ba:	e8 41 1a 00 00       	call   801e00 <__umoddi3>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004be:	ff 24 85 60 21 80 00 	jmp    *0x802160(,%eax,4)
  ...
  800582:	8b 14 85 c0 22 80 00 	mov    0x8022c0(,%eax,4),%edx
  800589:	85 d2                	test   %edx,%edx
  80058b:	75 18                	jne    8005a5 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  80058d:	50                   	push   %eax
  80058e:	68 33 20 80 00       	push   $0x802033
  800593:	53                   	push   %ebx
  800594:	56                   	push   %esi
  ...
  8005a5:	52                   	push   %edx
  8005a6:	68 f5 23 80 00       	push   $0x8023f5
  8005ab:	53                   	push   %ebx
  8005ac:	56                   	push   %esi
  ...
  8005ca:	b8 2c 20 80 00       	mov    $0x80202c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c45:	68 1f 23 80 00       	push   $0x80231f
  800c4a:	6a 23                	push   $0x23
  800c4c:	68 3c 23 80 00       	push   $0x80233c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d8c:	68 1f 23 80 00       	push   $0x80231f
  800d91:	6a 23                	push   $0x23
  800d93:	68 3c 23 80 00       	push   $0x80233c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800dce:	68 1f 23 80 00       	push   $0x80231f
  800dd3:	6a 23                	push   $0x23
  800dd5:	68 3c 23 80 00       	push   $0x80233c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e10:	68 1f 23 80 00       	push   $0x80231f
  800e15:	6a 23                	push   $0x23
  800e17:	68 3c 23 80 00       	push   $0x80233c
...
sys_ipc_recv(void *dstva)
{
  ...
  800e74:	68 1f 23 80 00       	push   $0x80231f
  800e79:	6a 23                	push   $0x23
  800e7b:	68 3c 23 80 00       	push   $0x80233c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800f62:	ba cc 23 80 00       	mov    $0x8023cc,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800f8d:	51                   	push   %ecx
  800f8e:	50                   	push   %eax
  800f8f:	68 4c 23 80 00       	push   $0x80234c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8011b7:	53                   	push   %ebx
  8011b8:	50                   	push   %eax
  8011b9:	68 90 23 80 00       	push   $0x802390
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80128c:	53                   	push   %ebx
  80128d:	50                   	push   %eax
  80128e:	68 ac 23 80 00       	push   $0x8023ac
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801341:	53                   	push   %ebx
  801342:	50                   	push   %eax
  801343:	68 6c 23 80 00       	push   $0x80236c
...
fsipc(unsigned type, void *dstva)
{
  ...
  801453:	e8 fe 07 00 00       	call   801c56 <ipc_find_env>
  ...
  80146e:	e8 8f 07 00 00       	call   801c02 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801597:	68 dc 23 80 00       	push   $0x8023dc
  80159c:	68 e3 23 80 00       	push   $0x8023e3
  8015a1:	6a 7c                	push   $0x7c
  8015a3:	68 f8 23 80 00       	push   $0x8023f8
  8015a8:	e8 8e ec ff ff       	call   80023b <_panic>
	assert(r <= PGSIZE);
  8015ad:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8015b2:	7e 16                	jle    8015ca <devfile_read+0x65>
  8015b4:	68 03 24 80 00       	push   $0x802403
  8015b9:	68 e3 23 80 00       	push   $0x8023e3
  8015be:	6a 7d                	push   $0x7d
  8015c0:	68 f8 23 80 00       	push   $0x8023f8
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8016a3:	68 0f 24 80 00       	push   $0x80240f
  8016a8:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80171f:	e8 6b 05 00 00       	call   801c8f <pageref>
  801724:	89 c3                	mov    %eax,%ebx
  801726:	89 3c 24             	mov    %edi,(%esp)
  801729:	e8 61 05 00 00       	call   801c8f <pageref>
  ...
  801753:	50                   	push   %eax
  801754:	56                   	push   %esi
  801755:	68 16 24 80 00       	push   $0x802416
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8019f7:	68 2e 24 80 00       	push   $0x80242e
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801ba3:	74 48                	je     801bed <ipc_recv+0x83>
			*perm_store = (r == 0) ? (thisenv->env_ipc_perm) : 0;
  801ba5:	b8 00 00 00 00       	mov    $0x0,%eax
  801baa:	85 d2                	test   %edx,%edx
  801bac:	75 08                	jne    801bb6 <ipc_recv+0x4c>
  801bae:	a1 04 40 80 00       	mov    0x804004,%eax
  801bb3:	8b 40 78             	mov    0x78(%eax),%eax
  801bb6:	89 03                	mov    %eax,(%ebx)
  801bb8:	eb 33                	jmp    801bed <ipc_recv+0x83>
		}
	}
	else {
  ...
  801bbd:	68 00 00 c0 ee       	push   $0xeec00000
  801bc2:	e8 85 f2 ff ff       	call   800e4c <sys_ipc_recv>
  801bc7:	89 c2                	mov    %eax,%edx
		if (from_env_store) {
  801bc9:	83 c4 10             	add    $0x10,%esp
  801bcc:	85 f6                	test   %esi,%esi
  801bce:	74 13                	je     801be3 <ipc_recv+0x79>
			*from_env_store = (r == 0) ? (thisenv->env_ipc_from) : 0;
  801bd0:	b8 00 00 00 00       	mov    $0x0,%eax
  801bd5:	85 d2                	test   %edx,%edx
  801bd7:	75 08                	jne    801be1 <ipc_recv+0x77>
  801bd9:	a1 04 40 80 00       	mov    0x804004,%eax
  801bde:	8b 40 74             	mov    0x74(%eax),%eax
  801be1:	89 06                	mov    %eax,(%esi)
		}
		if (perm_store) {
  801be3:	85 db                	test   %ebx,%ebx
  801be5:	74 06                	je     801bed <ipc_recv+0x83>
			*perm_store = 0;
  801be7:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
		}
	}
  ...
  801bf1:	75 08                	jne    801bfb <ipc_recv+0x91>
		// system call fails, return the error
		return r;
	
	// system call success
	return thisenv->env_ipc_value;
  801bf3:	a1 04 40 80 00       	mov    0x804004,%eax
  801bf8:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c0b:	8b 7d 08             	mov    0x8(%ebp),%edi
  801c0e:	8b 75 0c             	mov    0xc(%ebp),%esi
  801c11:	8b 5d 10             	mov    0x10(%ebp),%ebx
	// LAB 4: Your code here.
	// edited by Lethe 2018/12/8
	if (!pg)
  801c14:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;
  801c16:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801c1b:	0f 44 d8             	cmove  %eax,%ebx

	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801c1e:	eb 1c                	jmp    801c3c <ipc_send+0x3a>
		if (r != -E_IPC_NOT_RECV) {
  801c20:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801c23:	74 12                	je     801c37 <ipc_send+0x35>
			panic("Sys ipc try send error: %e", r);
  801c25:	50                   	push   %eax
  801c26:	68 3a 24 80 00       	push   $0x80243a
  801c2b:	6a 4f                	push   $0x4f
  801c2d:	68 55 24 80 00       	push   $0x802455
  801c32:	e8 04 e6 ff ff       	call   80023b <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801c37:	e8 41 f0 ff ff       	call   800c7d <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
  ...
  801c40:	56                   	push   %esi
  801c41:	57                   	push   %edi
  801c42:	e8 e2 f1 ff ff       	call   800e29 <sys_ipc_try_send>
  801c47:	83 c4 10             	add    $0x10,%esp
  801c4a:	85 c0                	test   %eax,%eax
  801c4c:	78 d2                	js     801c20 <ipc_send+0x1e>
...
ipc_find_env(enum EnvType type)
{
  ...
  801c61:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801c64:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801c6a:	8b 52 50             	mov    0x50(%edx),%edx
  801c6d:	39 ca                	cmp    %ecx,%edx
  801c6f:	75 0d                	jne    801c7e <ipc_find_env+0x28>
			return envs[i].env_id;
  801c71:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801c74:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801c79:	8b 40 48             	mov    0x48(%eax),%eax
  801c7c:	eb 0f                	jmp    801c8d <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801c81:	3d 00 04 00 00       	cmp    $0x400,%eax
  801c86:	75 d9                	jne    801c61 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;

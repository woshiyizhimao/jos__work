...
fsipc(unsigned type, void *dstva)
{
  ...
  800938:	e8 a3 11 00 00       	call   801ae0 <ipc_find_env>
  ...
  800953:	e8 34 11 00 00       	call   801a8c <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a88:	68 e0 1e 80 00       	push   $0x801ee0
  800a8d:	e8 bd 05 00 00       	call   80104f <_panic>
	assert(r <= PGSIZE);
  800a92:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800a97:	7e 16                	jle    800aaf <devfile_read+0x65>
  800a99:	68 eb 1e 80 00       	push   $0x801eeb
  800a9e:	68 cb 1e 80 00       	push   $0x801ecb
  800aa3:	6a 7d                	push   $0x7d
  800aa5:	68 e0 1e 80 00       	push   $0x801ee0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b88:	68 f7 1e 80 00       	push   $0x801ef7
  800b8d:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800c04:	e8 10 0f 00 00       	call   801b19 <pageref>
  800c09:	89 c3                	mov    %eax,%ebx
  800c0b:	89 3c 24             	mov    %edi,(%esp)
  800c0e:	e8 06 0f 00 00       	call   801b19 <pageref>
  ...
  800c38:	50                   	push   %eax
  800c39:	56                   	push   %esi
  800c3a:	68 fe 1e 80 00       	push   $0x801efe
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800edc:	68 16 1f 80 00       	push   $0x801f16
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80106b:	56                   	push   %esi
  80106c:	50                   	push   %eax
  80106d:	68 24 1f 80 00       	push   $0x801f24
  ...
  80107e:	e8 54 00 00 00       	call   8010d7 <vcprintf>
	cprintf("\n");
  801083:	c7 04 24 0f 1f 80 00 	movl   $0x801f0f,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80118b:	e8 d0 09 00 00       	call   801b60 <__udivdi3>
  ...
  8011ce:	e8 bd 0a 00 00       	call   801c90 <__umoddi3>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801396:	8b 14 85 e0 21 80 00 	mov    0x8021e0(,%eax,4),%edx
  ...
  8013de:	b8 58 1f 80 00       	mov    $0x801f58,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a6f:	74 06                	je     801a77 <ipc_recv+0x83>
			*perm_store = 0;
  801a71:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
		}
	}
  ...
  801a7b:	75 08                	jne    801a85 <ipc_recv+0x91>
		// system call fails, return the error
		return r;
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801aa8:	eb 1c                	jmp    801ac6 <ipc_send+0x3a>
		if (r != -E_IPC_NOT_RECV) {
  801aaa:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801aad:	74 12                	je     801ac1 <ipc_send+0x35>
			panic("Sys ipc try send error: %e", r);
  801aaf:	50                   	push   %eax
  801ab0:	68 40 22 80 00       	push   $0x802240
  801ab5:	6a 4f                	push   $0x4f
  801ab7:	68 5b 22 80 00       	push   $0x80225b
  801abc:	e8 8e f5 ff ff       	call   80104f <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801ac1:	e8 9c e6 ff ff       	call   800162 <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
  ...
  801aca:	56                   	push   %esi
  801acb:	57                   	push   %edi
  801acc:	e8 3d e8 ff ff       	call   80030e <sys_ipc_try_send>
  801ad1:	83 c4 10             	add    $0x10,%esp
  801ad4:	85 c0                	test   %eax,%eax
  801ad6:	78 d2                	js     801aaa <ipc_send+0x1e>

...
fsipc(unsigned type, void *dstva)
{
  ...
  800911:	e8 a3 11 00 00       	call   801ab9 <ipc_find_env>
  ...
  80092c:	e8 34 11 00 00       	call   801a65 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a55:	68 84 1e 80 00       	push   $0x801e84
  800a5a:	68 8b 1e 80 00       	push   $0x801e8b
  800a5f:	6a 7c                	push   $0x7c
  800a61:	68 a0 1e 80 00       	push   $0x801ea0
  800a66:	e8 bd 05 00 00       	call   801028 <_panic>
	assert(r <= PGSIZE);
  800a6b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800a70:	7e 16                	jle    800a88 <devfile_read+0x65>
  800a72:	68 ab 1e 80 00       	push   $0x801eab
  800a77:	68 8b 1e 80 00       	push   $0x801e8b
  800a7c:	6a 7d                	push   $0x7d
  800a7e:	68 a0 1e 80 00       	push   $0x801ea0
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800bdd:	e8 10 0f 00 00       	call   801af2 <pageref>
  800be2:	89 c3                	mov    %eax,%ebx
  800be4:	89 3c 24             	mov    %edi,(%esp)
  800be7:	e8 06 0f 00 00       	call   801af2 <pageref>
  ...
  800c11:	50                   	push   %eax
  800c12:	56                   	push   %esi
  800c13:	68 be 1e 80 00       	push   $0x801ebe
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800eb5:	68 d6 1e 80 00       	push   $0x801ed6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801044:	56                   	push   %esi
  801045:	50                   	push   %eax
  801046:	68 e4 1e 80 00       	push   $0x801ee4
  ...
  801057:	e8 54 00 00 00       	call   8010b0 <vcprintf>
	cprintf("\n");
  80105c:	c7 04 24 cf 1e 80 00 	movl   $0x801ecf,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801164:	e8 c7 09 00 00       	call   801b30 <__udivdi3>
  ...
  8011a7:	e8 b4 0a 00 00       	call   801c60 <__umoddi3>
  8011ac:	83 c4 14             	add    $0x14,%esp
  8011af:	0f be 80 07 1f 80 00 	movsbl 0x801f07(%eax),%eax
  8011b6:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8012ab:	ff 24 85 40 20 80 00 	jmp    *0x802040(,%eax,4)
  ...
  80136f:	8b 14 85 a0 21 80 00 	mov    0x8021a0(,%eax,4),%edx
  801376:	85 d2                	test   %edx,%edx
  801378:	75 18                	jne    801392 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  80137a:	50                   	push   %eax
  80137b:	68 1f 1f 80 00       	push   $0x801f1f
  801380:	53                   	push   %ebx
  801381:	56                   	push   %esi
  ...
  801392:	52                   	push   %edx
  801393:	68 9d 1e 80 00       	push   $0x801e9d
  801398:	53                   	push   %ebx
  801399:	56                   	push   %esi
  ...
  8013b7:	b8 18 1f 80 00       	mov    $0x801f18,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8019dd:	74 3e                	je     801a1d <ipc_recv+0x50>
		r = sys_ipc_recv(pg);
  8019df:	83 ec 0c             	sub    $0xc,%esp
  8019e2:	50                   	push   %eax
  8019e3:	e8 22 e9 ff ff       	call   80030a <sys_ipc_recv>
  8019e8:	89 c2                	mov    %eax,%edx

		if (from_env_store) {
  8019ea:	83 c4 10             	add    $0x10,%esp
  8019ed:	85 f6                	test   %esi,%esi
  8019ef:	74 13                	je     801a04 <ipc_recv+0x37>
			*from_env_store = (r == 0) ? (thisenv->env_ipc_from) : 0;
  8019f1:	b8 00 00 00 00       	mov    $0x0,%eax
  8019f6:	85 d2                	test   %edx,%edx
  8019f8:	75 08                	jne    801a02 <ipc_recv+0x35>
  8019fa:	a1 04 40 80 00       	mov    0x804004,%eax
  8019ff:	8b 40 74             	mov    0x74(%eax),%eax
  801a02:	89 06                	mov    %eax,(%esi)
		}
		if (perm_store) {
  801a04:	85 db                	test   %ebx,%ebx
  801a06:	74 48                	je     801a50 <ipc_recv+0x83>
			*perm_store = (r == 0) ? (thisenv->env_ipc_perm) : 0;
  801a08:	b8 00 00 00 00       	mov    $0x0,%eax
  801a0d:	85 d2                	test   %edx,%edx
  801a0f:	75 08                	jne    801a19 <ipc_recv+0x4c>
  801a11:	a1 04 40 80 00       	mov    0x804004,%eax
  801a16:	8b 40 78             	mov    0x78(%eax),%eax
  801a19:	89 03                	mov    %eax,(%ebx)
  801a1b:	eb 33                	jmp    801a50 <ipc_recv+0x83>
		}
	}
	else {
  ...
  801a20:	68 00 00 c0 ee       	push   $0xeec00000
  801a25:	e8 e0 e8 ff ff       	call   80030a <sys_ipc_recv>
  801a2a:	89 c2                	mov    %eax,%edx
		if (from_env_store) {
  801a2c:	83 c4 10             	add    $0x10,%esp
  801a2f:	85 f6                	test   %esi,%esi
  801a31:	74 13                	je     801a46 <ipc_recv+0x79>
			*from_env_store = (r == 0) ? (thisenv->env_ipc_from) : 0;
  801a33:	b8 00 00 00 00       	mov    $0x0,%eax
  801a38:	85 d2                	test   %edx,%edx
  801a3a:	75 08                	jne    801a44 <ipc_recv+0x77>
  ...
  801a48:	74 06                	je     801a50 <ipc_recv+0x83>
			*perm_store = 0;
  801a4a:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
		}
	}
  ...
  801a54:	75 08                	jne    801a5e <ipc_recv+0x91>
		// system call fails, return the error
		return r;
  ...
  801a5b:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a71:	8b 75 0c             	mov    0xc(%ebp),%esi
  ...
  801a77:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;
  801a79:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801a7e:	0f 44 d8             	cmove  %eax,%ebx

	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801a81:	eb 1c                	jmp    801a9f <ipc_send+0x3a>
		if (r != -E_IPC_NOT_RECV) {
  801a83:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801a86:	74 12                	je     801a9a <ipc_send+0x35>
			panic("Sys ipc try send error: %e", r);
  801a88:	50                   	push   %eax
  801a89:	68 00 22 80 00       	push   $0x802200
  801a8e:	6a 4f                	push   $0x4f
  801a90:	68 1b 22 80 00       	push   $0x80221b
  801a95:	e8 8e f5 ff ff       	call   801028 <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801a9a:	e8 9c e6 ff ff       	call   80013b <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
  ...
  801aa3:	56                   	push   %esi
  801aa4:	57                   	push   %edi
  801aa5:	e8 3d e8 ff ff       	call   8002e7 <sys_ipc_try_send>
  801aaa:	83 c4 10             	add    $0x10,%esp
  801aad:	85 c0                	test   %eax,%eax
  801aaf:	78 d2                	js     801a83 <ipc_send+0x1e>

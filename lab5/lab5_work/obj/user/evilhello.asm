...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800457:	51                   	push   %ecx
  800458:	50                   	push   %eax
  800459:	68 18 1e 80 00       	push   $0x801e18
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800681:	53                   	push   %ebx
  800682:	50                   	push   %eax
  800683:	68 59 1e 80 00       	push   $0x801e59
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800756:	53                   	push   %ebx
  800757:	50                   	push   %eax
  800758:	68 75 1e 80 00       	push   $0x801e75
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80080b:	53                   	push   %ebx
  80080c:	50                   	push   %eax
  80080d:	68 38 1e 80 00       	push   $0x801e38
...
fsipc(unsigned type, void *dstva)
{
  ...
  80091d:	e8 a3 11 00 00       	call   801ac5 <ipc_find_env>
  ...
  800938:	e8 34 11 00 00       	call   801a71 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a61:	68 a4 1e 80 00       	push   $0x801ea4
  800a66:	68 ab 1e 80 00       	push   $0x801eab
  ...
  800a8a:	68 c0 1e 80 00       	push   $0x801ec0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b6d:	68 d7 1e 80 00       	push   $0x801ed7
  800b72:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800be9:	e8 10 0f 00 00       	call   801afe <pageref>
  800bee:	89 c3                	mov    %eax,%ebx
  800bf0:	89 3c 24             	mov    %edi,(%esp)
  800bf3:	e8 06 0f 00 00       	call   801afe <pageref>
  ...
  800c1d:	50                   	push   %eax
  800c1e:	56                   	push   %esi
  800c1f:	68 de 1e 80 00       	push   $0x801ede
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ec1:	68 f6 1e 80 00       	push   $0x801ef6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801050:	56                   	push   %esi
  801051:	50                   	push   %eax
  801052:	68 04 1f 80 00       	push   $0x801f04
  ...
  801063:	e8 54 00 00 00       	call   8010bc <vcprintf>
	cprintf("\n");
  801068:	c7 04 24 ef 1e 80 00 	movl   $0x801eef,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801170:	e8 cb 09 00 00       	call   801b40 <__udivdi3>
  ...
  8011b3:	e8 b8 0a 00 00       	call   801c70 <__umoddi3>
  8011b8:	83 c4 14             	add    $0x14,%esp
  8011bb:	0f be 80 27 1f 80 00 	movsbl 0x801f27(%eax),%eax
  8011c2:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8012b7:	ff 24 85 60 20 80 00 	jmp    *0x802060(,%eax,4)
  ...
  80137b:	8b 14 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%edx
  801382:	85 d2                	test   %edx,%edx
  801384:	75 18                	jne    80139e <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  801386:	50                   	push   %eax
  801387:	68 3f 1f 80 00       	push   $0x801f3f
  80138c:	53                   	push   %ebx
  80138d:	56                   	push   %esi
  ...
  80139e:	52                   	push   %edx
  80139f:	68 bd 1e 80 00       	push   $0x801ebd
  8013a4:	53                   	push   %ebx
  8013a5:	56                   	push   %esi
  ...
  8013c3:	b8 38 1f 80 00       	mov    $0x801f38,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a2c:	68 00 00 c0 ee       	push   $0xeec00000
  801a31:	e8 e0 e8 ff ff       	call   800316 <sys_ipc_recv>
  801a36:	89 c2                	mov    %eax,%edx
		if (from_env_store) {
  801a38:	83 c4 10             	add    $0x10,%esp
  801a3b:	85 f6                	test   %esi,%esi
  801a3d:	74 13                	je     801a52 <ipc_recv+0x79>
			*from_env_store = (r == 0) ? (thisenv->env_ipc_from) : 0;
  801a3f:	b8 00 00 00 00       	mov    $0x0,%eax
  801a44:	85 d2                	test   %edx,%edx
  801a46:	75 08                	jne    801a50 <ipc_recv+0x77>
  ...
  801a54:	74 06                	je     801a5c <ipc_recv+0x83>
			*perm_store = 0;
  801a56:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
		}
	}
  ...
  801a60:	75 08                	jne    801a6a <ipc_recv+0x91>
		// system call fails, return the error
		return r;
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a83:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;
  801a85:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801a8a:	0f 44 d8             	cmove  %eax,%ebx

	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801a8d:	eb 1c                	jmp    801aab <ipc_send+0x3a>
		if (r != -E_IPC_NOT_RECV) {
  801a8f:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801a92:	74 12                	je     801aa6 <ipc_send+0x35>
			panic("Sys ipc try send error: %e", r);
  801a94:	50                   	push   %eax
  801a95:	68 20 22 80 00       	push   $0x802220
  801a9a:	6a 4f                	push   $0x4f
  801a9c:	68 3b 22 80 00       	push   $0x80223b
  801aa1:	e8 8e f5 ff ff       	call   801034 <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801aa6:	e8 9c e6 ff ff       	call   800147 <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
  ...
  801aaf:	56                   	push   %esi
  801ab0:	57                   	push   %edi
  801ab1:	e8 3d e8 ff ff       	call   8002f3 <sys_ipc_try_send>
  801ab6:	83 c4 10             	add    $0x10,%esp
  801ab9:	85 c0                	test   %eax,%eax
  801abb:	78 d2                	js     801a8f <ipc_send+0x1e>

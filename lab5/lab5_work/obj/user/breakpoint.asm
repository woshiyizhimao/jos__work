...
fsipc(unsigned type, void *dstva)
{
  ...
  80090c:	e8 a3 11 00 00       	call   801ab4 <ipc_find_env>
  ...
  800927:	e8 34 11 00 00       	call   801a60 <ipc_send>
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b5c:	68 b7 1e 80 00       	push   $0x801eb7
  800b61:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800bd8:	e8 10 0f 00 00       	call   801aed <pageref>
  800bdd:	89 c3                	mov    %eax,%ebx
  800bdf:	89 3c 24             	mov    %edi,(%esp)
  800be2:	e8 06 0f 00 00       	call   801aed <pageref>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800eb0:	68 d6 1e 80 00       	push   $0x801ed6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80103f:	56                   	push   %esi
  801040:	50                   	push   %eax
  801041:	68 e4 1e 80 00       	push   $0x801ee4
  ...
  801052:	e8 54 00 00 00       	call   8010ab <vcprintf>
	cprintf("\n");
  801057:	c7 04 24 cf 1e 80 00 	movl   $0x801ecf,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80115f:	e8 cc 09 00 00       	call   801b30 <__udivdi3>
  ...
  8011a2:	e8 b9 0a 00 00       	call   801c60 <__umoddi3>
  8011a7:	83 c4 14             	add    $0x14,%esp
  8011aa:	0f be 80 07 1f 80 00 	movsbl 0x801f07(%eax),%eax
  8011b1:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8012a6:	ff 24 85 40 20 80 00 	jmp    *0x802040(,%eax,4)
  ...
  80136a:	8b 14 85 a0 21 80 00 	mov    0x8021a0(,%eax,4),%edx
  801371:	85 d2                	test   %edx,%edx
  801373:	75 18                	jne    80138d <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  801375:	50                   	push   %eax
  801376:	68 1f 1f 80 00       	push   $0x801f1f
  80137b:	53                   	push   %ebx
  80137c:	56                   	push   %esi
  ...
  8013b2:	b8 18 1f 80 00       	mov    $0x801f18,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a4b:	89 d0                	mov    %edx,%eax
	...
	if (r)
  801a4d:	85 d2                	test   %edx,%edx
  801a4f:	75 08                	jne    801a59 <ipc_recv+0x91>
		// system call fails, return the error
		return r;
  ...
  801a56:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a72:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;
  801a74:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801a79:	0f 44 d8             	cmove  %eax,%ebx

	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801a7c:	eb 1c                	jmp    801a9a <ipc_send+0x3a>
		if (r != -E_IPC_NOT_RECV) {
  801a7e:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801a81:	74 12                	je     801a95 <ipc_send+0x35>
			panic("Sys ipc try send error: %e", r);
  801a83:	50                   	push   %eax
  801a84:	68 00 22 80 00       	push   $0x802200
  801a89:	6a 4f                	push   $0x4f
  801a8b:	68 1b 22 80 00       	push   $0x80221b
  801a90:	e8 8e f5 ff ff       	call   801023 <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801a95:	e8 9c e6 ff ff       	call   800136 <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
  ...
  801a9e:	56                   	push   %esi
  801a9f:	57                   	push   %edi
  801aa0:	e8 3d e8 ff ff       	call   8002e2 <sys_ipc_try_send>
  801aa5:	83 c4 10             	add    $0x10,%esp
  801aa8:	85 c0                	test   %eax,%eax
  801aaa:	78 d2                	js     801a7e <ipc_send+0x1e>
...
ipc_find_env(enum EnvType type)
{
  ...
  801abf:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801ac2:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801ac8:	8b 52 50             	mov    0x50(%edx),%edx
  801acb:	39 ca                	cmp    %ecx,%edx
  801acd:	75 0d                	jne    801adc <ipc_find_env+0x28>
			return envs[i].env_id;
  801acf:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801ad2:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801ad7:	8b 40 48             	mov    0x48(%eax),%eax
  801ada:	eb 0f                	jmp    801aeb <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801adf:	3d 00 04 00 00       	cmp    $0x400,%eax
  801ae4:	75 d9                	jne    801abf <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;

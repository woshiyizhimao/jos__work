...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a6d:	68 c4 1e 80 00       	push   $0x801ec4
  800a72:	e8 bd 05 00 00       	call   801034 <_panic>
	assert(r <= PGSIZE);
  800a77:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800a7c:	7e 16                	jle    800a94 <devfile_read+0x65>
  800a7e:	68 cf 1e 80 00       	push   $0x801ecf
  800a83:	68 af 1e 80 00       	push   $0x801eaf
  800a88:	6a 7d                	push   $0x7d
  800a8a:	68 c4 1e 80 00       	push   $0x801ec4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b6d:	68 db 1e 80 00       	push   $0x801edb
  800b72:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800c1d:	50                   	push   %eax
  800c1e:	56                   	push   %esi
  800c1f:	68 e2 1e 80 00       	push   $0x801ee2
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ec1:	68 fa 1e 80 00       	push   $0x801efa
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801050:	56                   	push   %esi
  801051:	50                   	push   %eax
  801052:	68 08 1f 80 00       	push   $0x801f08
  ...
  801063:	e8 54 00 00 00       	call   8010bc <vcprintf>
	cprintf("\n");
  801068:	c7 04 24 f3 1e 80 00 	movl   $0x801ef3,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8011bb:	0f be 80 2b 1f 80 00 	movsbl 0x801f2b(%eax),%eax
  8011c2:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801386:	50                   	push   %eax
  801387:	68 43 1f 80 00       	push   $0x801f43
  80138c:	53                   	push   %ebx
  80138d:	56                   	push   %esi
  ...
  80139e:	52                   	push   %edx
  80139f:	68 c1 1e 80 00       	push   $0x801ec1
  8013a4:	53                   	push   %ebx
  8013a5:	56                   	push   %esi
  ...
  8013c3:	b8 3c 1f 80 00       	mov    $0x801f3c,%eax

...
fsipc(unsigned type, void *dstva)
{
  ...
  8013ab:	e8 0e 09 00 00       	call   801cbe <ipc_find_env>
  ...
  8013c6:	e8 9f 08 00 00       	call   801c6a <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8014ef:	68 1c 24 80 00       	push   $0x80241c
  8014f4:	68 23 24 80 00       	push   $0x802423
  8014f9:	6a 7c                	push   $0x7c
  8014fb:	68 38 24 80 00       	push   $0x802438
  801500:	e8 8e ec ff ff       	call   800193 <_panic>
	assert(r <= PGSIZE);
  801505:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80150a:	7e 16                	jle    801522 <devfile_read+0x65>
  80150c:	68 43 24 80 00       	push   $0x802443
  801511:	68 23 24 80 00       	push   $0x802423
  801516:	6a 7d                	push   $0x7d
  801518:	68 38 24 80 00       	push   $0x802438
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80170b:	68 4f 24 80 00       	push   $0x80244f
  801710:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801787:	e8 6b 05 00 00       	call   801cf7 <pageref>
  80178c:	89 c3                	mov    %eax,%ebx
  80178e:	89 3c 24             	mov    %edi,(%esp)
  801791:	e8 61 05 00 00       	call   801cf7 <pageref>
  ...
  8017bb:	50                   	push   %eax
  8017bc:	56                   	push   %esi
  8017bd:	68 56 24 80 00       	push   $0x802456
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801a5f:	68 6e 24 80 00       	push   $0x80246e
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801c25:	68 00 00 c0 ee       	push   $0xeec00000
  801c2a:	e8 75 f1 ff ff       	call   800da4 <sys_ipc_recv>
  801c2f:	89 c2                	mov    %eax,%edx
		if (from_env_store) {
  801c31:	83 c4 10             	add    $0x10,%esp
  801c34:	85 f6                	test   %esi,%esi
  801c36:	74 13                	je     801c4b <ipc_recv+0x79>
			*from_env_store = (r == 0) ? (thisenv->env_ipc_from) : 0;
  801c38:	b8 00 00 00 00       	mov    $0x0,%eax
  801c3d:	85 d2                	test   %edx,%edx
  801c3f:	75 08                	jne    801c49 <ipc_recv+0x77>
  ...
  801c4d:	74 06                	je     801c55 <ipc_recv+0x83>
			*perm_store = 0;
  ...
  801c59:	75 08                	jne    801c63 <ipc_recv+0x91>
		// system call fails, return the error
		return r;
  ...
  801c60:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c76:	8b 75 0c             	mov    0xc(%ebp),%esi
  ...
  801c7c:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;
  801c7e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801c83:	0f 44 d8             	cmove  %eax,%ebx

	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801c86:	eb 1c                	jmp    801ca4 <ipc_send+0x3a>
		if (r != -E_IPC_NOT_RECV) {
  801c88:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801c8b:	74 12                	je     801c9f <ipc_send+0x35>
			panic("Sys ipc try send error: %e", r);
  801c8d:	50                   	push   %eax
  801c8e:	68 7a 24 80 00       	push   $0x80247a
  801c93:	6a 4f                	push   $0x4f
  801c95:	68 95 24 80 00       	push   $0x802495
  801c9a:	e8 f4 e4 ff ff       	call   800193 <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801c9f:	e8 31 ef ff ff       	call   800bd5 <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
	...
	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801ca4:	ff 75 14             	pushl  0x14(%ebp)
  801ca7:	53                   	push   %ebx
  801ca8:	56                   	push   %esi
  801ca9:	57                   	push   %edi
  801caa:	e8 d2 f0 ff ff       	call   800d81 <sys_ipc_try_send>
  801caf:	83 c4 10             	add    $0x10,%esp
  801cb2:	85 c0                	test   %eax,%eax
  801cb4:	78 d2                	js     801c88 <ipc_send+0x1e>
...
ipc_find_env(enum EnvType type)
{
  ...
  801cc1:	8b 4d 08             	mov    0x8(%ebp),%ecx
	int i;
	for (i = 0; i < NENV; i++)
  801cc4:	b8 00 00 00 00       	mov    $0x0,%eax
		if (envs[i].env_type == type)
  801cc9:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801ccc:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801cd2:	8b 52 50             	mov    0x50(%edx),%edx
  801cd5:	39 ca                	cmp    %ecx,%edx
  801cd7:	75 0d                	jne    801ce6 <ipc_find_env+0x28>
			return envs[i].env_id;
  801cd9:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801cdc:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801ce1:	8b 40 48             	mov    0x48(%eax),%eax
  801ce4:	eb 0f                	jmp    801cf5 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
	int i;
	for (i = 0; i < NENV; i++)
  801ce6:	83 c0 01             	add    $0x1,%eax
  801ce9:	3d 00 04 00 00       	cmp    $0x400,%eax
  801cee:	75 d9                	jne    801cc9 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;

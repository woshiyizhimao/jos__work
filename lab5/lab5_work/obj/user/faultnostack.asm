...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80045a:	ba 34 1f 80 00       	mov    $0x801f34,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800485:	51                   	push   %ecx
  800486:	50                   	push   %eax
  800487:	68 b8 1e 80 00       	push   $0x801eb8
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006af:	53                   	push   %ebx
  8006b0:	50                   	push   %eax
  8006b1:	68 f9 1e 80 00       	push   $0x801ef9
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800784:	53                   	push   %ebx
  800785:	50                   	push   %eax
  800786:	68 15 1f 80 00       	push   $0x801f15
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800839:	53                   	push   %ebx
  80083a:	50                   	push   %eax
  80083b:	68 d8 1e 80 00       	push   $0x801ed8
...
fsipc(unsigned type, void *dstva)
{
  ...
  80094b:	e8 17 12 00 00       	call   801b67 <ipc_find_env>
  ...
  800966:	e8 a8 11 00 00       	call   801b13 <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  80096b:	83 c4 0c             	add    $0xc,%esp
  80096e:	6a 00                	push   $0x0
  800970:	53                   	push   %ebx
  800971:	6a 00                	push   $0x0
  800973:	e8 03 11 00 00       	call   801a7b <ipc_recv>
}
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a8f:	68 44 1f 80 00       	push   $0x801f44
  800a94:	68 4b 1f 80 00       	push   $0x801f4b
  800a99:	6a 7c                	push   $0x7c
  800a9b:	68 60 1f 80 00       	push   $0x801f60
  800aa0:	e8 bd 05 00 00       	call   801062 <_panic>
	assert(r <= PGSIZE);
  800aa5:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800aaa:	7e 16                	jle    800ac2 <devfile_read+0x65>
  800aac:	68 6b 1f 80 00       	push   $0x801f6b
  800ab1:	68 4b 1f 80 00       	push   $0x801f4b
  800ab6:	6a 7d                	push   $0x7d
  800ab8:	68 60 1f 80 00       	push   $0x801f60
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b9b:	68 77 1f 80 00       	push   $0x801f77
  800ba0:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800c17:	e8 84 0f 00 00       	call   801ba0 <pageref>
  800c1c:	89 c3                	mov    %eax,%ebx
  800c1e:	89 3c 24             	mov    %edi,(%esp)
  800c21:	e8 7a 0f 00 00       	call   801ba0 <pageref>
  ...
  800c4b:	50                   	push   %eax
  800c4c:	56                   	push   %esi
  800c4d:	68 7e 1f 80 00       	push   $0x801f7e
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800eef:	68 96 1f 80 00       	push   $0x801f96
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80107e:	56                   	push   %esi
  80107f:	50                   	push   %eax
  801080:	68 a4 1f 80 00       	push   $0x801fa4
  ...
  801091:	e8 54 00 00 00       	call   8010ea <vcprintf>
	cprintf("\n");
  801096:	c7 04 24 8f 1f 80 00 	movl   $0x801f8f,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80119e:	e8 3d 0a 00 00       	call   801be0 <__udivdi3>
  ...
  8011e1:	e8 2a 0b 00 00       	call   801d10 <__umoddi3>
  8011e6:	83 c4 14             	add    $0x14,%esp
  8011e9:	0f be 80 c7 1f 80 00 	movsbl 0x801fc7(%eax),%eax
  8011f0:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8012e5:	ff 24 85 00 21 80 00 	jmp    *0x802100(,%eax,4)
  ...
  8013a9:	8b 14 85 60 22 80 00 	mov    0x802260(,%eax,4),%edx
  8013b0:	85 d2                	test   %edx,%edx
  8013b2:	75 18                	jne    8013cc <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8013b4:	50                   	push   %eax
  8013b5:	68 df 1f 80 00       	push   $0x801fdf
  8013ba:	53                   	push   %ebx
  8013bb:	56                   	push   %esi
  ...
  8013cc:	52                   	push   %edx
  8013cd:	68 5d 1f 80 00       	push   $0x801f5d
  8013d2:	53                   	push   %ebx
  8013d3:	56                   	push   %esi
  ...
  8013f1:	b8 d8 1f 80 00       	mov    $0x801fd8,%eax
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801a0e:	83 3d 00 60 80 00 00 	cmpl   $0x0,0x806000
  801a15:	75 57                	jne    801a6e <set_pgfault_handler+0x67>
		// First time through!
		// LAB 4: Your code here.
		// edited by Lethe 2018/12/7
		envid_t eid = sys_getenvid();
  801a17:	e8 16 e7 ff ff       	call   800132 <sys_getenvid>
  ...
  801a33:	74 12                	je     801a47 <set_pgfault_handler+0x40>
			panic("Sys page alloc error: %e", r);
  801a35:	50                   	push   %eax
  801a36:	68 bf 22 80 00       	push   $0x8022bf
  801a3b:	6a 25                	push   $0x25
  801a3d:	68 d8 22 80 00       	push   $0x8022d8
  801a42:	e8 1b f6 ff ff       	call   801062 <_panic>
		}

		// _pgfault_upcall is a global variable definited in lib/pfentry.S
		r = sys_env_set_pgfault_upcall(eid, _pgfault_upcall);
  801a47:	83 ec 08             	sub    $0x8,%esp
  801a4a:	68 61 03 80 00       	push   $0x800361
  801a4f:	53                   	push   %ebx
  801a50:	e8 66 e8 ff ff       	call   8002bb <sys_env_set_pgfault_upcall>
		if (r) {
  801a55:	83 c4 10             	add    $0x10,%esp
  801a58:	85 c0                	test   %eax,%eax
  801a5a:	74 12                	je     801a6e <set_pgfault_handler+0x67>
			panic("Sys env set pgfault upcall error: %e", r);
  801a5c:	50                   	push   %eax
  801a5d:	68 e8 22 80 00       	push   $0x8022e8
  801a62:	6a 2b                	push   $0x2b
  801a64:	68 d8 22 80 00       	push   $0x8022d8
  801a69:	e8 f4 f5 ff ff       	call   801062 <_panic>
		}
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801ace:	68 00 00 c0 ee       	push   $0xeec00000
  801ad3:	e8 48 e8 ff ff       	call   800320 <sys_ipc_recv>
  801ad8:	89 c2                	mov    %eax,%edx
		if (from_env_store) {
  801ada:	83 c4 10             	add    $0x10,%esp
  801add:	85 f6                	test   %esi,%esi
  801adf:	74 13                	je     801af4 <ipc_recv+0x79>
			*from_env_store = (r == 0) ? (thisenv->env_ipc_from) : 0;
  801ae1:	b8 00 00 00 00       	mov    $0x0,%eax
  801ae6:	85 d2                	test   %edx,%edx
  801ae8:	75 08                	jne    801af2 <ipc_recv+0x77>
  801aea:	a1 04 40 80 00       	mov    0x804004,%eax
  801aef:	8b 40 74             	mov    0x74(%eax),%eax
  801af2:	89 06                	mov    %eax,(%esi)
		}
		if (perm_store) {
  801af4:	85 db                	test   %ebx,%ebx
  801af6:	74 06                	je     801afe <ipc_recv+0x83>
			*perm_store = 0;
  ...
  801b02:	75 08                	jne    801b0c <ipc_recv+0x91>
		// system call fails, return the error
		return r;
  ...
  801b09:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b2c:	0f 44 d8             	cmove  %eax,%ebx

	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801b2f:	eb 1c                	jmp    801b4d <ipc_send+0x3a>
		if (r != -E_IPC_NOT_RECV) {
  801b31:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801b34:	74 12                	je     801b48 <ipc_send+0x35>
			panic("Sys ipc try send error: %e", r);
  801b36:	50                   	push   %eax
  801b37:	68 10 23 80 00       	push   $0x802310
  801b3c:	6a 4f                	push   $0x4f
  801b3e:	68 2b 23 80 00       	push   $0x80232b
  801b43:	e8 1a f5 ff ff       	call   801062 <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801b48:	e8 04 e6 ff ff       	call   800151 <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
	...
	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801b4d:	ff 75 14             	pushl  0x14(%ebp)
  801b50:	53                   	push   %ebx
  801b51:	56                   	push   %esi
  801b52:	57                   	push   %edi
  801b53:	e8 a5 e7 ff ff       	call   8002fd <sys_ipc_try_send>
  801b58:	83 c4 10             	add    $0x10,%esp
  801b5b:	85 c0                	test   %eax,%eax
  801b5d:	78 d2                	js     801b31 <ipc_send+0x1e>
...
ipc_find_env(enum EnvType type)
{
  ...
  801b72:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801b75:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801b7b:	8b 52 50             	mov    0x50(%edx),%edx
  801b7e:	39 ca                	cmp    %ecx,%edx
  801b80:	75 0d                	jne    801b8f <ipc_find_env+0x28>
			return envs[i].env_id;
  801b82:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801b85:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801b8a:	8b 40 48             	mov    0x48(%eax),%eax
  801b8d:	eb 0f                	jmp    801b9e <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801b97:	75 d9                	jne    801b72 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;

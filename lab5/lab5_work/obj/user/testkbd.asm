...
readline(const char *prompt)
{
  ...
  800904:	50                   	push   %eax
  800905:	68 05 25 80 00       	push   $0x802505
  ...
  800944:	53                   	push   %ebx
  800945:	68 1f 24 80 00       	push   $0x80241f
...
sys_env_destroy(envid_t envid)
{
  ...
  800dc9:	68 2f 24 80 00       	push   $0x80242f
  800dce:	6a 23                	push   $0x23
  800dd0:	68 4c 24 80 00       	push   $0x80244c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800e4a:	68 2f 24 80 00       	push   $0x80242f
  800e4f:	6a 23                	push   $0x23
  800e51:	68 4c 24 80 00       	push   $0x80244c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800e8c:	68 2f 24 80 00       	push   $0x80242f
  800e91:	6a 23                	push   $0x23
  800e93:	68 4c 24 80 00       	push   $0x80244c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800ece:	68 2f 24 80 00       	push   $0x80242f
  800ed3:	6a 23                	push   $0x23
  800ed5:	68 4c 24 80 00       	push   $0x80244c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800f10:	68 2f 24 80 00       	push   $0x80242f
  800f15:	6a 23                	push   $0x23
  800f17:	68 4c 24 80 00       	push   $0x80244c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800f52:	68 2f 24 80 00       	push   $0x80242f
  800f57:	6a 23                	push   $0x23
  800f59:	68 4c 24 80 00       	push   $0x80244c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800f94:	68 2f 24 80 00       	push   $0x80242f
  800f99:	6a 23                	push   $0x23
  800f9b:	68 4c 24 80 00       	push   $0x80244c
...
sys_ipc_recv(void *dstva)
{
  ...
  800ff8:	68 2f 24 80 00       	push   $0x80242f
  800ffd:	6a 23                	push   $0x23
  800fff:	68 4c 24 80 00       	push   $0x80244c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8010e6:	ba dc 24 80 00       	mov    $0x8024dc,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801111:	51                   	push   %ecx
  801112:	50                   	push   %eax
  801113:	68 5c 24 80 00       	push   $0x80245c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80133b:	53                   	push   %ebx
  80133c:	50                   	push   %eax
  80133d:	68 a0 24 80 00       	push   $0x8024a0
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801410:	53                   	push   %ebx
  801411:	50                   	push   %eax
  801412:	68 bc 24 80 00       	push   $0x8024bc
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8014c5:	53                   	push   %ebx
  8014c6:	50                   	push   %eax
  8014c7:	68 7c 24 80 00       	push   $0x80247c
...
fsipc(unsigned type, void *dstva)
{
  ...
  8015d7:	e8 8b 07 00 00       	call   801d67 <ipc_find_env>
  ...
  8015f2:	e8 1c 07 00 00       	call   801d13 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80171b:	68 ec 24 80 00       	push   $0x8024ec
  801720:	68 f3 24 80 00       	push   $0x8024f3
  801725:	6a 7c                	push   $0x7c
  801727:	68 08 25 80 00       	push   $0x802508
  80172c:	e8 9b eb ff ff       	call   8002cc <_panic>
	assert(r <= PGSIZE);
  801731:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801736:	7e 16                	jle    80174e <devfile_read+0x65>
  801738:	68 13 25 80 00       	push   $0x802513
  80173d:	68 f3 24 80 00       	push   $0x8024f3
  801742:	6a 7d                	push   $0x7d
  801744:	68 08 25 80 00       	push   $0x802508
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801937:	68 1f 25 80 00       	push   $0x80251f
  80193c:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8019b3:	e8 e8 03 00 00       	call   801da0 <pageref>
  8019b8:	89 c3                	mov    %eax,%ebx
  8019ba:	89 3c 24             	mov    %edi,(%esp)
  8019bd:	e8 de 03 00 00       	call   801da0 <pageref>
  ...
  8019e7:	50                   	push   %eax
  8019e8:	56                   	push   %esi
  8019e9:	68 26 25 80 00       	push   $0x802526
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801cce:	68 00 00 c0 ee       	push   $0xeec00000
  801cd3:	e8 f8 f2 ff ff       	call   800fd0 <sys_ipc_recv>
  801cd8:	89 c2                	mov    %eax,%edx
		if (from_env_store) {
  801cda:	83 c4 10             	add    $0x10,%esp
  801cdd:	85 f6                	test   %esi,%esi
  801cdf:	74 13                	je     801cf4 <ipc_recv+0x79>
			*from_env_store = (r == 0) ? (thisenv->env_ipc_from) : 0;
  801ce1:	b8 00 00 00 00       	mov    $0x0,%eax
  801ce6:	85 d2                	test   %edx,%edx
  801ce8:	75 08                	jne    801cf2 <ipc_recv+0x77>
  801cea:	a1 04 44 80 00       	mov    0x804404,%eax
  801cef:	8b 40 74             	mov    0x74(%eax),%eax
  801cf2:	89 06                	mov    %eax,(%esi)
		}
		if (perm_store) {
  801cf4:	85 db                	test   %ebx,%ebx
  801cf6:	74 06                	je     801cfe <ipc_recv+0x83>
			*perm_store = 0;
  801cf8:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
		}
	}
  ...
  801d02:	75 08                	jne    801d0c <ipc_recv+0x91>
		// system call fails, return the error
		return r;
  ...
  801d09:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d25:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;
  801d27:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801d2c:	0f 44 d8             	cmove  %eax,%ebx

	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801d2f:	eb 1c                	jmp    801d4d <ipc_send+0x3a>
		if (r != -E_IPC_NOT_RECV) {
  801d31:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801d34:	74 12                	je     801d48 <ipc_send+0x35>
			panic("Sys ipc try send error: %e", r);
  801d36:	50                   	push   %eax
  801d37:	68 3e 25 80 00       	push   $0x80253e
  801d3c:	6a 4f                	push   $0x4f
  801d3e:	68 59 25 80 00       	push   $0x802559
  801d43:	e8 84 e5 ff ff       	call   8002cc <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801d48:	e8 b4 f0 ff ff       	call   800e01 <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
	...
	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801d4d:	ff 75 14             	pushl  0x14(%ebp)
  801d50:	53                   	push   %ebx
  801d51:	56                   	push   %esi
  801d52:	57                   	push   %edi
  801d53:	e8 55 f2 ff ff       	call   800fad <sys_ipc_try_send>
  801d58:	83 c4 10             	add    $0x10,%esp
  801d5b:	85 c0                	test   %eax,%eax
  801d5d:	78 d2                	js     801d31 <ipc_send+0x1e>
...
ipc_find_env(enum EnvType type)
{
  ...
  801d72:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801d75:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801d7b:	8b 52 50             	mov    0x50(%edx),%edx
  801d7e:	39 ca                	cmp    %ecx,%edx
  801d80:	75 0d                	jne    801d8f <ipc_find_env+0x28>
			return envs[i].env_id;
  801d82:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801d85:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801d8a:	8b 40 48             	mov    0x48(%eax),%eax
  801d8d:	eb 0f                	jmp    801d9e <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801d92:	3d 00 04 00 00       	cmp    $0x400,%eax
  801d97:	75 d9                	jne    801d72 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  801dab:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801db7:	f6 c1 01             	test   $0x1,%cl
  801dba:	74 1d                	je     801dd9 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801dbc:	c1 ea 0c             	shr    $0xc,%edx
  801dbf:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801dc6:	f6 c2 01             	test   $0x1,%dl
  801dc9:	74 0e                	je     801dd9 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801dcb:	c1 ea 0c             	shr    $0xc,%edx
  801dce:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801dd5:	ef 
  801dd6:	0f b7 c0             	movzwl %ax,%eax
}
  801dd9:	5d                   	pop    %ebp
  801dda:	c3                   	ret    

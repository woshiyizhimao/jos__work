...
fsipc(unsigned type, void *dstva)
{
  ...
  80091a:	e8 a3 11 00 00       	call   801ac2 <ipc_find_env>
  ...
  800935:	e8 34 11 00 00       	call   801a6e <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a7b:	68 cb 1e 80 00       	push   $0x801ecb
  800a80:	68 ab 1e 80 00       	push   $0x801eab
  800a85:	6a 7d                	push   $0x7d
  800a87:	68 c0 1e 80 00       	push   $0x801ec0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b6a:	68 d7 1e 80 00       	push   $0x801ed7
  800b6f:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800be6:	e8 10 0f 00 00       	call   801afb <pageref>
  800beb:	89 c3                	mov    %eax,%ebx
  800bed:	89 3c 24             	mov    %edi,(%esp)
  800bf0:	e8 06 0f 00 00       	call   801afb <pageref>
  ...
  800c1a:	50                   	push   %eax
  800c1b:	56                   	push   %esi
  800c1c:	68 de 1e 80 00       	push   $0x801ede
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ebe:	68 f6 1e 80 00       	push   $0x801ef6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80104d:	56                   	push   %esi
  80104e:	50                   	push   %eax
  80104f:	68 04 1f 80 00       	push   $0x801f04
  ...
  801060:	e8 54 00 00 00       	call   8010b9 <vcprintf>
	cprintf("\n");
  801065:	c7 04 24 ef 1e 80 00 	movl   $0x801eef,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80116d:	e8 ce 09 00 00       	call   801b40 <__udivdi3>
  ...
  8011b0:	e8 bb 0a 00 00       	call   801c70 <__umoddi3>
  8011b5:	83 c4 14             	add    $0x14,%esp
  8011b8:	0f be 80 27 1f 80 00 	movsbl 0x801f27(%eax),%eax
  8011bf:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8012b4:	ff 24 85 60 20 80 00 	jmp    *0x802060(,%eax,4)
  ...
  801378:	8b 14 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%edx
  80137f:	85 d2                	test   %edx,%edx
  801381:	75 18                	jne    80139b <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  801383:	50                   	push   %eax
  801384:	68 3f 1f 80 00       	push   $0x801f3f
  801389:	53                   	push   %ebx
  80138a:	56                   	push   %esi
  ...
  80139b:	52                   	push   %edx
  80139c:	68 bd 1e 80 00       	push   $0x801ebd
  8013a1:	53                   	push   %ebx
  8013a2:	56                   	push   %esi
  ...
  8013c0:	b8 38 1f 80 00       	mov    $0x801f38,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a51:	74 06                	je     801a59 <ipc_recv+0x83>
			*perm_store = 0;
  801a53:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
		}
	}
  ...
  801a5d:	75 08                	jne    801a67 <ipc_recv+0x91>
		// system call fails, return the error
		return r;
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a80:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;
  801a82:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  ...
  801a91:	50                   	push   %eax
  801a92:	68 20 22 80 00       	push   $0x802220
  801a97:	6a 4f                	push   $0x4f
  801a99:	68 3b 22 80 00       	push   $0x80223b
  801a9e:	e8 8e f5 ff ff       	call   801031 <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801aa3:	e8 9c e6 ff ff       	call   800144 <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
  ...
  801aac:	56                   	push   %esi
  801aad:	57                   	push   %edi
  801aae:	e8 3d e8 ff ff       	call   8002f0 <sys_ipc_try_send>
...
ipc_find_env(enum EnvType type)
{
  ...
  801ae0:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801ae5:	8b 40 48             	mov    0x48(%eax),%eax
  801ae8:	eb 0f                	jmp    801af9 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
...
pageref(void *v)
{
  ...
  801b06:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801b12:	f6 c1 01             	test   $0x1,%cl
  801b15:	74 1d                	je     801b34 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801b17:	c1 ea 0c             	shr    $0xc,%edx
  801b1a:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801b21:	f6 c2 01             	test   $0x1,%dl
  801b24:	74 0e                	je     801b34 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801b26:	c1 ea 0c             	shr    $0xc,%edx
  801b29:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801b30:	ef 
  801b31:	0f b7 c0             	movzwl %ax,%eax
}
  801b34:	5d                   	pop    %ebp
  801b35:	c3                   	ret    

	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002a6:	e8 e5 1c 00 00       	call   801f90 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800b31:	68 3f 24 80 00       	push   $0x80243f
  800b36:	6a 23                	push   $0x23
  800b38:	68 5c 24 80 00       	push   $0x80245c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bb2:	68 3f 24 80 00       	push   $0x80243f
  800bb7:	6a 23                	push   $0x23
  800bb9:	68 5c 24 80 00       	push   $0x80245c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bf4:	68 3f 24 80 00       	push   $0x80243f
  800bf9:	6a 23                	push   $0x23
  800bfb:	68 5c 24 80 00       	push   $0x80245c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c36:	68 3f 24 80 00       	push   $0x80243f
  800c3b:	6a 23                	push   $0x23
  800c3d:	68 5c 24 80 00       	push   $0x80245c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c78:	68 3f 24 80 00       	push   $0x80243f
  800c7d:	6a 23                	push   $0x23
  800c7f:	68 5c 24 80 00       	push   $0x80245c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800cba:	68 3f 24 80 00       	push   $0x80243f
  800cbf:	6a 23                	push   $0x23
  800cc1:	68 5c 24 80 00       	push   $0x80245c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cfc:	68 3f 24 80 00       	push   $0x80243f
  800d01:	6a 23                	push   $0x23
  800d03:	68 5c 24 80 00       	push   $0x80245c
...
sys_ipc_recv(void *dstva)
{
  ...
  800d60:	68 3f 24 80 00       	push   $0x80243f
  800d65:	6a 23                	push   $0x23
  800d67:	68 5c 24 80 00       	push   $0x80245c
...
argstart(int *argc, char **argv, struct Argstate *args)
{
  ...
  800d8f:	ba 11 21 80 00       	mov    $0x802111,%edx
...
argnextvalue(struct Argstate *args)
{
  ...
  800e50:	89 43 0c             	mov    %eax,0xc(%ebx)
		args->curarg = "";
  800e53:	c7 43 08 11 21 80 00 	movl   $0x802111,0x8(%ebx)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800fa2:	ba e8 24 80 00       	mov    $0x8024e8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800fcd:	51                   	push   %ecx
  800fce:	50                   	push   %eax
  800fcf:	68 6c 24 80 00       	push   $0x80246c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8011f7:	53                   	push   %ebx
  8011f8:	50                   	push   %eax
  8011f9:	68 ad 24 80 00       	push   $0x8024ad
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8012cc:	53                   	push   %ebx
  8012cd:	50                   	push   %eax
  8012ce:	68 c9 24 80 00       	push   $0x8024c9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801381:	53                   	push   %ebx
  801382:	50                   	push   %eax
  801383:	68 8c 24 80 00       	push   $0x80248c
...
fsipc(unsigned type, void *dstva)
{
  ...
  801493:	e8 54 09 00 00       	call   801dec <ipc_find_env>
  ...
  8014ae:	e8 e5 08 00 00       	call   801d98 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8015d7:	68 f8 24 80 00       	push   $0x8024f8
  8015dc:	68 ff 24 80 00       	push   $0x8024ff
  8015e1:	6a 7c                	push   $0x7c
  8015e3:	68 14 25 80 00       	push   $0x802514
  8015e8:	e8 cd 06 00 00       	call   801cba <_panic>
	assert(r <= PGSIZE);
  8015ed:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8015f2:	7e 16                	jle    80160a <devfile_read+0x65>
  8015f4:	68 1f 25 80 00       	push   $0x80251f
  8015f9:	68 ff 24 80 00       	push   $0x8024ff
  8015fe:	6a 7d                	push   $0x7d
  801600:	68 14 25 80 00       	push   $0x802514
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8017f3:	68 2b 25 80 00       	push   $0x80252b
  8017f8:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80186f:	e8 b1 05 00 00       	call   801e25 <pageref>
  801874:	89 c3                	mov    %eax,%ebx
  801876:	89 3c 24             	mov    %edi,(%esp)
  801879:	e8 a7 05 00 00       	call   801e25 <pageref>
  ...
  8018a3:	50                   	push   %eax
  8018a4:	56                   	push   %esi
  8018a5:	68 32 25 80 00       	push   $0x802532
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801b47:	68 4a 25 80 00       	push   $0x80254a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801cd6:	56                   	push   %esi
  801cd7:	50                   	push   %eax
  801cd8:	68 58 25 80 00       	push   $0x802558
  ...
  801ce9:	e8 c1 e4 ff ff       	call   8001af <vcprintf>
	cprintf("\n");
  801cee:	c7 04 24 10 21 80 00 	movl   $0x802110,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d39:	74 48                	je     801d83 <ipc_recv+0x83>
			*perm_store = (r == 0) ? (thisenv->env_ipc_perm) : 0;
  801d3b:	b8 00 00 00 00       	mov    $0x0,%eax
  801d40:	85 d2                	test   %edx,%edx
  801d42:	75 08                	jne    801d4c <ipc_recv+0x4c>
  801d44:	a1 04 40 80 00       	mov    0x804004,%eax
  801d49:	8b 40 78             	mov    0x78(%eax),%eax
  801d4c:	89 03                	mov    %eax,(%ebx)
  801d4e:	eb 33                	jmp    801d83 <ipc_recv+0x83>
		}
	}
	else {
  ...
  801d53:	68 00 00 c0 ee       	push   $0xeec00000
  801d58:	e8 db ef ff ff       	call   800d38 <sys_ipc_recv>
  801d5d:	89 c2                	mov    %eax,%edx
		if (from_env_store) {
  801d5f:	83 c4 10             	add    $0x10,%esp
  801d62:	85 f6                	test   %esi,%esi
  801d64:	74 13                	je     801d79 <ipc_recv+0x79>
			*from_env_store = (r == 0) ? (thisenv->env_ipc_from) : 0;
  801d66:	b8 00 00 00 00       	mov    $0x0,%eax
  801d6b:	85 d2                	test   %edx,%edx
  801d6d:	75 08                	jne    801d77 <ipc_recv+0x77>
  801d6f:	a1 04 40 80 00       	mov    0x804004,%eax
  801d74:	8b 40 74             	mov    0x74(%eax),%eax
  801d77:	89 06                	mov    %eax,(%esi)
		}
		if (perm_store) {
  801d79:	85 db                	test   %ebx,%ebx
  801d7b:	74 06                	je     801d83 <ipc_recv+0x83>
			*perm_store = 0;
  ...
  801d87:	75 08                	jne    801d91 <ipc_recv+0x91>
		// system call fails, return the error
		return r;
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801daa:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;
  801dac:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801db1:	0f 44 d8             	cmove  %eax,%ebx

	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  801db4:	eb 1c                	jmp    801dd2 <ipc_send+0x3a>
		if (r != -E_IPC_NOT_RECV) {
  801db6:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801db9:	74 12                	je     801dcd <ipc_send+0x35>
			panic("Sys ipc try send error: %e", r);
  801dbb:	50                   	push   %eax
  801dbc:	68 7c 25 80 00       	push   $0x80257c
  801dc1:	6a 4f                	push   $0x4f
  801dc3:	68 97 25 80 00       	push   $0x802597
  801dc8:	e8 ed fe ff ff       	call   801cba <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  801dcd:	e8 97 ed ff ff       	call   800b69 <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
  ...
  801dd6:	56                   	push   %esi
  801dd7:	57                   	push   %edi
  801dd8:	e8 38 ef ff ff       	call   800d15 <sys_ipc_try_send>
  801ddd:	83 c4 10             	add    $0x10,%esp
  801de0:	85 c0                	test   %eax,%eax
  801de2:	78 d2                	js     801db6 <ipc_send+0x1e>
...
ipc_find_env(enum EnvType type)
{
  ...
  801df7:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801dfa:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801e00:	8b 52 50             	mov    0x50(%edx),%edx
  801e03:	39 ca                	cmp    %ecx,%edx
  801e05:	75 0d                	jne    801e14 <ipc_find_env+0x28>
			return envs[i].env_id;
  801e07:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801e0a:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801e0f:	8b 40 48             	mov    0x48(%eax),%eax
  801e12:	eb 0f                	jmp    801e23 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801e17:	3d 00 04 00 00       	cmp    $0x400,%eax
  801e1c:	75 d9                	jne    801df7 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  801e2d:	c1 e8 16             	shr    $0x16,%eax
  801e30:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801e3c:	f6 c1 01             	test   $0x1,%cl
  801e3f:	74 1d                	je     801e5e <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801e41:	c1 ea 0c             	shr    $0xc,%edx
  801e44:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801e4b:	f6 c2 01             	test   $0x1,%dl
  801e4e:	74 0e                	je     801e5e <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801e50:	c1 ea 0c             	shr    $0xc,%edx
  801e53:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801e5a:	ef 

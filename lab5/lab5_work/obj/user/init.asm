...
umain(int argc, char **argv)
{
  ...
  8001ef:	e8 92 1b 00 00       	call   801d86 <spawnl>
		if (r < 0) {
  ...
  800211:	50                   	push   %eax
  800212:	e8 3e 1f 00 00       	call   802155 <wait>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80053b:	e8 d0 1d 00 00       	call   802310 <__udivdi3>
  ...
  80057e:	e8 bd 1e 00 00       	call   802440 <__umoddi3>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800682:	ff 24 85 60 28 80 00 	jmp    *0x802860(,%eax,4)
  ...
  800746:	8b 14 85 c0 29 80 00 	mov    0x8029c0(,%eax,4),%edx
  80074d:	85 d2                	test   %edx,%edx
  80074f:	75 18                	jne    800769 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  800751:	50                   	push   %eax
  800752:	68 27 27 80 00       	push   $0x802727
  800757:	53                   	push   %ebx
  800758:	56                   	push   %esi
  ...
  800769:	52                   	push   %edx
  80076a:	68 f1 2a 80 00       	push   $0x802af1
  80076f:	53                   	push   %ebx
  800770:	56                   	push   %esi
  ...
  80078e:	b8 20 27 80 00       	mov    $0x802720,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800e09:	68 1f 2a 80 00       	push   $0x802a1f
  800e0e:	6a 23                	push   $0x23
  800e10:	68 3c 2a 80 00       	push   $0x802a3c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800e8a:	68 1f 2a 80 00       	push   $0x802a1f
  800e8f:	6a 23                	push   $0x23
  800e91:	68 3c 2a 80 00       	push   $0x802a3c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800ecc:	68 1f 2a 80 00       	push   $0x802a1f
  800ed1:	6a 23                	push   $0x23
  800ed3:	68 3c 2a 80 00       	push   $0x802a3c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800f0e:	68 1f 2a 80 00       	push   $0x802a1f
  800f13:	6a 23                	push   $0x23
  800f15:	68 3c 2a 80 00       	push   $0x802a3c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800f50:	68 1f 2a 80 00       	push   $0x802a1f
  800f55:	6a 23                	push   $0x23
  800f57:	68 3c 2a 80 00       	push   $0x802a3c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800f92:	68 1f 2a 80 00       	push   $0x802a1f
  800f97:	6a 23                	push   $0x23
  800f99:	68 3c 2a 80 00       	push   $0x802a3c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800fd4:	68 1f 2a 80 00       	push   $0x802a1f
  800fd9:	6a 23                	push   $0x23
  800fdb:	68 3c 2a 80 00       	push   $0x802a3c
...
sys_ipc_recv(void *dstva)
{
  ...
  801038:	68 1f 2a 80 00       	push   $0x802a1f
  80103d:	6a 23                	push   $0x23
  80103f:	68 3c 2a 80 00       	push   $0x802a3c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801126:	ba c8 2a 80 00       	mov    $0x802ac8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801151:	51                   	push   %ecx
  801152:	50                   	push   %eax
  801153:	68 4c 2a 80 00       	push   $0x802a4c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80137b:	53                   	push   %ebx
  80137c:	50                   	push   %eax
  80137d:	68 8d 2a 80 00       	push   $0x802a8d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801450:	53                   	push   %ebx
  801451:	50                   	push   %eax
  801452:	68 a9 2a 80 00       	push   $0x802aa9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801505:	53                   	push   %ebx
  801506:	50                   	push   %eax
  801507:	68 6c 2a 80 00       	push   $0x802a6c
...
fsipc(unsigned type, void *dstva)
{
  ...
  801617:	e8 74 0c 00 00       	call   802290 <ipc_find_env>
  ...
  801632:	e8 05 0c 00 00       	call   80223c <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  801637:	83 c4 0c             	add    $0xc,%esp
  80163a:	6a 00                	push   $0x0
  80163c:	53                   	push   %ebx
  80163d:	6a 00                	push   $0x0
  80163f:	e8 60 0b 00 00       	call   8021a4 <ipc_recv>
}
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80175b:	68 d8 2a 80 00       	push   $0x802ad8
  801760:	68 df 2a 80 00       	push   $0x802adf
  801765:	6a 7c                	push   $0x7c
  801767:	68 f4 2a 80 00       	push   $0x802af4
  80176c:	e8 8e ec ff ff       	call   8003ff <_panic>
	assert(r <= PGSIZE);
  801771:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801776:	7e 16                	jle    80178e <devfile_read+0x65>
  801778:	68 ff 2a 80 00       	push   $0x802aff
  80177d:	68 df 2a 80 00       	push   $0x802adf
  801782:	6a 7d                	push   $0x7d
  801784:	68 f4 2a 80 00       	push   $0x802af4
...
spawn(const char *prog, const char **argv)
{
  ...
  801872:	0f 88 a4 04 00 00    	js     801d1c <spawn+0x4cd>
		return r;
	fd = r;
...
sys_exofork(void)
{
  ...
  8018eb:	0f 88 33 04 00 00    	js     801d24 <spawn+0x4d5>
		return r;
	child = r;
  ...
  80197a:	0f 86 b4 03 00 00    	jbe    801d34 <spawn+0x4e5>
		return -E_NO_MEM;
  ...
  801996:	0f 88 9f 03 00 00    	js     801d3b <spawn+0x4ec>
  ...
  8019ff:	68 80 2b 80 00       	push   $0x802b80
  801a04:	68 df 2a 80 00       	push   $0x802adf
  801a09:	68 f1 00 00 00       	push   $0xf1
  801a0e:	68 25 2b 80 00       	push   $0x802b25
  ...
  801a60:	0f 88 04 03 00 00    	js     801d6a <spawn+0x51b>
		goto error;
  ...
  801a7c:	0f 88 e8 02 00 00    	js     801d6a <spawn+0x51b>
  ...
  801a9c:	00 00 00 
  801a9f:	e9 88 01 00 00       	jmp    801c2c <spawn+0x3dd>
		if (ph->p_type != ELF_PROG_LOAD)
  801aa4:	8b 85 7c fd ff ff    	mov    -0x284(%ebp),%eax
  801aaa:	83 38 01             	cmpl   $0x1,(%eax)
  801aad:	0f 85 6b 01 00 00    	jne    801c1e <spawn+0x3cf>
			continue;
		perm = PTE_P | PTE_U;
  ...
  801ae2:	8b 50 14             	mov    0x14(%eax),%edx
  801ae5:	89 95 90 fd ff ff    	mov    %edx,-0x270(%ebp)
  801aeb:	8b 70 08             	mov    0x8(%eax),%esi
	int i, r;
	void *blk;
  ...
  801af0:	25 ff 0f 00 00       	and    $0xfff,%eax
  801af5:	74 14                	je     801b0b <spawn+0x2bc>
		va -= i;
  801af7:	29 c6                	sub    %eax,%esi
		memsz += i;
  801af9:	01 c2                	add    %eax,%edx
  801afb:	89 95 90 fd ff ff    	mov    %edx,-0x270(%ebp)
		filesz += i;
  801b01:	01 c7                	add    %eax,%edi
		fileoffset -= i;
  801b03:	29 c1                	sub    %eax,%ecx
  801b05:	89 8d 80 fd ff ff    	mov    %ecx,-0x280(%ebp)
	}

	for (i = 0; i < memsz; i += PGSIZE) {
  801b0b:	bb 00 00 00 00       	mov    $0x0,%ebx
  801b10:	e9 f7 00 00 00       	jmp    801c0c <spawn+0x3bd>
		if (i >= filesz) {
  801b15:	39 df                	cmp    %ebx,%edi
  801b17:	77 27                	ja     801b40 <spawn+0x2f1>
			// allocate a blank page
			if ((r = sys_page_alloc(child, (void*) (va + i), perm)) < 0)
  801b19:	83 ec 04             	sub    $0x4,%esp
  801b1c:	ff b5 88 fd ff ff    	pushl  -0x278(%ebp)
  801b22:	56                   	push   %esi
  801b23:	ff b5 84 fd ff ff    	pushl  -0x27c(%ebp)
  801b29:	e8 32 f3 ff ff       	call   800e60 <sys_page_alloc>
  801b2e:	83 c4 10             	add    $0x10,%esp
  801b31:	85 c0                	test   %eax,%eax
  801b33:	0f 89 c7 00 00 00    	jns    801c00 <spawn+0x3b1>
  801b39:	89 c3                	mov    %eax,%ebx
  801b3b:	e9 09 02 00 00       	jmp    801d49 <spawn+0x4fa>
				return r;
		} else {
			// from file
  ...
  801b4c:	e8 0f f3 ff ff       	call   800e60 <sys_page_alloc>
  801b51:	83 c4 10             	add    $0x10,%esp
  801b54:	85 c0                	test   %eax,%eax
  801b56:	0f 88 e3 01 00 00    	js     801d3f <spawn+0x4f0>
				return r;
			if ((r = seek(fd, fileoffset + i)) < 0)
  801b5c:	83 ec 08             	sub    $0x8,%esp
  801b5f:	8b 85 80 fd ff ff    	mov    -0x280(%ebp),%eax
  801b65:	03 85 94 fd ff ff    	add    -0x26c(%ebp),%eax
  801b6b:	50                   	push   %eax
  801b6c:	ff b5 8c fd ff ff    	pushl  -0x274(%ebp)
  801b72:	e8 1c f9 ff ff       	call   801493 <seek>
  801b77:	83 c4 10             	add    $0x10,%esp
  801b7a:	85 c0                	test   %eax,%eax
  801b7c:	0f 88 c1 01 00 00    	js     801d43 <spawn+0x4f4>
				return r;
			if ((r = readn(fd, UTEMP, MIN(PGSIZE, filesz-i))) < 0)
  801b82:	83 ec 04             	sub    $0x4,%esp
  801b85:	89 f8                	mov    %edi,%eax
  801b87:	2b 85 94 fd ff ff    	sub    -0x26c(%ebp),%eax
  801b8d:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801b92:	ba 00 10 00 00       	mov    $0x1000,%edx
  801b97:	0f 47 c2             	cmova  %edx,%eax
  801b9a:	50                   	push   %eax
  801b9b:	68 00 00 40 00       	push   $0x400000
  801ba0:	ff b5 8c fd ff ff    	pushl  -0x274(%ebp)
  801ba6:	e8 13 f8 ff ff       	call   8013be <readn>
  801bab:	83 c4 10             	add    $0x10,%esp
  801bae:	85 c0                	test   %eax,%eax
  801bb0:	0f 88 91 01 00 00    	js     801d47 <spawn+0x4f8>
				return r;
			if ((r = sys_page_map(0, UTEMP, child, (void*) (va + i), perm)) < 0)
  801bb6:	83 ec 0c             	sub    $0xc,%esp
  801bb9:	ff b5 88 fd ff ff    	pushl  -0x278(%ebp)
  801bbf:	56                   	push   %esi
  801bc0:	ff b5 84 fd ff ff    	pushl  -0x27c(%ebp)
  801bc6:	68 00 00 40 00       	push   $0x400000
  801bcb:	6a 00                	push   $0x0
  801bcd:	e8 d1 f2 ff ff       	call   800ea3 <sys_page_map>
  801bd2:	83 c4 20             	add    $0x20,%esp
  801bd5:	85 c0                	test   %eax,%eax
  801bd7:	79 15                	jns    801bee <spawn+0x39f>
				panic("spawn: sys_page_map data: %e", r);
  801bd9:	50                   	push   %eax
  801bda:	68 31 2b 80 00       	push   $0x802b31
  801bdf:	68 24 01 00 00       	push   $0x124
  801be4:	68 25 2b 80 00       	push   $0x802b25
  801be9:	e8 11 e8 ff ff       	call   8003ff <_panic>
			sys_page_unmap(0, UTEMP);
  801bee:	83 ec 08             	sub    $0x8,%esp
  801bf1:	68 00 00 40 00       	push   $0x400000
  801bf6:	6a 00                	push   $0x0
  801bf8:	e8 e8 f2 ff ff       	call   800ee5 <sys_page_unmap>
  ...
  801c06:	81 c6 00 10 00 00    	add    $0x1000,%esi
  801c0c:	89 9d 94 fd ff ff    	mov    %ebx,-0x26c(%ebp)
  801c12:	39 9d 90 fd ff ff    	cmp    %ebx,-0x270(%ebp)
  801c18:	0f 87 f7 fe ff ff    	ja     801b15 <spawn+0x2c6>
	if ((r = init_stack(child, argv, &child_tf.tf_esp)) < 0)
		return r;
	...
	ph = (struct Proghdr*) (elf_buf + elf->e_phoff);
	for (i = 0; i < elf->e_phnum; i++, ph++) {
  801c1e:	83 85 78 fd ff ff 01 	addl   $0x1,-0x288(%ebp)
  801c25:	83 85 7c fd ff ff 20 	addl   $0x20,-0x284(%ebp)
  801c2c:	0f b7 85 14 fe ff ff 	movzwl -0x1ec(%ebp),%eax
  801c33:	39 85 78 fd ff ff    	cmp    %eax,-0x288(%ebp)
  801c39:	0f 8c 65 fe ff ff    	jl     801aa4 <spawn+0x255>
			perm |= PTE_W;
		if ((r = map_segment(child, ph->p_va, ph->p_memsz,
  ...
  801c42:	ff b5 8c fd ff ff    	pushl  -0x274(%ebp)
  801c48:	e8 a4 f5 ff ff       	call   8011f1 <close>
...
copy_shared_pages(envid_t child)
{
  ...
  801c55:	8b b5 84 fd ff ff    	mov    -0x27c(%ebp),%esi
  ...
  801c69:	74 46                	je     801cb1 <spawn+0x462>
  801c6b:	89 d8                	mov    %ebx,%eax
  801c6d:	c1 e8 0c             	shr    $0xc,%eax
  801c70:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  801c77:	f6 c2 01             	test   $0x1,%dl
  801c7a:	74 35                	je     801cb1 <spawn+0x462>
			(uvpt[PGNUM(addr)] & PTE_U) && (uvpt[PGNUM(addr)] & PTE_SHARE)) {
  801c7c:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
{
	// LAB 5: Your code here.
	//EDIT BY Lethe 2018/12/14
	uintptr_t addr;
	for (addr = 0; addr < UTOP; addr += PGSIZE) {
		if ((uvpd[PDX(addr)] & PTE_P) && (uvpt[PGNUM(addr)] & PTE_P) &&
  801c83:	f6 c2 04             	test   $0x4,%dl
  801c86:	74 29                	je     801cb1 <spawn+0x462>
			(uvpt[PGNUM(addr)] & PTE_U) && (uvpt[PGNUM(addr)] & PTE_SHARE)) {
  801c88:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  801c8f:	f6 c6 04             	test   $0x4,%dh
  801c92:	74 1d                	je     801cb1 <spawn+0x462>
			sys_page_map(0, (void*)addr, child, (void*)addr, (uvpt[PGNUM(addr)] & PTE_SYSCALL));
  801c94:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
  ...
  801ca9:	e8 f5 f1 ff ff       	call   800ea3 <sys_page_map>
...
copy_shared_pages(envid_t child)
{
	...
	uintptr_t addr;
	for (addr = 0; addr < UTOP; addr += PGSIZE) {
  801cb1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  801cb7:	81 fb 00 00 c0 ee    	cmp    $0xeec00000,%ebx
  801cbd:	75 9c                	jne    801c5b <spawn+0x40c>
  ...
  801cc2:	8d 85 a4 fd ff ff    	lea    -0x25c(%ebp),%eax
  801cc8:	50                   	push   %eax
  801cc9:	ff b5 74 fd ff ff    	pushl  -0x28c(%ebp)
  801ccf:	e8 95 f2 ff ff       	call   800f69 <sys_env_set_trapframe>
  801cd4:	83 c4 10             	add    $0x10,%esp
  801cd7:	85 c0                	test   %eax,%eax
  801cd9:	79 15                	jns    801cf0 <spawn+0x4a1>
		panic("sys_env_set_trapframe: %e", r);
  801cdb:	50                   	push   %eax
  801cdc:	68 4e 2b 80 00       	push   $0x802b4e
  801ce1:	68 85 00 00 00       	push   $0x85
  801ce6:	68 25 2b 80 00       	push   $0x802b25
  801ceb:	e8 0f e7 ff ff       	call   8003ff <_panic>

	if ((r = sys_env_set_status(child, ENV_RUNNABLE)) < 0)
  801cf0:	83 ec 08             	sub    $0x8,%esp
  801cf3:	6a 02                	push   $0x2
  801cf5:	ff b5 74 fd ff ff    	pushl  -0x28c(%ebp)
  801cfb:	e8 27 f2 ff ff       	call   800f27 <sys_env_set_status>
  801d00:	83 c4 10             	add    $0x10,%esp
  801d03:	85 c0                	test   %eax,%eax
  801d05:	79 25                	jns    801d2c <spawn+0x4dd>
		panic("sys_env_set_status: %e", r);
  801d07:	50                   	push   %eax
  801d08:	68 68 2b 80 00       	push   $0x802b68
  801d0d:	68 88 00 00 00       	push   $0x88
  801d12:	68 25 2b 80 00       	push   $0x802b25
  801d17:	e8 e3 e6 ff ff       	call   8003ff <_panic>
	//     correct initial eip and esp values in the child.
	//
	//   - Start the child process running with sys_env_set_status().
	...
	if ((r = open(prog, O_RDONLY)) < 0)
		return r;
  801d1c:	8b 9d 8c fd ff ff    	mov    -0x274(%ebp),%ebx
  801d22:	eb 58                	jmp    801d7c <spawn+0x52d>
		return -E_NOT_EXEC;
	}
  ...
  801d2a:	eb 50                	jmp    801d7c <spawn+0x52d>
		panic("sys_env_set_trapframe: %e", r);
	...
	return child;
  801d2c:	8b 9d 74 fd ff ff    	mov    -0x28c(%ebp),%ebx
  801d32:	eb 48                	jmp    801d7c <spawn+0x52d>
	argv_store = (uintptr_t*) (ROUNDDOWN(string_store, 4) - 4 * (argc + 1));
	...
	if ((void*) (argv_store - 2) < (void*) UTEMP)
		return -E_NO_MEM;
  801d34:	bb fc ff ff ff       	mov    $0xfffffffc,%ebx
  801d39:	eb 41                	jmp    801d7c <spawn+0x52d>

	// Allocate the single stack page at UTEMP.
	if ((r = sys_page_alloc(0, (void*) UTEMP, PTE_P|PTE_U|PTE_W)) < 0)
		return r;
  801d3b:	89 c3                	mov    %eax,%ebx
  801d3d:	eb 3d                	jmp    801d7c <spawn+0x52d>
			// allocate a blank page
			if ((r = sys_page_alloc(child, (void*) (va + i), perm)) < 0)
				return r;
		} else {
  ...
  801d41:	eb 06                	jmp    801d49 <spawn+0x4fa>
				return r;
			if ((r = seek(fd, fileoffset + i)) < 0)
  801d43:	89 c3                	mov    %eax,%ebx
  801d45:	eb 02                	jmp    801d49 <spawn+0x4fa>
				return r;
			if ((r = readn(fd, UTEMP, MIN(PGSIZE, filesz-i))) < 0)
...
error:
  ...
  801d4c:	ff b5 74 fd ff ff    	pushl  -0x28c(%ebp)
  801d52:	e8 8a f0 ff ff       	call   800de1 <sys_env_destroy>
	close(fd);
  801d57:	83 c4 04             	add    $0x4,%esp
  801d5a:	ff b5 8c fd ff ff    	pushl  -0x274(%ebp)
  801d60:	e8 8c f4 ff ff       	call   8011f1 <close>
	return r;
  801d65:	83 c4 10             	add    $0x10,%esp
  801d68:	eb 12                	jmp    801d7c <spawn+0x52d>
		goto error;
...
error:
  ...
  801d74:	e8 6c f1 ff ff       	call   800ee5 <sys_page_unmap>
...
spawnl(const char *prog, const char *arg0, ...)
{
  ...
  801d8b:	8d 55 10             	lea    0x10(%ebp),%edx
{
  ...
  801d8e:	b8 00 00 00 00       	mov    $0x0,%eax
	...
	va_start(vl, arg0);
	while(va_arg(vl, void *) != NULL)
  801d93:	eb 03                	jmp    801d98 <spawnl+0x12>
		argc++;
  801d95:	83 c0 01             	add    $0x1,%eax
	...
	va_start(vl, arg0);
	while(va_arg(vl, void *) != NULL)
  801d98:	83 c2 04             	add    $0x4,%edx
  801d9b:	83 7a fc 00          	cmpl   $0x0,-0x4(%edx)
  801d9f:	75 f4                	jne    801d95 <spawnl+0xf>
		argc++;
	va_end(vl);
  ...
  801da1:	8d 14 85 1a 00 00 00 	lea    0x1a(,%eax,4),%edx
  801da8:	83 e2 f0             	and    $0xfffffff0,%edx
  801dab:	29 d4                	sub    %edx,%esp
  801dad:	8d 54 24 03          	lea    0x3(%esp),%edx
  801db1:	c1 ea 02             	shr    $0x2,%edx
  801db4:	8d 34 95 00 00 00 00 	lea    0x0(,%edx,4),%esi
  801dbb:	89 f3                	mov    %esi,%ebx
	argv[0] = arg0;
  801dbd:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  801dc0:	89 0c 95 00 00 00 00 	mov    %ecx,0x0(,%edx,4)
	argv[argc+1] = NULL;
  801dc7:	c7 44 86 04 00 00 00 	movl   $0x0,0x4(%esi,%eax,4)
  801dce:	00 
  ...
  801dd6:	eb 0a                	jmp    801de2 <spawnl+0x5c>
		argv[i+1] = va_arg(vl, const char *);
  801dd8:	83 c0 01             	add    $0x1,%eax
  801ddb:	8b 4c 85 0c          	mov    0xc(%ebp,%eax,4),%ecx
  801ddf:	89 0c 83             	mov    %ecx,(%ebx,%eax,4)
	argv[0] = arg0;
	argv[argc+1] = NULL;
  ...
  801de4:	75 f2                	jne    801dd8 <spawnl+0x52>
		argv[i+1] = va_arg(vl, const char *);
	va_end(vl);
  ...
  801ded:	e8 5d fa ff ff       	call   80184f <spawn>
}
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801dfc:	56                   	push   %esi
  801dfd:	53                   	push   %ebx
  801dfe:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	struct Pipe *p = (struct Pipe*) fd2data(fd);
  801e01:	83 ec 0c             	sub    $0xc,%esp
  801e04:	ff 75 08             	pushl  0x8(%ebp)
  801e07:	e8 55 f2 ff ff       	call   801061 <fd2data>
  801e0c:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  801e0e:	83 c4 08             	add    $0x8,%esp
  801e11:	68 a8 2b 80 00       	push   $0x802ba8
  801e16:	53                   	push   %ebx
  801e17:	e8 41 ec ff ff       	call   800a5d <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  801e1c:	8b 46 04             	mov    0x4(%esi),%eax
  801e1f:	2b 06                	sub    (%esi),%eax
  801e21:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  801e27:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  801e2e:	00 00 00 
	stat->st_dev = &devpipe;
  801e31:	c7 83 88 00 00 00 ac 	movl   $0x8047ac,0x88(%ebx)
  801e38:	47 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  801e4e:	8b 5d 08             	mov    0x8(%ebp),%ebx
	(void) sys_page_unmap(0, fd);
  801e51:	53                   	push   %ebx
  801e52:	6a 00                	push   $0x0
  801e54:	e8 8c f0 ff ff       	call   800ee5 <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801e59:	89 1c 24             	mov    %ebx,(%esp)
  801e5c:	e8 00 f2 ff ff       	call   801061 <fd2data>
  801e61:	83 c4 08             	add    $0x8,%esp
  801e64:	50                   	push   %eax
  801e65:	6a 00                	push   $0x0
  801e67:	e8 79 f0 ff ff       	call   800ee5 <sys_page_unmap>
}
  801e6c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801e6f:	c9                   	leave  
  801e70:	c3                   	ret    

00801e71 <_pipeisclosed>:
	return r;
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801e7a:	89 45 e0             	mov    %eax,-0x20(%ebp)
  801e7d:	89 d7                	mov    %edx,%edi
	int n, nn, ret;

	while (1) {
		n = thisenv->env_runs;
  801e7f:	a1 90 67 80 00       	mov    0x806790,%eax
  801e84:	8b 70 58             	mov    0x58(%eax),%esi
		ret = pageref(fd) == pageref(p);
  801e87:	83 ec 0c             	sub    $0xc,%esp
  801e8a:	ff 75 e0             	pushl  -0x20(%ebp)
  801e8d:	e8 37 04 00 00       	call   8022c9 <pageref>
  801e92:	89 c3                	mov    %eax,%ebx
  801e94:	89 3c 24             	mov    %edi,(%esp)
  801e97:	e8 2d 04 00 00       	call   8022c9 <pageref>
  801e9c:	83 c4 10             	add    $0x10,%esp
  801e9f:	39 c3                	cmp    %eax,%ebx
  801ea1:	0f 94 c1             	sete   %cl
  801ea4:	0f b6 c9             	movzbl %cl,%ecx
  801ea7:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  801eaa:	8b 15 90 67 80 00    	mov    0x806790,%edx
  801eb0:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  801eb3:	39 ce                	cmp    %ecx,%esi
  801eb5:	74 1b                	je     801ed2 <_pipeisclosed+0x61>
			return ret;
		if (n != nn && ret == 1)
  801eb7:	39 c3                	cmp    %eax,%ebx
  801eb9:	75 c4                	jne    801e7f <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  801ebb:	8b 42 58             	mov    0x58(%edx),%eax
  801ebe:	ff 75 e4             	pushl  -0x1c(%ebp)
  801ec1:	50                   	push   %eax
  801ec2:	56                   	push   %esi
  801ec3:	68 af 2b 80 00       	push   $0x802baf
  801ec8:	e8 0b e6 ff ff       	call   8004d8 <cprintf>
  801ecd:	83 c4 10             	add    $0x10,%esp
  801ed0:	eb ad                	jmp    801e7f <_pipeisclosed+0xe>
	}
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801ee9:	56                   	push   %esi
  801eea:	e8 72 f1 ff ff       	call   801061 <fd2data>
  ...
  801ef9:	eb 4b                	jmp    801f46 <devpipe_write+0x69>
  ...
  801eff:	e8 6d ff ff ff       	call   801e71 <_pipeisclosed>
  801f04:	85 c0                	test   %eax,%eax
  801f06:	75 48                	jne    801f50 <devpipe_write+0x73>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_write yield\n");
			sys_yield();
  801f08:	e8 34 ef ff ff       	call   800e41 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	for (i = 0; i < n; i++) {
		while (p->p_wpos >= p->p_rpos + sizeof(p->p_buf)) {
  801f0d:	8b 43 04             	mov    0x4(%ebx),%eax
  801f10:	8b 0b                	mov    (%ebx),%ecx
  801f12:	8d 51 20             	lea    0x20(%ecx),%edx
  801f15:	39 d0                	cmp    %edx,%eax
  801f17:	73 e2                	jae    801efb <devpipe_write+0x1e>
				cprintf("devpipe_write yield\n");
			sys_yield();
		}
  ...
  801f1c:	0f b6 0c 39          	movzbl (%ecx,%edi,1),%ecx
  801f20:	88 4d e7             	mov    %cl,-0x19(%ebp)
  801f23:	89 c2                	mov    %eax,%edx
  801f25:	c1 fa 1f             	sar    $0x1f,%edx
  801f28:	89 d1                	mov    %edx,%ecx
  801f2a:	c1 e9 1b             	shr    $0x1b,%ecx
  801f2d:	8d 14 08             	lea    (%eax,%ecx,1),%edx
  801f30:	83 e2 1f             	and    $0x1f,%edx
  801f33:	29 ca                	sub    %ecx,%edx
  801f35:	0f b6 4d e7          	movzbl -0x19(%ebp),%ecx
  801f39:	88 4c 13 08          	mov    %cl,0x8(%ebx,%edx,1)
		p->p_wpos++;
  801f3d:	83 c0 01             	add    $0x1,%eax
  801f40:	89 43 04             	mov    %eax,0x4(%ebx)
	if (debug)
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	buf = vbuf;
	for (i = 0; i < n; i++) {
  801f43:	83 c7 01             	add    $0x1,%edi
  801f46:	3b 7d 10             	cmp    0x10(%ebp),%edi
  801f49:	75 c2                	jne    801f0d <devpipe_write+0x30>
		// wait to increment wpos until the byte is stored!
		p->p_buf[p->p_wpos % PIPEBUFSIZ] = buf[i];
		p->p_wpos++;
	}
  ...
  801f4e:	eb 05                	jmp    801f55 <devpipe_write+0x78>
			// pipe is full
			// if all the readers are gone
			// (it's only writers like us now),
			// note eof
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801f66:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  801f69:	57                   	push   %edi
  801f6a:	e8 f2 f0 ff ff       	call   801061 <fd2data>
  ...
  801f79:	eb 3d                	jmp    801fb8 <devpipe_read+0x5b>
		while (p->p_rpos == p->p_wpos) {
			// pipe is empty
			// if we got any data, return it
			if (i > 0)
  801f7b:	85 db                	test   %ebx,%ebx
  801f7d:	74 04                	je     801f83 <devpipe_read+0x26>
				return i;
  801f7f:	89 d8                	mov    %ebx,%eax
  801f81:	eb 44                	jmp    801fc7 <devpipe_read+0x6a>
			// if all the writers are gone, note eof
			if (_pipeisclosed(fd, p))
  801f83:	89 f2                	mov    %esi,%edx
  801f85:	89 f8                	mov    %edi,%eax
  801f87:	e8 e5 fe ff ff       	call   801e71 <_pipeisclosed>
  801f8c:	85 c0                	test   %eax,%eax
  801f8e:	75 32                	jne    801fc2 <devpipe_read+0x65>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_read yield\n");
			sys_yield();
  801f90:	e8 ac ee ff ff       	call   800e41 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	for (i = 0; i < n; i++) {
		while (p->p_rpos == p->p_wpos) {
  801f95:	8b 06                	mov    (%esi),%eax
  801f97:	3b 46 04             	cmp    0x4(%esi),%eax
  801f9a:	74 df                	je     801f7b <devpipe_read+0x1e>
				cprintf("devpipe_read yield\n");
			sys_yield();
		}
  ...
  801f9c:	99                   	cltd   
  801f9d:	c1 ea 1b             	shr    $0x1b,%edx
  801fa0:	01 d0                	add    %edx,%eax
  801fa2:	83 e0 1f             	and    $0x1f,%eax
  801fa5:	29 d0                	sub    %edx,%eax
  801fa7:	0f b6 44 06 08       	movzbl 0x8(%esi,%eax,1),%eax
  801fac:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  801faf:	88 04 19             	mov    %al,(%ecx,%ebx,1)
		p->p_rpos++;
  801fb2:	83 06 01             	addl   $0x1,(%esi)
	if (debug)
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	buf = vbuf;
	for (i = 0; i < n; i++) {
  801fb5:	83 c3 01             	add    $0x1,%ebx
  801fb8:	3b 5d 10             	cmp    0x10(%ebp),%ebx
  801fbb:	75 d8                	jne    801f95 <devpipe_read+0x38>
		// there's a byte.  take it.
		// wait to increment rpos until the byte is taken!
		buf[i] = p->p_buf[p->p_rpos % PIPEBUFSIZ];
		p->p_rpos++;
  ...
  801fc0:	eb 05                	jmp    801fc7 <devpipe_read+0x6a>
			// if we got any data, return it
			if (i > 0)
				return i;
			// if all the writers are gone, note eof
...
pipe(int pfd[2])
{
  ...
  80204a:	e8 12 f0 ff ff       	call   801061 <fd2data>
  80204f:	89 c6                	mov    %eax,%esi
	if ((r = sys_page_alloc(0, va, PTE_P|PTE_W|PTE_U|PTE_SHARE)) < 0)
  802051:	83 c4 0c             	add    $0xc,%esp
  802054:	68 07 04 00 00       	push   $0x407
  802059:	50                   	push   %eax
  80205a:	6a 00                	push   $0x0
  80205c:	e8 ff ed ff ff       	call   800e60 <sys_page_alloc>
  802061:	89 c3                	mov    %eax,%ebx
  802063:	83 c4 10             	add    $0x10,%esp
  802066:	85 c0                	test   %eax,%eax
  802068:	0f 88 89 00 00 00    	js     8020f7 <pipe+0x128>
		goto err2;
	if ((r = sys_page_map(0, va, 0, fd2data(fd1), PTE_P|PTE_W|PTE_U|PTE_SHARE)) < 0)
  80206e:	83 ec 0c             	sub    $0xc,%esp
  802071:	ff 75 f0             	pushl  -0x10(%ebp)
  802074:	e8 e8 ef ff ff       	call   801061 <fd2data>
  802079:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  802080:	50                   	push   %eax
  802081:	6a 00                	push   $0x0
  802083:	56                   	push   %esi
  802084:	6a 00                	push   $0x0
  802086:	e8 18 ee ff ff       	call   800ea3 <sys_page_map>
  80208b:	89 c3                	mov    %eax,%ebx
  80208d:	83 c4 20             	add    $0x20,%esp
  802090:	85 c0                	test   %eax,%eax
  802092:	78 55                	js     8020e9 <pipe+0x11a>
		goto err3;
  ...
  8020a9:	8b 15 ac 47 80 00    	mov    0x8047ac,%edx
  ...
  8020c4:	e8 88 ef ff ff       	call   801051 <fd2num>
  8020c9:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8020cc:	89 01                	mov    %eax,(%ecx)
	pfd[1] = fd2num(fd1);
  8020ce:	83 c4 04             	add    $0x4,%esp
  8020d1:	ff 75 f0             	pushl  -0x10(%ebp)
  8020d4:	e8 78 ef ff ff       	call   801051 <fd2num>
  ...
  8020e7:	eb 30                	jmp    802119 <pipe+0x14a>
  ...
  8020ef:	e8 f1 ed ff ff       	call   800ee5 <sys_page_unmap>
  ...
  8020ff:	e8 e1 ed ff ff       	call   800ee5 <sys_page_unmap>
  ...
  80210f:	e8 d1 ed ff ff       	call   800ee5 <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  80212f:	e8 93 ef ff ff       	call   8010c7 <fd_lookup>
  ...
  802141:	e8 1b ef ff ff       	call   801061 <fd2data>
	return _pipeisclosed(fd, p);
  802146:	89 c2                	mov    %eax,%edx
  802148:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80214b:	e8 21 fd ff ff       	call   801e71 <_pipeisclosed>
...
wait(envid_t envid)
{
  ...
  802158:	56                   	push   %esi
  802159:	53                   	push   %ebx
  80215a:	8b 75 08             	mov    0x8(%ebp),%esi
	const volatile struct Env *e;

	assert(envid != 0);
  80215d:	85 f6                	test   %esi,%esi
  80215f:	75 16                	jne    802177 <wait+0x22>
  802161:	68 c7 2b 80 00       	push   $0x802bc7
  802166:	68 df 2a 80 00       	push   $0x802adf
  80216b:	6a 09                	push   $0x9
  80216d:	68 d2 2b 80 00       	push   $0x802bd2
  802172:	e8 88 e2 ff ff       	call   8003ff <_panic>
	e = &envs[ENVX(envid)];
  ...
  802188:	eb 05                	jmp    80218f <wait+0x3a>
		sys_yield();
  80218a:	e8 b2 ec ff ff       	call   800e41 <sys_yield>
{
	const volatile struct Env *e;
	...
	e = &envs[ENVX(envid)];
	while (e->env_id == envid && e->env_status != ENV_FREE)
  80218f:	8b 43 48             	mov    0x48(%ebx),%eax
  802192:	39 c6                	cmp    %eax,%esi
  802194:	75 07                	jne    80219d <wait+0x48>
  802196:	8b 43 54             	mov    0x54(%ebx),%eax
  802199:	85 c0                	test   %eax,%eax
  80219b:	75 ed                	jne    80218a <wait+0x35>
		sys_yield();
}
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8021f7:	68 00 00 c0 ee       	push   $0xeec00000
  8021fc:	e8 0f ee ff ff       	call   801010 <sys_ipc_recv>
  802201:	89 c2                	mov    %eax,%edx
		if (from_env_store) {
  802203:	83 c4 10             	add    $0x10,%esp
  802206:	85 f6                	test   %esi,%esi
  802208:	74 13                	je     80221d <ipc_recv+0x79>
			*from_env_store = (r == 0) ? (thisenv->env_ipc_from) : 0;
  80220a:	b8 00 00 00 00       	mov    $0x0,%eax
  80220f:	85 d2                	test   %edx,%edx
  802211:	75 08                	jne    80221b <ipc_recv+0x77>
  802213:	a1 90 67 80 00       	mov    0x806790,%eax
  802218:	8b 40 74             	mov    0x74(%eax),%eax
  80221b:	89 06                	mov    %eax,(%esi)
		}
		if (perm_store) {
  80221d:	85 db                	test   %ebx,%ebx
  80221f:	74 06                	je     802227 <ipc_recv+0x83>
			*perm_store = 0;
  802221:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
		}
	}
  ...
  80222b:	75 08                	jne    802235 <ipc_recv+0x91>
		// system call fails, return the error
		return r;
	
	// system call success
	return thisenv->env_ipc_value;
  80222d:	a1 90 67 80 00       	mov    0x806790,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80224e:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;
  802250:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  802255:	0f 44 d8             	cmove  %eax,%ebx

	int r = 0;
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) < 0) {
  802258:	eb 1c                	jmp    802276 <ipc_send+0x3a>
		if (r != -E_IPC_NOT_RECV) {
  80225a:	83 f8 f9             	cmp    $0xfffffff9,%eax
  80225d:	74 12                	je     802271 <ipc_send+0x35>
			panic("Sys ipc try send error: %e", r);
  80225f:	50                   	push   %eax
  802260:	68 dd 2b 80 00       	push   $0x802bdd
  802265:	6a 4f                	push   $0x4f
  802267:	68 f8 2b 80 00       	push   $0x802bf8
  80226c:	e8 8e e1 ff ff       	call   8003ff <_panic>
		}

		// to be CPU-friendly
		sys_yield();
  802271:	e8 cb eb ff ff       	call   800e41 <sys_yield>
	// edited by Lethe 2018/12/8
	if (!pg)
		pg = (void *)-1;
  ...
  80227a:	56                   	push   %esi
  80227b:	57                   	push   %edi
  80227c:	e8 6c ed ff ff       	call   800fed <sys_ipc_try_send>
  802281:	83 c4 10             	add    $0x10,%esp
  802284:	85 c0                	test   %eax,%eax
  802286:	78 d2                	js     80225a <ipc_send+0x1e>
...
ipc_find_env(enum EnvType type)
{
  ...
  8022bb:	3d 00 04 00 00       	cmp    $0x400,%eax
  8022c0:	75 d9                	jne    80229b <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;

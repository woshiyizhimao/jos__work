...
boot_alloc(uint32_t n)
{
	...
	result=nextfree;
	if(n==0){
		//if n==0, just return the nextfree(address of the next free page)
	...
	return result;
	//some details:(also edited by Lethe)
	//1.nextfree is a static variable, so it will be initialized to 0 automatically
...
mem_init(void)
{
	...
	//////////////////////////////////////////////////////////////////////
	// Use the physical memory that 'bootstack' refers sto as the kernel
	...
	// Your code goes here:
	// edited by Lethe 
	// bootstack is virtual address, need to be converted
...
pgdir_walk(pde_t *pgdir, const void *va, int create)
{
	// Fill this function in
	//edited by Lethe
	//This function is really really tough!!!
	//analyze: this function make it possible to
	//convert virtual address into physical address
	//however, it doesn't make this converting directly,
	//it returns a pointer points to the virtual address
	//of the corresponding page table entry.
...
page_remove(pde_t *pgdir, void *va)
{
	...
	if(!pp){
		//can not find corresponding physical page
		//because of the page_lookup function has filtered
		//the condition that *entry & PTE_P==0, so we dont

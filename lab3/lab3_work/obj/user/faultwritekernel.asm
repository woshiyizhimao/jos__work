...
sys_env_destroy(envid_t envid)
{
  ...
  800102:	68 8a 0d 80 00       	push   $0x800d8a
  800107:	6a 23                	push   $0x23
  800109:	68 a7 0d 80 00       	push   $0x800da7
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800156:	56                   	push   %esi
  800157:	50                   	push   %eax
  800158:	68 b8 0d 80 00       	push   $0x800db8
  ...
  800169:	e8 54 00 00 00       	call   8001c2 <vcprintf>
	cprintf("\n");
  80016e:	c7 04 24 dc 0d 80 00 	movl   $0x800ddc,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002c1:	0f be 80 de 0d 80 00 	movsbl 0x800dde(%eax),%eax
  8002c8:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003bd:	ff 24 85 80 0e 80 00 	jmp    *0x800e80(,%eax,4)
  ...
  800481:	8b 14 85 e0 0f 80 00 	mov    0x800fe0(,%eax,4),%edx
  800488:	85 d2                	test   %edx,%edx
  80048a:	75 18                	jne    8004a4 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  80048c:	50                   	push   %eax
  80048d:	68 f6 0d 80 00       	push   $0x800df6
  800492:	53                   	push   %ebx
  800493:	56                   	push   %esi
  ...
  8004a4:	52                   	push   %edx
  8004a5:	68 ff 0d 80 00       	push   $0x800dff
  8004aa:	53                   	push   %ebx
  8004ab:	56                   	push   %esi
  ...
  8004c9:	b8 ef 0d 80 00       	mov    $0x800def,%eax

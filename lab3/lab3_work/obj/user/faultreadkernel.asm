	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ea:	0f be 80 b1 0d 80 00 	movsbl 0x800db1(%eax),%eax
  8001f1:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003b5:	50                   	push   %eax
  8003b6:	68 c9 0d 80 00       	push   $0x800dc9
  8003bb:	53                   	push   %ebx
  8003bc:	56                   	push   %esi
  ...
  8003cd:	52                   	push   %edx
  8003ce:	68 d2 0d 80 00       	push   $0x800dd2
  8003d3:	53                   	push   %ebx
  8003d4:	56                   	push   %esi
  ...
  8003f2:	b8 c2 0d 80 00       	mov    $0x800dc2,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ad4:	e8 12 f6 ff ff       	call   8000eb <vcprintf>
	cprintf("\n");
  800ad9:	c7 04 24 10 10 80 00 	movl   $0x801010,(%esp)

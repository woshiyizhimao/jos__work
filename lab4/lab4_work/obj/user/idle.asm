...
sys_env_destroy(envid_t envid)
{
  ...
  800107:	68 6f 0f 80 00       	push   $0x800f6f
  80010c:	6a 23                	push   $0x23
  80010e:	68 8c 0f 80 00       	push   $0x800f8c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800188:	68 6f 0f 80 00       	push   $0x800f6f
  80018d:	6a 23                	push   $0x23
  80018f:	68 8c 0f 80 00       	push   $0x800f8c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ca:	68 6f 0f 80 00       	push   $0x800f6f
  8001cf:	6a 23                	push   $0x23
  8001d1:	68 8c 0f 80 00       	push   $0x800f8c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80020c:	68 6f 0f 80 00       	push   $0x800f6f
  800211:	6a 23                	push   $0x23
  800213:	68 8c 0f 80 00       	push   $0x800f8c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80024e:	68 6f 0f 80 00       	push   $0x800f6f
  800253:	6a 23                	push   $0x23
  800255:	68 8c 0f 80 00       	push   $0x800f8c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800290:	68 6f 0f 80 00       	push   $0x800f6f
  800295:	6a 23                	push   $0x23
  800297:	68 8c 0f 80 00       	push   $0x800f8c
...
sys_ipc_recv(void *dstva)
{
  ...
  8002f4:	68 6f 0f 80 00       	push   $0x800f6f
  8002f9:	6a 23                	push   $0x23
  8002fb:	68 8c 0f 80 00       	push   $0x800f8c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80033c:	e8 54 00 00 00       	call   800395 <vcprintf>
	cprintf("\n");
  800341:	c7 04 24 c0 0f 80 00 	movl   $0x800fc0,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800494:	0f be 80 c2 0f 80 00 	movsbl 0x800fc2(%eax),%eax
  80049b:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80065f:	50                   	push   %eax
  800660:	68 da 0f 80 00       	push   $0x800fda
  800665:	53                   	push   %ebx
  800666:	56                   	push   %esi
  ...
  800677:	52                   	push   %edx
  800678:	68 e3 0f 80 00       	push   $0x800fe3
  80067d:	53                   	push   %ebx
  80067e:	56                   	push   %esi
  ...
  80069c:	b8 d3 0f 80 00       	mov    $0x800fd3,%eax

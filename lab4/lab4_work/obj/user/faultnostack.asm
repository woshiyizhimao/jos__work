	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800477:	e8 d4 08 00 00       	call   800d50 <__udivdi3>
  ...
  8004ba:	e8 c1 09 00 00       	call   800e80 <__umoddi3>
  8004bf:	83 c4 14             	add    $0x14,%esp
  8004c2:	0f be 80 3d 10 80 00 	movsbl 0x80103d(%eax),%eax
  8004c9:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8005be:	ff 24 85 00 11 80 00 	jmp    *0x801100(,%eax,4)
  ...
  80067d:	83 f8 09             	cmp    $0x9,%eax
  800680:	7f 0b                	jg     80068d <vprintfmt+0x142>
  800682:	8b 14 85 60 12 80 00 	mov    0x801260(,%eax,4),%edx
  800689:	85 d2                	test   %edx,%edx
  80068b:	75 18                	jne    8006a5 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  80068d:	50                   	push   %eax
  80068e:	68 55 10 80 00       	push   $0x801055
  800693:	53                   	push   %ebx
  800694:	56                   	push   %esi
  ...
  8006a5:	52                   	push   %edx
  8006a6:	68 5e 10 80 00       	push   $0x80105e
  8006ab:	53                   	push   %ebx
  8006ac:	56                   	push   %esi
  ...
  8006ca:	b8 4e 10 80 00       	mov    $0x80104e,%eax
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800ced:	75 56                	jne    800d45 <set_pgfault_handler+0x65>
		// First time through!
		// LAB 4: Your code here.
		//panic("set_pgfault_handler not implemented");
		if (sys_page_alloc(0, (void *)(UXSTACKTOP - PGSIZE), PTE_W|PTE_U|PTE_P)) {
  800cef:	83 ec 04             	sub    $0x4,%esp
  800cf2:	6a 07                	push   $0x7
  800cf4:	68 00 f0 bf ee       	push   $0xeebff000
  800cf9:	6a 00                	push   $0x0
  800cfb:	e8 68 f4 ff ff       	call   800168 <sys_page_alloc>
  800d00:	83 c4 10             	add    $0x10,%esp
  800d03:	85 c0                	test   %eax,%eax
  800d05:	74 14                	je     800d1b <set_pgfault_handler+0x3b>
			panic("set_pgfault_handler page_alloc failed");
  800d07:	83 ec 04             	sub    $0x4,%esp
  800d0a:	68 88 12 80 00       	push   $0x801288
  800d0f:	6a 22                	push   $0x22
  800d11:	68 e0 12 80 00       	push   $0x8012e0
  800d16:	e8 20 f6 ff ff       	call   80033b <_panic>
		}
  ...
  800d2f:	74 14                	je     800d45 <set_pgfault_handler+0x65>
			panic("set_pgfault_handler set_pgfault_upcall failed");
  800d31:	83 ec 04             	sub    $0x4,%esp
  800d34:	68 b0 12 80 00       	push   $0x8012b0
  800d39:	6a 25                	push   $0x25
  800d3b:	68 e0 12 80 00       	push   $0x8012e0
  800d40:	e8 f6 f5 ff ff       	call   80033b <_panic>
		}
	}
  ...
  800d48:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800d4d:	c9                   	leave  
  800d4e:	c3                   	ret    
  800d4f:	90                   	nop

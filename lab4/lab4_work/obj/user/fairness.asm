...
umain(int argc, char **argv)
{
  ...
  800096:	50                   	push   %eax
  800097:	e8 7c 0c 00 00       	call   800d18 <ipc_send>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80023a:	0f be 80 b2 10 80 00 	movsbl 0x8010b2(%eax),%eax
  800241:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800336:	ff 24 85 80 11 80 00 	jmp    *0x801180(,%eax,4)
  ...
  8003fa:	8b 14 85 e0 12 80 00 	mov    0x8012e0(,%eax,4),%edx
  800401:	85 d2                	test   %edx,%edx
  800403:	75 18                	jne    80041d <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  800405:	50                   	push   %eax
  800406:	68 ca 10 80 00       	push   $0x8010ca
  80040b:	53                   	push   %ebx
  80040c:	56                   	push   %esi
  ...
  80041d:	52                   	push   %edx
  80041e:	68 d3 10 80 00       	push   $0x8010d3
  800423:	53                   	push   %ebx
  800424:	56                   	push   %esi
  ...
  800442:	b8 c3 10 80 00       	mov    $0x8010c3,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800abd:	68 08 13 80 00       	push   $0x801308
  800ac2:	6a 23                	push   $0x23
  800ac4:	68 25 13 80 00       	push   $0x801325
  800ac9:	e8 d7 02 00 00       	call   800da5 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b3e:	68 08 13 80 00       	push   $0x801308
  800b43:	6a 23                	push   $0x23
  800b45:	68 25 13 80 00       	push   $0x801325
  800b4a:	e8 56 02 00 00       	call   800da5 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b80:	68 08 13 80 00       	push   $0x801308
  800b85:	6a 23                	push   $0x23
  800b87:	68 25 13 80 00       	push   $0x801325
  800b8c:	e8 14 02 00 00       	call   800da5 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bc2:	68 08 13 80 00       	push   $0x801308
  800bc7:	6a 23                	push   $0x23
  800bc9:	68 25 13 80 00       	push   $0x801325
  800bce:	e8 d2 01 00 00       	call   800da5 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c04:	68 08 13 80 00       	push   $0x801308
  800c09:	6a 23                	push   $0x23
  800c0b:	68 25 13 80 00       	push   $0x801325
  800c10:	e8 90 01 00 00       	call   800da5 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c46:	68 08 13 80 00       	push   $0x801308
  800c4b:	6a 23                	push   $0x23
  800c4d:	68 25 13 80 00       	push   $0x801325
  800c52:	e8 4e 01 00 00       	call   800da5 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800caa:	68 08 13 80 00       	push   $0x801308
  800caf:	6a 23                	push   $0x23
  800cb1:	68 25 13 80 00       	push   $0x801325
  800cb6:	e8 ea 00 00 00       	call   800da5 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800cd3:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  800cd8:	0f 44 c2             	cmove  %edx,%eax

	int r = sys_ipc_recv(pg);
  800cdb:	83 ec 0c             	sub    $0xc,%esp
  800cde:	50                   	push   %eax
  800cdf:	e8 9e ff ff ff       	call   800c82 <sys_ipc_recv>
	int from_env = 0, perm = 0;
	if (r == 0) {
  800ce4:	83 c4 10             	add    $0x10,%esp
  800ce7:	85 c0                	test   %eax,%eax
  800ce9:	75 10                	jne    800cfb <ipc_recv+0x38>
		from_env = thisenv->env_ipc_from;
  800ceb:	a1 04 20 80 00       	mov    0x802004,%eax
  800cf0:	8b 48 74             	mov    0x74(%eax),%ecx
		perm = thisenv->env_ipc_perm;
  800cf3:	8b 50 78             	mov    0x78(%eax),%edx
		r = thisenv->env_ipc_value;
  800cf6:	8b 40 70             	mov    0x70(%eax),%eax
  800cf9:	eb 0a                	jmp    800d05 <ipc_recv+0x42>
	} else {
		from_env = 0;
		perm = 0;
  ...
  800d07:	74 02                	je     800d0b <ipc_recv+0x48>
  800d09:	89 0e                	mov    %ecx,(%esi)
	if (perm_store) *perm_store = perm;
  800d0b:	85 db                	test   %ebx,%ebx
  800d0d:	74 02                	je     800d11 <ipc_recv+0x4e>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800d2c:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  800d31:	0f 44 d8             	cmove  %eax,%ebx
  800d34:	eb 1c                	jmp    800d52 <ipc_send+0x3a>

	int ret;
	while ((ret = sys_ipc_try_send(to_env, val, pg, perm))) {
		if (ret != -E_IPC_NOT_RECV) panic("ipc_send error %e", ret);
  800d36:	83 f8 f8             	cmp    $0xfffffff8,%eax
  800d39:	74 12                	je     800d4d <ipc_send+0x35>
  800d3b:	50                   	push   %eax
  800d3c:	68 33 13 80 00       	push   $0x801333
  800d41:	6a 3f                	push   $0x3f
  800d43:	68 45 13 80 00       	push   $0x801345
  800d48:	e8 58 00 00 00       	call   800da5 <_panic>
		sys_yield();
  800d4d:	e8 a3 fd ff ff       	call   800af5 <sys_yield>
	// LAB 4: Your code here.
	//panic("ipc_send not implemented");
	if (pg == NULL) pg = (void *)UTOP;
  ...
  800d56:	56                   	push   %esi
  800d57:	57                   	push   %edi
  800d58:	e8 02 ff ff ff       	call   800c5f <sys_ipc_try_send>
  800d5d:	83 c4 10             	add    $0x10,%esp
  800d60:	85 c0                	test   %eax,%eax
  800d62:	75 d2                	jne    800d36 <ipc_send+0x1e>
		if (ret != -E_IPC_NOT_RECV) panic("ipc_send error %e", ret);
		sys_yield();
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  800d77:	6b d0 7c             	imul   $0x7c,%eax,%edx
  800d7a:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  800d80:	8b 52 50             	mov    0x50(%edx),%edx
  800d83:	39 ca                	cmp    %ecx,%edx
  800d85:	75 0d                	jne    800d94 <ipc_find_env+0x28>
			return envs[i].env_id;
  800d87:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800d8a:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800d8f:	8b 40 48             	mov    0x48(%eax),%eax
  800d92:	eb 0f                	jmp    800da3 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  800d97:	3d 00 04 00 00       	cmp    $0x400,%eax
  800d9c:	75 d9                	jne    800d77 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800da9:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800daa:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800dad:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800db3:	e8 1e fd ff ff       	call   800ad6 <sys_getenvid>
  800db8:	83 ec 0c             	sub    $0xc,%esp
  800dbb:	ff 75 0c             	pushl  0xc(%ebp)
  800dbe:	ff 75 08             	pushl  0x8(%ebp)
  800dc1:	56                   	push   %esi
  800dc2:	50                   	push   %eax
  800dc3:	68 50 13 80 00       	push   $0x801350
  800dc8:	e8 bf f3 ff ff       	call   80018c <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800dcd:	83 c4 18             	add    $0x18,%esp
  800dd0:	53                   	push   %ebx
  800dd1:	ff 75 10             	pushl  0x10(%ebp)
  800dd4:	e8 62 f3 ff ff       	call   80013b <vcprintf>
	cprintf("\n");
  800dd9:	c7 04 24 8f 10 80 00 	movl   $0x80108f,(%esp)
  800de0:	e8 a7 f3 ff ff       	call   80018c <cprintf>
  800de5:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800de8:	cc                   	int3   
  800de9:	eb fd                	jmp    800de8 <_panic+0x43>

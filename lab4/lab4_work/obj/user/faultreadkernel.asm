...
sys_env_destroy(envid_t envid)
{
  ...
  800a6a:	68 e8 11 80 00       	push   $0x8011e8
  800a6f:	6a 23                	push   $0x23
  800a71:	68 05 12 80 00       	push   $0x801205
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800aeb:	68 e8 11 80 00       	push   $0x8011e8
  800af0:	6a 23                	push   $0x23
  800af2:	68 05 12 80 00       	push   $0x801205
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b2d:	68 e8 11 80 00       	push   $0x8011e8
  800b32:	6a 23                	push   $0x23
  800b34:	68 05 12 80 00       	push   $0x801205
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b6f:	68 e8 11 80 00       	push   $0x8011e8
  800b74:	6a 23                	push   $0x23
  800b76:	68 05 12 80 00       	push   $0x801205
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bb1:	68 e8 11 80 00       	push   $0x8011e8
  800bb6:	6a 23                	push   $0x23
  800bb8:	68 05 12 80 00       	push   $0x801205
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800bf3:	68 e8 11 80 00       	push   $0x8011e8
  800bf8:	6a 23                	push   $0x23
  800bfa:	68 05 12 80 00       	push   $0x801205
...
sys_ipc_recv(void *dstva)
{
  ...
  800c57:	68 e8 11 80 00       	push   $0x8011e8
  800c5c:	6a 23                	push   $0x23
  800c5e:	68 05 12 80 00       	push   $0x801205
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c8c:	56                   	push   %esi
  800c8d:	50                   	push   %eax
  800c8e:	68 14 12 80 00       	push   $0x801214
  ...
  800c9f:	e8 44 f4 ff ff       	call   8000e8 <vcprintf>
	cprintf("\n");
  800ca4:	c7 04 24 38 12 80 00 	movl   $0x801238,(%esp)

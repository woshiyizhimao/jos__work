	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002a9:	0f be 80 fb 10 80 00 	movsbl 0x8010fb(%eax),%eax
  8002b0:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800474:	50                   	push   %eax
  800475:	68 13 11 80 00       	push   $0x801113
  80047a:	53                   	push   %ebx
  80047b:	56                   	push   %esi
  ...
  80048c:	52                   	push   %edx
  80048d:	68 1c 11 80 00       	push   $0x80111c
  800492:	53                   	push   %ebx
  800493:	56                   	push   %esi
  ...
  8004b1:	b8 0c 11 80 00       	mov    $0x80110c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b2c:	68 48 13 80 00       	push   $0x801348
  800b31:	6a 23                	push   $0x23
  800b33:	68 65 13 80 00       	push   $0x801365
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bad:	68 48 13 80 00       	push   $0x801348
  800bb2:	6a 23                	push   $0x23
  800bb4:	68 65 13 80 00       	push   $0x801365
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bef:	68 48 13 80 00       	push   $0x801348
  800bf4:	6a 23                	push   $0x23
  800bf6:	68 65 13 80 00       	push   $0x801365
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c31:	68 48 13 80 00       	push   $0x801348
  800c36:	6a 23                	push   $0x23
  800c38:	68 65 13 80 00       	push   $0x801365
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c73:	68 48 13 80 00       	push   $0x801348
  800c78:	6a 23                	push   $0x23
  800c7a:	68 65 13 80 00       	push   $0x801365
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cb5:	68 48 13 80 00       	push   $0x801348
  800cba:	6a 23                	push   $0x23
  800cbc:	68 65 13 80 00       	push   $0x801365
...
sys_ipc_recv(void *dstva)
{
  ...
  800d19:	68 48 13 80 00       	push   $0x801348
  800d1e:	6a 23                	push   $0x23
  800d20:	68 65 13 80 00       	push   $0x801365
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d3f:	75 56                	jne    800d97 <set_pgfault_handler+0x65>
		// First time through!
  ...
  800d46:	68 00 f0 bf ee       	push   $0xeebff000
  800d4b:	6a 00                	push   $0x0
  800d4d:	e8 31 fe ff ff       	call   800b83 <sys_page_alloc>
  800d52:	83 c4 10             	add    $0x10,%esp
  800d55:	85 c0                	test   %eax,%eax
  800d57:	74 14                	je     800d6d <set_pgfault_handler+0x3b>
			panic("set_pgfault_handler page_alloc failed");
  800d59:	83 ec 04             	sub    $0x4,%esp
  800d5c:	68 74 13 80 00       	push   $0x801374
  800d61:	6a 22                	push   $0x22
  800d63:	68 cc 13 80 00       	push   $0x8013cc
  800d68:	e8 b5 f3 ff ff       	call   800122 <_panic>
		}
		if (sys_env_set_pgfault_upcall(0, _pgfault_upcall)) {
  800d6d:	83 ec 08             	sub    $0x8,%esp
  800d70:	68 a1 0d 80 00       	push   $0x800da1
  800d75:	6a 00                	push   $0x0
  800d77:	e8 10 ff ff ff       	call   800c8c <sys_env_set_pgfault_upcall>
  800d7c:	83 c4 10             	add    $0x10,%esp
  800d7f:	85 c0                	test   %eax,%eax
  800d81:	74 14                	je     800d97 <set_pgfault_handler+0x65>
			panic("set_pgfault_handler set_pgfault_upcall failed");
  800d83:	83 ec 04             	sub    $0x4,%esp
  800d86:	68 9c 13 80 00       	push   $0x80139c
  800d8b:	6a 25                	push   $0x25
  800d8d:	68 cc 13 80 00       	push   $0x8013cc
  800d92:	e8 8b f3 ff ff       	call   800122 <_panic>
		}
	}
...
_pgfault_upcall:
  ...
  800da2:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  800da7:	ff d0                	call   *%eax
	addl $4, %esp			// pop function argument
  800da9:	83 c4 04             	add    $0x4,%esp
  ...
  800dac:	8b 5c 24 28          	mov    0x28(%esp),%ebx
	subl $0x4, 0x30(%esp)  # trap-time esp minus 4
  800db0:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %eax 
  800db5:	8b 44 24 30          	mov    0x30(%esp),%eax

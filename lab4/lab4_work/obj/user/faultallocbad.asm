	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800249:	e8 62 0b 00 00       	call   800db0 <__udivdi3>
  ...
  80028c:	e8 4f 0c 00 00       	call   800ee0 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800b17:	68 28 13 80 00       	push   $0x801328
  800b1c:	6a 23                	push   $0x23
  800b1e:	68 45 13 80 00       	push   $0x801345
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b98:	68 28 13 80 00       	push   $0x801328
  800b9d:	6a 23                	push   $0x23
  800b9f:	68 45 13 80 00       	push   $0x801345
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bda:	68 28 13 80 00       	push   $0x801328
  800bdf:	6a 23                	push   $0x23
  800be1:	68 45 13 80 00       	push   $0x801345
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c1c:	68 28 13 80 00       	push   $0x801328
  800c21:	6a 23                	push   $0x23
  800c23:	68 45 13 80 00       	push   $0x801345
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c5e:	68 28 13 80 00       	push   $0x801328
  800c63:	6a 23                	push   $0x23
  800c65:	68 45 13 80 00       	push   $0x801345
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ca0:	68 28 13 80 00       	push   $0x801328
  800ca5:	6a 23                	push   $0x23
  800ca7:	68 45 13 80 00       	push   $0x801345
...
sys_ipc_recv(void *dstva)
{
  ...
  800d04:	68 28 13 80 00       	push   $0x801328
  800d09:	6a 23                	push   $0x23
  800d0b:	68 45 13 80 00       	push   $0x801345
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d23:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  800d2a:	75 56                	jne    800d82 <set_pgfault_handler+0x65>
		// First time through!
		// LAB 4: Your code here.
		//panic("set_pgfault_handler not implemented");
		if (sys_page_alloc(0, (void *)(UXSTACKTOP - PGSIZE), PTE_W|PTE_U|PTE_P)) {
  800d2c:	83 ec 04             	sub    $0x4,%esp
  800d2f:	6a 07                	push   $0x7
  800d31:	68 00 f0 bf ee       	push   $0xeebff000
  800d36:	6a 00                	push   $0x0
  800d38:	e8 31 fe ff ff       	call   800b6e <sys_page_alloc>
  800d3d:	83 c4 10             	add    $0x10,%esp
  800d40:	85 c0                	test   %eax,%eax
  800d42:	74 14                	je     800d58 <set_pgfault_handler+0x3b>
			panic("set_pgfault_handler page_alloc failed");
  800d44:	83 ec 04             	sub    $0x4,%esp
  800d47:	68 54 13 80 00       	push   $0x801354
  800d4c:	6a 22                	push   $0x22
  800d4e:	68 ac 13 80 00       	push   $0x8013ac
  800d53:	e8 b5 f3 ff ff       	call   80010d <_panic>
		}
		if (sys_env_set_pgfault_upcall(0, _pgfault_upcall)) {
  800d58:	83 ec 08             	sub    $0x8,%esp
  800d5b:	68 8c 0d 80 00       	push   $0x800d8c
  800d60:	6a 00                	push   $0x0
  800d62:	e8 10 ff ff ff       	call   800c77 <sys_env_set_pgfault_upcall>
  800d67:	83 c4 10             	add    $0x10,%esp
  800d6a:	85 c0                	test   %eax,%eax
  800d6c:	74 14                	je     800d82 <set_pgfault_handler+0x65>
			panic("set_pgfault_handler set_pgfault_upcall failed");
  800d6e:	83 ec 04             	sub    $0x4,%esp
  800d71:	68 7c 13 80 00       	push   $0x80137c
  800d76:	6a 25                	push   $0x25
  800d78:	68 ac 13 80 00       	push   $0x8013ac
  800d7d:	e8 8b f3 ff ff       	call   80010d <_panic>
		}
	}
...
_pgfault_upcall:
  ...
  800d8d:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800d97:	8b 5c 24 28          	mov    0x28(%esp),%ebx
	subl $0x4, 0x30(%esp)  # trap-time esp minus 4
  800d9b:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %eax 
  800da0:	8b 44 24 30          	mov    0x30(%esp),%eax
	movl %ebx, (%eax)      # trap-time esp store trap-time eip
  800da4:	89 18                	mov    %ebx,(%eax)
	addl $0x8, %esp	
  800da6:	83 c4 08             	add    $0x8,%esp

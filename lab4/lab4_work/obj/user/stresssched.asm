...
umain(int argc, char **argv)
{
  ...
  80003f:	bb 00 00 00 00       	mov    $0x0,%ebx
		if (fork() == 0)
  800044:	e8 a4 0e 00 00       	call   800eed <fork>
...
sys_env_destroy(envid_t envid)
{
  ...
  800b4f:	68 28 16 80 00       	push   $0x801628
  800b54:	6a 23                	push   $0x23
  800b56:	68 45 16 80 00       	push   $0x801645
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bd0:	68 28 16 80 00       	push   $0x801628
  800bd5:	6a 23                	push   $0x23
  800bd7:	68 45 16 80 00       	push   $0x801645
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c12:	68 28 16 80 00       	push   $0x801628
  800c17:	6a 23                	push   $0x23
  800c19:	68 45 16 80 00       	push   $0x801645
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c54:	68 28 16 80 00       	push   $0x801628
  800c59:	6a 23                	push   $0x23
  800c5b:	68 45 16 80 00       	push   $0x801645
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c96:	68 28 16 80 00       	push   $0x801628
  800c9b:	6a 23                	push   $0x23
  800c9d:	68 45 16 80 00       	push   $0x801645
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cd8:	68 28 16 80 00       	push   $0x801628
  800cdd:	6a 23                	push   $0x23
  800cdf:	68 45 16 80 00       	push   $0x801645
...
sys_ipc_recv(void *dstva)
{
  ...
  800d3c:	68 28 16 80 00       	push   $0x801628
  800d41:	6a 23                	push   $0x23
  800d43:	68 45 16 80 00       	push   $0x801645
...
duppage(envid_t envid, unsigned pn)
{
  ...
  800d5e:	c1 e3 0c             	shl    $0xc,%ebx
	if (uvpt[pn] & (PTE_W|PTE_COW)) {
  800d61:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
  800d68:	f7 c2 02 08 00 00    	test   $0x802,%edx
  800d6e:	74 57                	je     800dc7 <duppage+0x72>
		if ((r = sys_page_map(0, addr, envid, addr, PTE_COW|PTE_U|PTE_P)) < 0)
  800d70:	83 ec 0c             	sub    $0xc,%esp
  800d73:	68 05 08 00 00       	push   $0x805
  800d78:	53                   	push   %ebx
  800d79:	50                   	push   %eax
  800d7a:	53                   	push   %ebx
  800d7b:	6a 00                	push   $0x0
  800d7d:	e8 67 fe ff ff       	call   800be9 <sys_page_map>
  800d82:	83 c4 20             	add    $0x20,%esp
  800d85:	85 c0                	test   %eax,%eax
  800d87:	79 12                	jns    800d9b <duppage+0x46>
			panic("sys_page_map COW:%e", r);
  800d89:	50                   	push   %eax
  800d8a:	68 53 16 80 00       	push   $0x801653
  800d8f:	6a 4b                	push   $0x4b
  800d91:	68 67 16 80 00       	push   $0x801667
  800d96:	e8 aa f3 ff ff       	call   800145 <_panic>

		if ((r = sys_page_map(0, addr, 0, addr, PTE_COW|PTE_U|PTE_P)) < 0)
  800d9b:	83 ec 0c             	sub    $0xc,%esp
  800d9e:	68 05 08 00 00       	push   $0x805
  800da3:	53                   	push   %ebx
  800da4:	6a 00                	push   $0x0
  800da6:	53                   	push   %ebx
  800da7:	6a 00                	push   $0x0
  800da9:	e8 3b fe ff ff       	call   800be9 <sys_page_map>
  800dae:	83 c4 20             	add    $0x20,%esp
  800db1:	85 c0                	test   %eax,%eax
  800db3:	79 3a                	jns    800def <duppage+0x9a>
			panic("sys_page_map COW:%e", r);
  800db5:	50                   	push   %eax
  800db6:	68 53 16 80 00       	push   $0x801653
  800dbb:	6a 4e                	push   $0x4e
  800dbd:	68 67 16 80 00       	push   $0x801667
  800dc2:	e8 7e f3 ff ff       	call   800145 <_panic>
	} else {
  ...
  800dd1:	e8 13 fe ff ff       	call   800be9 <sys_page_map>
  800dd6:	83 c4 20             	add    $0x20,%esp
  800dd9:	85 c0                	test   %eax,%eax
  800ddb:	79 12                	jns    800def <duppage+0x9a>
			panic("sys_page_map UP:%e", r);
  800ddd:	50                   	push   %eax
  800dde:	68 72 16 80 00       	push   $0x801672
  800de3:	6a 51                	push   $0x51
  800de5:	68 67 16 80 00       	push   $0x801667
  800dea:	e8 56 f3 ff ff       	call   800145 <_panic>
	}
	return 0;
}
...
pgfault(struct UTrapframe *utf)
{
  ...
  800e05:	f6 42 04 02          	testb  $0x2,0x4(%edx)
  800e09:	74 2e                	je     800e39 <pgfault+0x40>
  800e0b:	89 c2                	mov    %eax,%edx
  800e0d:	c1 ea 16             	shr    $0x16,%edx
  800e10:	8b 14 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%edx
  800e17:	f6 c2 01             	test   $0x1,%dl
  800e1a:	74 1d                	je     800e39 <pgfault+0x40>
			&& (uvpt[PGNUM(addr)] & PTE_COW) && (uvpt[PGNUM(addr)] & PTE_P)))
  800e1c:	89 c2                	mov    %eax,%edx
  800e1e:	c1 ea 0c             	shr    $0xc,%edx
  800e21:	8b 0c 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%ecx
  800e28:	f6 c5 08             	test   $0x8,%ch
  800e2b:	74 0c                	je     800e39 <pgfault+0x40>
  ...
  800e37:	75 14                	jne    800e4d <pgfault+0x54>
			&& (uvpt[PGNUM(addr)] & PTE_COW) && (uvpt[PGNUM(addr)] & PTE_P)))
		panic("page cow check failed");
  800e39:	83 ec 04             	sub    $0x4,%esp
  800e3c:	68 85 16 80 00       	push   $0x801685
  800e41:	6a 1e                	push   $0x1e
  800e43:	68 67 16 80 00       	push   $0x801667
  800e48:	e8 f8 f2 ff ff       	call   800145 <_panic>
  ...
  800e60:	e8 41 fd ff ff       	call   800ba6 <sys_page_alloc>
  800e65:	83 c4 10             	add    $0x10,%esp
  800e68:	85 c0                	test   %eax,%eax
  800e6a:	74 12                	je     800e7e <pgfault+0x85>
		panic("sys_page_alloc: %e", r);
  800e6c:	50                   	push   %eax
  800e6d:	68 9b 16 80 00       	push   $0x80169b
  800e72:	6a 29                	push   $0x29
  800e74:	68 67 16 80 00       	push   $0x801667
  800e79:	e8 c7 f2 ff ff       	call   800145 <_panic>
  ...
  800e8c:	e8 a4 fa ff ff       	call   800935 <memmove>
  ...
  800ea2:	e8 42 fd ff ff       	call   800be9 <sys_page_map>
  800ea7:	83 c4 20             	add    $0x20,%esp
  800eaa:	85 c0                	test   %eax,%eax
  800eac:	74 12                	je     800ec0 <pgfault+0xc7>
		panic("sys_page_map: %e", r);
  800eae:	50                   	push   %eax
  800eaf:	68 ae 16 80 00       	push   $0x8016ae
  800eb4:	6a 2e                	push   $0x2e
  800eb6:	68 67 16 80 00       	push   $0x801667
  800ebb:	e8 85 f2 ff ff       	call   800145 <_panic>

	if ((r = sys_page_unmap(0, PFTEMP)))
  800ec0:	83 ec 08             	sub    $0x8,%esp
  800ec3:	68 00 f0 7f 00       	push   $0x7ff000
  800ec8:	6a 00                	push   $0x0
  800eca:	e8 5c fd ff ff       	call   800c2b <sys_page_unmap>
  800ecf:	83 c4 10             	add    $0x10,%esp
  800ed2:	85 c0                	test   %eax,%eax
  800ed4:	74 12                	je     800ee8 <pgfault+0xef>
		panic("sys_page_unmap: %e", r);
  800ed6:	50                   	push   %eax
  800ed7:	68 bf 16 80 00       	push   $0x8016bf
  800edc:	6a 31                	push   $0x31
  800ede:	68 67 16 80 00       	push   $0x801667
  800ee3:	e8 5d f2 ff ff       	call   800145 <_panic>
...
fork(void)
{
  ...
  800ef0:	56                   	push   %esi
  800ef1:	53                   	push   %ebx
  800ef2:	83 ec 1c             	sub    $0x1c,%esp
	// LAB 4: Your code here.
	//panic("fork not implemented");
	set_pgfault_handler(pgfault);
  800ef5:	68 f9 0d 80 00       	push   $0x800df9
  800efa:	e8 25 01 00 00       	call   801024 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800f0d:	79 12                	jns    800f21 <fork+0x34>
		panic("sys_exofork:%e", envid);
  800f0f:	50                   	push   %eax
  800f10:	68 d2 16 80 00       	push   $0x8016d2
  800f15:	6a 70                	push   $0x70
  800f17:	68 67 16 80 00       	push   $0x801667
  800f1c:	e8 24 f2 ff ff       	call   800145 <_panic>
  800f21:	89 c6                	mov    %eax,%esi
	if (envid == 0) {
  800f23:	85 c0                	test   %eax,%eax
  800f25:	75 21                	jne    800f48 <fork+0x5b>
		thisenv = &envs[ENVX(sys_getenvid())];
  800f27:	e8 3c fc ff ff       	call   800b68 <sys_getenvid>
  800f2c:	25 ff 03 00 00       	and    $0x3ff,%eax
  800f31:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800f34:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800f39:	a3 08 20 80 00       	mov    %eax,0x802008
		return 0;
  800f3e:	b8 00 00 00 00       	mov    $0x0,%eax
  800f43:	e9 bb 00 00 00       	jmp    801003 <fork+0x116>
	}

	extern unsigned char end[];
	for (addr = (uint8_t *)UTEXT; addr < end; addr += PGSIZE) {
  800f48:	c7 45 f4 00 00 80 00 	movl   $0x800000,-0xc(%ebp)
  800f4f:	eb 37                	jmp    800f88 <fork+0x9b>
		if ((uvpd[PDX(addr)] & PTE_P) && (uvpt[PGNUM(addr)] & PTE_P)
  800f51:	89 d0                	mov    %edx,%eax
  800f53:	c1 e8 16             	shr    $0x16,%eax
  800f56:	8b 04 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%eax
  800f5d:	a8 01                	test   $0x1,%al
  800f5f:	74 20                	je     800f81 <fork+0x94>
  800f61:	c1 ea 0c             	shr    $0xc,%edx
  800f64:	8b 04 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%eax
  800f6b:	a8 01                	test   $0x1,%al
  800f6d:	74 12                	je     800f81 <fork+0x94>
				&& (uvpt[PGNUM(addr)] & PTE_U)) {
  800f6f:	8b 04 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%eax
  800f76:	a8 04                	test   $0x4,%al
  800f78:	74 07                	je     800f81 <fork+0x94>
			duppage(envid, PGNUM(addr));
  800f7a:	89 f0                	mov    %esi,%eax
  800f7c:	e8 d4 fd ff ff       	call   800d55 <duppage>
		thisenv = &envs[ENVX(sys_getenvid())];
		return 0;
	}
	...
	extern unsigned char end[];
	for (addr = (uint8_t *)UTEXT; addr < end; addr += PGSIZE) {
  800f81:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
  800f88:	8b 55 f4             	mov    -0xc(%ebp),%edx
  800f8b:	81 fa 10 20 80 00    	cmp    $0x802010,%edx
  800f91:	72 be                	jb     800f51 <fork+0x64>
				&& (uvpt[PGNUM(addr)] & PTE_U)) {
			duppage(envid, PGNUM(addr));
		}
	}
  ...
  800f93:	8d 55 f4             	lea    -0xc(%ebp),%edx
  800f96:	c1 ea 0c             	shr    $0xc,%edx
  800f99:	89 d8                	mov    %ebx,%eax
  800f9b:	e8 b5 fd ff ff       	call   800d55 <duppage>

	int r;
	if ((r = sys_page_alloc(envid, (void *)(UXSTACKTOP - PGSIZE), PTE_P|PTE_U|PTE_W)))
  800fa0:	83 ec 04             	sub    $0x4,%esp
  800fa3:	6a 07                	push   $0x7
  800fa5:	68 00 f0 bf ee       	push   $0xeebff000
  800faa:	53                   	push   %ebx
  800fab:	e8 f6 fb ff ff       	call   800ba6 <sys_page_alloc>
  800fb0:	83 c4 10             	add    $0x10,%esp
  800fb3:	85 c0                	test   %eax,%eax
  800fb5:	74 15                	je     800fcc <fork+0xdf>
		panic("sys_page_alloc:%e", r);
  800fb7:	50                   	push   %eax
  800fb8:	68 e1 16 80 00       	push   $0x8016e1
  800fbd:	68 82 00 00 00       	push   $0x82
  800fc2:	68 67 16 80 00       	push   $0x801667
  800fc7:	e8 79 f1 ff ff       	call   800145 <_panic>

	extern void _pgfault_upcall();
	sys_env_set_pgfault_upcall(envid, _pgfault_upcall);
  800fcc:	83 ec 08             	sub    $0x8,%esp
  800fcf:	68 93 10 80 00       	push   $0x801093
  800fd4:	53                   	push   %ebx
  800fd5:	e8 d5 fc ff ff       	call   800caf <sys_env_set_pgfault_upcall>

	if ((r = sys_env_set_status(envid, ENV_RUNNABLE)))
  800fda:	83 c4 08             	add    $0x8,%esp
  800fdd:	6a 02                	push   $0x2
  800fdf:	53                   	push   %ebx
  800fe0:	e8 88 fc ff ff       	call   800c6d <sys_env_set_status>
  800fe5:	83 c4 10             	add    $0x10,%esp
  800fe8:	85 c0                	test   %eax,%eax
  800fea:	74 15                	je     801001 <fork+0x114>
		panic("sys_env_set_status:%e", r);
  800fec:	50                   	push   %eax
  800fed:	68 f3 16 80 00       	push   $0x8016f3
  800ff2:	68 88 00 00 00       	push   $0x88
  800ff7:	68 67 16 80 00       	push   $0x801667
  800ffc:	e8 44 f1 ff ff       	call   800145 <_panic>
...
sfork(void)
{
  ...
  801010:	68 09 17 80 00       	push   $0x801709
  801015:	68 91 00 00 00       	push   $0x91
  80101a:	68 67 16 80 00       	push   $0x801667
  80101f:	e8 21 f1 ff ff       	call   800145 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  80102a:	83 3d 0c 20 80 00 00 	cmpl   $0x0,0x80200c
  801031:	75 56                	jne    801089 <set_pgfault_handler+0x65>
		// First time through!
		// LAB 4: Your code here.
  ...
  80103f:	e8 62 fb ff ff       	call   800ba6 <sys_page_alloc>
  801044:	83 c4 10             	add    $0x10,%esp
  801047:	85 c0                	test   %eax,%eax
  801049:	74 14                	je     80105f <set_pgfault_handler+0x3b>
			panic("set_pgfault_handler page_alloc failed");
  80104b:	83 ec 04             	sub    $0x4,%esp
  80104e:	68 20 17 80 00       	push   $0x801720
  801053:	6a 22                	push   $0x22
  801055:	68 78 17 80 00       	push   $0x801778
  80105a:	e8 e6 f0 ff ff       	call   800145 <_panic>
		}
		if (sys_env_set_pgfault_upcall(0, _pgfault_upcall)) {
  80105f:	83 ec 08             	sub    $0x8,%esp
  801062:	68 93 10 80 00       	push   $0x801093
  801067:	6a 00                	push   $0x0
  801069:	e8 41 fc ff ff       	call   800caf <sys_env_set_pgfault_upcall>
  80106e:	83 c4 10             	add    $0x10,%esp
  801071:	85 c0                	test   %eax,%eax
  801073:	74 14                	je     801089 <set_pgfault_handler+0x65>
			panic("set_pgfault_handler set_pgfault_upcall failed");
  801075:	83 ec 04             	sub    $0x4,%esp
  801078:	68 48 17 80 00       	push   $0x801748
  80107d:	6a 25                	push   $0x25
  80107f:	68 78 17 80 00       	push   $0x801778
  801084:	e8 bc f0 ff ff       	call   800145 <_panic>
		}
	}
  ...
  80108c:	a3 0c 20 80 00       	mov    %eax,0x80200c
}
  801091:	c9                   	leave  
  801092:	c3                   	ret    

00801093 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  801094:	a1 0c 20 80 00       	mov    0x80200c,%eax
	call *%eax
  801099:	ff d0                	call   *%eax
	addl $4, %esp			// pop function argument
  80109b:	83 c4 04             	add    $0x4,%esp
  ...
  80109e:	8b 5c 24 28          	mov    0x28(%esp),%ebx
	subl $0x4, 0x30(%esp)  # trap-time esp minus 4
  8010a2:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %eax 
  8010a7:	8b 44 24 30          	mov    0x30(%esp),%eax
	movl %ebx, (%eax)      # trap-time esp store trap-time eip
  8010ab:	89 18                	mov    %ebx,(%eax)
	addl $0x8, %esp	

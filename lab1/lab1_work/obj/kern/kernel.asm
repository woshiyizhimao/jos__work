...
f0100055:	e8 50 09 00 00       	call   f01009aa <cprintf>
	if (x > 0)
...
f0100092:	e8 13 09 00 00       	call   f01009aa <cprintf>
}
...
f01000d9:	e8 cc 08 00 00       	call   f01009aa <cprintf>
...
f010012c:	e8 79 08 00 00       	call   f01009aa <cprintf>
	vcprintf(fmt, ap);
f0100131:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f0100135:	89 34 24             	mov    %esi,(%esp)
f0100138:	e8 3a 08 00 00       	call   f0100977 <vcprintf>
	cprintf("\n");
f010013d:	c7 04 24 ce 1a 10 f0 	movl   $0xf0101ace,(%esp)
f0100144:	e8 61 08 00 00       	call   f01009aa <cprintf>
	va_end(ap);
...
f0100176:	e8 2f 08 00 00       	call   f01009aa <cprintf>
	vcprintf(fmt, ap);
f010017b:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f010017f:	8b 45 10             	mov    0x10(%ebp),%eax
f0100182:	89 04 24             	mov    %eax,(%esp)
f0100185:	e8 ed 07 00 00       	call   f0100977 <vcprintf>
	cprintf("\n");
f010018a:	c7 04 24 ce 1a 10 f0 	movl   $0xf0101ace,(%esp)
f0100191:	e8 14 08 00 00       	call   f01009aa <cprintf>
	va_end(ap);
}
...
f01004cb:	e8 da 04 00 00       	call   f01009aa <cprintf>
}
...
f0100642:	e8 63 03 00 00       	call   f01009aa <cprintf>
}
...
f010068d:	e8 18 03 00 00       	call   f01009aa <cprintf>
	cprintf("  _start                  %08x (phys)\n", _start);
f0100692:	c7 44 24 04 0c 00 10 	movl   $0x10000c,0x4(%esp)
f0100699:	00 
f010069a:	c7 04 24 e8 1d 10 f0 	movl   $0xf0101de8,(%esp)
f01006a1:	e8 04 03 00 00       	call   f01009aa <cprintf>
	cprintf("  entry  %08x (virt)  %08x (phys)\n", entry, entry - KERNBASE);
f01006a6:	c7 44 24 08 0c 00 10 	movl   $0x10000c,0x8(%esp)
f01006ad:	00 
f01006ae:	c7 44 24 04 0c 00 10 	movl   $0xf010000c,0x4(%esp)
f01006b5:	f0 
f01006b6:	c7 04 24 10 1e 10 f0 	movl   $0xf0101e10,(%esp)
f01006bd:	e8 e8 02 00 00       	call   f01009aa <cprintf>
	cprintf("  etext  %08x (virt)  %08x (phys)\n", etext, etext - KERNBASE);
f01006c2:	c7 44 24 08 2f 1a 10 	movl   $0x101a2f,0x8(%esp)
f01006c9:	00 
f01006ca:	c7 44 24 04 2f 1a 10 	movl   $0xf0101a2f,0x4(%esp)
f01006d1:	f0 
f01006d2:	c7 04 24 34 1e 10 f0 	movl   $0xf0101e34,(%esp)
f01006d9:	e8 cc 02 00 00       	call   f01009aa <cprintf>
	cprintf("  edata  %08x (virt)  %08x (phys)\n", edata, edata - KERNBASE);
f01006de:	c7 44 24 08 00 23 11 	movl   $0x112300,0x8(%esp)
f01006e5:	00 
f01006e6:	c7 44 24 04 00 23 11 	movl   $0xf0112300,0x4(%esp)
f01006ed:	f0 
f01006ee:	c7 04 24 58 1e 10 f0 	movl   $0xf0101e58,(%esp)
f01006f5:	e8 b0 02 00 00       	call   f01009aa <cprintf>
	cprintf("  end    %08x (virt)  %08x (phys)\n", end, end - KERNBASE);
f01006fa:	c7 44 24 08 44 29 11 	movl   $0x112944,0x8(%esp)
f0100701:	00 
f0100702:	c7 44 24 04 44 29 11 	movl   $0xf0112944,0x4(%esp)
f0100709:	f0 
f010070a:	c7 04 24 7c 1e 10 f0 	movl   $0xf0101e7c,(%esp)
f0100711:	e8 94 02 00 00       	call   f01009aa <cprintf>
...
f0100737:	c7 04 24 a0 1e 10 f0 	movl   $0xf0101ea0,(%esp)
f010073e:	e8 67 02 00 00       	call   f01009aa <cprintf>
		ROUNDUP(end - entry, 1024) / 1024);
	return 0;
}
...
f0100752:	bb 84 1f 10 f0       	mov    $0xf0101f84,%ebx
...
int
mon_help(int argc, char **argv, struct Trapframe *tf)
f0100757:	be a8 1f 10 f0       	mov    $0xf0101fa8,%esi
{
	int i;
...
f0100770:	e8 35 02 00 00       	call   f01009aa <cprintf>
...
f010078e:	83 ec 5c             	sub    $0x5c,%esp
	// Your code here.
	int i;
	uint32_t eip;
	uint32_t* ebp = (uint32_t*)read_ebp();
f0100791:	89 ee                	mov    %ebp,%esi
	cprintf("Stack backtrace:\n");
f0100793:	c7 04 24 32 1d 10 f0 	movl   $0xf0101d32,(%esp)
f010079a:	e8 0b 02 00 00       	call   f01009aa <cprintf>
	while(ebp)
f010079f:	eb 7f                	jmp    f0100820 <mon_backtrace+0x98>
	{
		eip = *(ebp + 1);
f01007a1:	8b 46 04             	mov    0x4(%esi),%eax
f01007a4:	89 45 c4             	mov    %eax,-0x3c(%ebp)
		cprintf("  ebp %x  eip %x  args ",ebp,eip);
f01007a7:	89 44 24 08          	mov    %eax,0x8(%esp)
f01007ab:	89 74 24 04          	mov    %esi,0x4(%esp)
f01007af:	c7 04 24 44 1d 10 f0 	movl   $0xf0101d44,(%esp)
f01007b6:	e8 ef 01 00 00       	call   f01009aa <cprintf>
		uint32_t* args = ebp+2;
f01007bb:	8d 5e 08             	lea    0x8(%esi),%ebx
		ROUNDUP(end - entry, 1024) / 1024);
	return 0;
}
...
int
mon_backtrace(int argc, char **argv, struct Trapframe *tf)
f01007be:	8d 7e 1c             	lea    0x1c(%esi),%edi
		cprintf("  ebp %x  eip %x  args ",ebp,eip);
		uint32_t* args = ebp+2;
		for (i=0; i<5;i++)
		{
			...
			cprintf(" %08x",arg);
f01007c1:	8b 03                	mov    (%ebx),%eax
f01007c3:	89 44 24 04          	mov    %eax,0x4(%esp)
f01007c7:	c7 04 24 5c 1d 10 f0 	movl   $0xf0101d5c,(%esp)
f01007ce:	e8 d7 01 00 00       	call   f01009aa <cprintf>
f01007d3:	83 c3 04             	add    $0x4,%ebx
	while(ebp)
	{
		eip = *(ebp + 1);
		cprintf("  ebp %x  eip %x  args ",ebp,eip);
		uint32_t* args = ebp+2;
		for (i=0; i<5;i++)
f01007d6:	39 fb                	cmp    %edi,%ebx
f01007d8:	75 e7                	jne    f01007c1 <mon_backtrace+0x39>
		{
			uint32_t arg = args[i];//parameters
			cprintf(" %08x",arg);
		}
...
f01007da:	8d 45 d0             	lea    -0x30(%ebp),%eax
f01007dd:	89 44 24 04          	mov    %eax,0x4(%esp)
f01007e1:	8b 45 c4             	mov    -0x3c(%ebp),%eax
f01007e4:	89 04 24             	mov    %eax,(%esp)
f01007e7:	e8 b5 02 00 00       	call   f0100aa1 <debuginfo_eip>
		cprintf("\t%s:%d: %.*s+%d\n",info.eip_file,info.eip_line,info.eip_fn_namelen,info.eip_fn_name,eip-info.eip_fn_addr);
f01007ec:	8b 45 c4             	mov    -0x3c(%ebp),%eax
f01007ef:	2b 45 e0             	sub    -0x20(%ebp),%eax
f01007f2:	89 44 24 14          	mov    %eax,0x14(%esp)
f01007f6:	8b 45 d8             	mov    -0x28(%ebp),%eax
f01007f9:	89 44 24 10          	mov    %eax,0x10(%esp)
f01007fd:	8b 45 dc             	mov    -0x24(%ebp),%eax
f0100800:	89 44 24 0c          	mov    %eax,0xc(%esp)
f0100804:	8b 45 d4             	mov    -0x2c(%ebp),%eax
f0100807:	89 44 24 08          	mov    %eax,0x8(%esp)
f010080b:	8b 45 d0             	mov    -0x30(%ebp),%eax
f010080e:	89 44 24 04          	mov    %eax,0x4(%esp)
f0100812:	c7 04 24 62 1d 10 f0 	movl   $0xf0101d62,(%esp)
f0100819:	e8 8c 01 00 00       	call   f01009aa <cprintf>
		ebp = (uint32_t*) *ebp;
f010081e:	8b 36                	mov    (%esi),%esi
	// Your code here.
	int i;
	uint32_t eip;
	uint32_t* ebp = (uint32_t*)read_ebp();
	cprintf("Stack backtrace:\n");
	while(ebp)
f0100820:	85 f6                	test   %esi,%esi
f0100822:	0f 85 79 ff ff ff    	jne    f01007a1 <mon_backtrace+0x19>
		debuginfo_eip(eip,&info);
		cprintf("\t%s:%d: %.*s+%d\n",info.eip_file,info.eip_line,info.eip_fn_namelen,info.eip_fn_name,eip-info.eip_fn_addr);
		ebp = (uint32_t*) *ebp;
	}
...
f010082d:	83 c4 5c             	add    $0x5c,%esp
f0100830:	5b                   	pop    %ebx
f0100831:	5e                   	pop    %esi
f0100832:	5f                   	pop    %edi
f0100833:	5d                   	pop    %ebp
...
f010083e:	c7 04 24 cc 1e 10 f0 	movl   $0xf0101ecc,(%esp)
f0100845:	e8 60 01 00 00       	call   f01009aa <cprintf>
	cprintf("Type 'help' for a list of commands.\n");
f010084a:	c7 04 24 f0 1e 10 f0 	movl   $0xf0101ef0,(%esp)
f0100851:	e8 54 01 00 00       	call   f01009aa <cprintf>


	while (1) {
		buf = readline("K> ");
f0100856:	c7 04 24 73 1d 10 f0 	movl   $0xf0101d73,(%esp)
f010085d:	e8 6e 0a 00 00       	call   f01012d0 <readline>
f0100862:	89 c6                	mov    %eax,%esi
		if (buf != NULL)
...
f0100874:	eb 06                	jmp    f010087c <monitor+0x47>
	argv[argc] = 0;
	while (1) {
		// gobble whitespace
		while (*buf && strchr(WHITESPACE, *buf))
			*buf++ = 0;
f0100876:	c6 06 00             	movb   $0x0,(%esi)
f0100879:	83 c6 01             	add    $0x1,%esi
	// Parse the command buffer into whitespace-separated arguments
	argc = 0;
	argv[argc] = 0;
	while (1) {
		// gobble whitespace
		while (*buf && strchr(WHITESPACE, *buf))
f010087c:	0f b6 06             	movzbl (%esi),%eax
f010087f:	84 c0                	test   %al,%al
f0100881:	74 63                	je     f01008e6 <monitor+0xb1>
f0100883:	0f be c0             	movsbl %al,%eax
f0100886:	89 44 24 04          	mov    %eax,0x4(%esp)
f010088a:	c7 04 24 77 1d 10 f0 	movl   $0xf0101d77,(%esp)
f0100891:	e8 50 0c 00 00       	call   f01014e6 <strchr>
f0100896:	85 c0                	test   %eax,%eax
f0100898:	75 dc                	jne    f0100876 <monitor+0x41>
			*buf++ = 0;
		if (*buf == 0)
f010089a:	80 3e 00             	cmpb   $0x0,(%esi)
f010089d:	74 47                	je     f01008e6 <monitor+0xb1>
			break;

		// save and scan past next arg
		if (argc == MAXARGS-1) {
f010089f:	83 fb 0f             	cmp    $0xf,%ebx
f01008a2:	75 16                	jne    f01008ba <monitor+0x85>
			cprintf("Too many arguments (max %d)\n", MAXARGS);
f01008a4:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
f01008ab:	00 
f01008ac:	c7 04 24 7c 1d 10 f0 	movl   $0xf0101d7c,(%esp)
f01008b3:	e8 f2 00 00 00       	call   f01009aa <cprintf>
f01008b8:	eb 9c                	jmp    f0100856 <monitor+0x21>
			return 0;
		}
		argv[argc++] = buf;
f01008ba:	89 74 9d a8          	mov    %esi,-0x58(%ebp,%ebx,4)
f01008be:	83 c3 01             	add    $0x1,%ebx
f01008c1:	eb 03                	jmp    f01008c6 <monitor+0x91>
		while (*buf && !strchr(WHITESPACE, *buf))
			buf++;
f01008c3:	83 c6 01             	add    $0x1,%esi
		if (argc == MAXARGS-1) {
			cprintf("Too many arguments (max %d)\n", MAXARGS);
			return 0;
		}
		argv[argc++] = buf;
		while (*buf && !strchr(WHITESPACE, *buf))
f01008c6:	0f b6 06             	movzbl (%esi),%eax
f01008c9:	84 c0                	test   %al,%al
f01008cb:	74 af                	je     f010087c <monitor+0x47>
f01008cd:	0f be c0             	movsbl %al,%eax
f01008d0:	89 44 24 04          	mov    %eax,0x4(%esp)
f01008d4:	c7 04 24 77 1d 10 f0 	movl   $0xf0101d77,(%esp)
f01008db:	e8 06 0c 00 00       	call   f01014e6 <strchr>
f01008e0:	85 c0                	test   %eax,%eax
f01008e2:	74 df                	je     f01008c3 <monitor+0x8e>
f01008e4:	eb 96                	jmp    f010087c <monitor+0x47>
			buf++;
	}
	argv[argc] = 0;
f01008e6:	c7 44 9d a8 00 00 00 	movl   $0x0,-0x58(%ebp,%ebx,4)
f01008ed:	00 

	// Lookup and invoke the command
	if (argc == 0)
f01008ee:	85 db                	test   %ebx,%ebx
f01008f0:	0f 84 60 ff ff ff    	je     f0100856 <monitor+0x21>
f01008f6:	bf 80 1f 10 f0       	mov    $0xf0101f80,%edi
f01008fb:	be 00 00 00 00       	mov    $0x0,%esi
		return 0;
	for (i = 0; i < NCOMMANDS; i++) {
		if (strcmp(argv[0], commands[i].name) == 0)
f0100900:	8b 07                	mov    (%edi),%eax
f0100902:	89 44 24 04          	mov    %eax,0x4(%esp)
f0100906:	8b 45 a8             	mov    -0x58(%ebp),%eax
f0100909:	89 04 24             	mov    %eax,(%esp)
f010090c:	e8 77 0b 00 00       	call   f0101488 <strcmp>
f0100911:	85 c0                	test   %eax,%eax
f0100913:	75 24                	jne    f0100939 <monitor+0x104>
			return commands[i].func(argc, argv, tf);
f0100915:	8d 04 76             	lea    (%esi,%esi,2),%eax
f0100918:	8b 55 08             	mov    0x8(%ebp),%edx
f010091b:	89 54 24 08          	mov    %edx,0x8(%esp)
f010091f:	8d 55 a8             	lea    -0x58(%ebp),%edx
f0100922:	89 54 24 04          	mov    %edx,0x4(%esp)
f0100926:	89 1c 24             	mov    %ebx,(%esp)
f0100929:	ff 14 85 88 1f 10 f0 	call   *-0xfefe078(,%eax,4)
...
f0100932:	78 28                	js     f010095c <monitor+0x127>
f0100934:	e9 1d ff ff ff       	jmp    f0100856 <monitor+0x21>
	argv[argc] = 0;
	...
	if (argc == 0)
		return 0;
	for (i = 0; i < NCOMMANDS; i++) {
f0100939:	83 c6 01             	add    $0x1,%esi
f010093c:	83 c7 0c             	add    $0xc,%edi
f010093f:	83 fe 03             	cmp    $0x3,%esi
f0100942:	75 bc                	jne    f0100900 <monitor+0xcb>
		if (strcmp(argv[0], commands[i].name) == 0)
			return commands[i].func(argc, argv, tf);
	}
	cprintf("Unknown command '%s'\n", argv[0]);
f0100944:	8b 45 a8             	mov    -0x58(%ebp),%eax
f0100947:	89 44 24 04          	mov    %eax,0x4(%esp)
f010094b:	c7 04 24 99 1d 10 f0 	movl   $0xf0101d99,(%esp)
f0100952:	e8 53 00 00 00       	call   f01009aa <cprintf>
f0100957:	e9 fa fe ff ff       	jmp    f0100856 <monitor+0x21>
		buf = readline("K> ");
		if (buf != NULL)
			if (runcmd(buf, tf) < 0)
				break;
...
f010095c:	83 c4 5c             	add    $0x5c,%esp
f010095f:	5b                   	pop    %ebx
f0100960:	5e                   	pop    %esi
f0100961:	5f                   	pop    %edi
f0100962:	5d                   	pop    %ebp
...
f0100967:	83 ec 18             	sub    $0x18,%esp
	cputchar(ch);
f010096a:	8b 45 08             	mov    0x8(%ebp),%eax
f010096d:	89 04 24             	mov    %eax,(%esp)
f0100970:	e8 da fc ff ff       	call   f010064f <cputchar>
	*cnt++;
}
f0100975:	c9                   	leave  
f0100976:	c3                   	ret    
...
f010097a:	83 ec 28             	sub    $0x28,%esp
	int cnt = 0;
f010097d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	vprintfmt((void*)putch, &cnt, fmt, ap);
f0100984:	8b 45 0c             	mov    0xc(%ebp),%eax
f0100987:	89 44 24 0c          	mov    %eax,0xc(%esp)
f010098b:	8b 45 08             	mov    0x8(%ebp),%eax
f010098e:	89 44 24 08          	mov    %eax,0x8(%esp)
f0100992:	8d 45 f4             	lea    -0xc(%ebp),%eax
f0100995:	89 44 24 04          	mov    %eax,0x4(%esp)
f0100999:	c7 04 24 64 09 10 f0 	movl   $0xf0100964,(%esp)
f01009a0:	e8 b0 04 00 00       	call   f0100e55 <vprintfmt>
	return cnt;
}
f01009a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
f01009a8:	c9                   	leave  
f01009a9:	c3                   	ret    
...
f01009ad:	83 ec 18             	sub    $0x18,%esp
	va_list ap;
	int cnt;

	va_start(ap, fmt);
f01009b0:	8d 45 0c             	lea    0xc(%ebp),%eax
	cnt = vcprintf(fmt, ap);
f01009b3:	89 44 24 04          	mov    %eax,0x4(%esp)
f01009b7:	8b 45 08             	mov    0x8(%ebp),%eax
f01009ba:	89 04 24             	mov    %eax,(%esp)
f01009bd:	e8 b5 ff ff ff       	call   f0100977 <vcprintf>
	va_end(ap);
...
f01009cf:	89 55 e8             	mov    %edx,-0x18(%ebp)
f01009d2:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
f01009d5:	8b 7d 08             	mov    0x8(%ebp),%edi
	int l = *region_left, r = *region_right, any_matches = 0;
f01009d8:	8b 1a                	mov    (%edx),%ebx
f01009da:	8b 09                	mov    (%ecx),%ecx
f01009dc:	89 4d f0             	mov    %ecx,-0x10(%ebp)
f01009df:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)

	while (l <= r) {
f01009e6:	eb 77                	jmp    f0100a5f <stab_binsearch+0x9b>
		int true_m = (l + r) / 2, m = true_m;
f01009e8:	8b 45 f0             	mov    -0x10(%ebp),%eax
f01009eb:	01 d8                	add    %ebx,%eax
f01009ed:	b9 02 00 00 00       	mov    $0x2,%ecx
f01009f2:	99                   	cltd   
f01009f3:	f7 f9                	idiv   %ecx
f01009f5:	89 c1                	mov    %eax,%ecx

		// search for earliest stab with right type
		while (m >= l && stabs[m].n_type != type)
f01009f7:	eb 01                	jmp    f01009fa <stab_binsearch+0x36>
			m--;
f01009f9:	49                   	dec    %ecx
	...
	while (l <= r) {
		...
		// search for earliest stab with right type
		while (m >= l && stabs[m].n_type != type)
f01009fa:	39 d9                	cmp    %ebx,%ecx
f01009fc:	7c 1d                	jl     f0100a1b <stab_binsearch+0x57>
//		left = 0, right = 657;
...
static void
stab_binsearch(const struct Stab *stabs, int *region_left, int *region_right,
f01009fe:	6b d1 0c             	imul   $0xc,%ecx,%edx
	...
	while (l <= r) {
		...
		// search for earliest stab with right type
		while (m >= l && stabs[m].n_type != type)
f0100a01:	0f b6 54 16 04       	movzbl 0x4(%esi,%edx,1),%edx
f0100a06:	39 fa                	cmp    %edi,%edx
f0100a08:	75 ef                	jne    f01009f9 <stab_binsearch+0x35>
f0100a0a:	89 4d ec             	mov    %ecx,-0x14(%ebp)
			continue;
		}
...
f0100a0d:	6b d1 0c             	imul   $0xc,%ecx,%edx
f0100a10:	8b 54 16 08          	mov    0x8(%esi,%edx,1),%edx
f0100a14:	3b 55 0c             	cmp    0xc(%ebp),%edx
f0100a17:	73 18                	jae    f0100a31 <stab_binsearch+0x6d>
f0100a19:	eb 05                	jmp    f0100a20 <stab_binsearch+0x5c>
		...
		if (m < l) {	// no match in [l, m]
			l = true_m + 1;
f0100a1b:	8d 58 01             	lea    0x1(%eax),%ebx
			continue;
f0100a1e:	eb 3f                	jmp    f0100a5f <stab_binsearch+0x9b>
		}
...
f0100a23:	89 0a                	mov    %ecx,(%edx)
			l = true_m + 1;
f0100a25:	8d 58 01             	lea    0x1(%eax),%ebx
			l = true_m + 1;
			continue;
		}
		...
		// actual binary search
		any_matches = 1;
f0100a28:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
f0100a2f:	eb 2e                	jmp    f0100a5f <stab_binsearch+0x9b>
		if (stabs[m].n_value < addr) {
			*region_left = m;
			l = true_m + 1;
		} else if (stabs[m].n_value > addr) {
f0100a31:	39 55 0c             	cmp    %edx,0xc(%ebp)
f0100a34:	73 15                	jae    f0100a4b <stab_binsearch+0x87>
			*region_right = m - 1;
f0100a36:	8b 4d ec             	mov    -0x14(%ebp),%ecx
f0100a39:	49                   	dec    %ecx
f0100a3a:	89 4d f0             	mov    %ecx,-0x10(%ebp)
f0100a3d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0100a40:	89 08                	mov    %ecx,(%eax)
			l = true_m + 1;
			continue;
		}
		...
		// actual binary search
		any_matches = 1;
f0100a42:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
f0100a49:	eb 14                	jmp    f0100a5f <stab_binsearch+0x9b>
			*region_right = m - 1;
			r = m - 1;
		} else {
...
f0100a4e:	8b 55 e8             	mov    -0x18(%ebp),%edx
f0100a51:	89 02                	mov    %eax,(%edx)
			l = m;
			addr++;
f0100a53:	ff 45 0c             	incl   0xc(%ebp)
f0100a56:	89 cb                	mov    %ecx,%ebx
			l = true_m + 1;
			continue;
		}
	       ...
	       int type, uintptr_t addr)
{
	...
	while (l <= r) {
f0100a5f:	3b 5d f0             	cmp    -0x10(%ebp),%ebx
f0100a62:	7e 84                	jle    f01009e8 <stab_binsearch+0x24>
			l = m;
			addr++;
		}
	}
	...
	if (!any_matches)
f0100a64:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
f0100a68:	75 0d                	jne    f0100a77 <stab_binsearch+0xb3>
		*region_right = *region_left - 1;
f0100a6a:	8b 55 e8             	mov    -0x18(%ebp),%edx
f0100a6d:	8b 02                	mov    (%edx),%eax
f0100a6f:	48                   	dec    %eax
f0100a70:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
f0100a73:	89 01                	mov    %eax,(%ecx)
f0100a75:	eb 22                	jmp    f0100a99 <stab_binsearch+0xd5>
	else {
		// find rightmost region containing 'addr'
		for (l = *region_right;
f0100a77:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
f0100a7a:	8b 01                	mov    (%ecx),%eax
		     l > *region_left && stabs[l].n_type != type;
f0100a7c:	8b 55 e8             	mov    -0x18(%ebp),%edx
f0100a7f:	8b 0a                	mov    (%edx),%ecx
	...
	if (!any_matches)
		*region_right = *region_left - 1;
		...
		// find rightmost region containing 'addr'
		for (l = *region_right;
f0100a81:	eb 01                	jmp    f0100a84 <stab_binsearch+0xc0>
		     l > *region_left && stabs[l].n_type != type;
		     l--)
f0100a83:	48                   	dec    %eax
	...
	if (!any_matches)
		*region_right = *region_left - 1;
		...
		// find rightmost region containing 'addr'
		for (l = *region_right;
f0100a84:	39 c1                	cmp    %eax,%ecx
f0100a86:	7d 0c                	jge    f0100a94 <stab_binsearch+0xd0>
//		left = 0, right = 657;
//		stab_binsearch(stabs, &left, &right, N_SO, 0xf0100184);
//	will exit setting left = 118, right = 554.
//
static void
stab_binsearch(const struct Stab *stabs, int *region_left, int *region_right,
f0100a88:	6b d0 0c             	imul   $0xc,%eax,%edx
	if (!any_matches)
		*region_right = *region_left - 1;
	else {
		// find rightmost region containing 'addr'
		for (l = *region_right;
		     l > *region_left && stabs[l].n_type != type;
f0100a8b:	0f b6 54 16 04       	movzbl 0x4(%esi,%edx,1),%edx
f0100a90:	39 fa                	cmp    %edi,%edx
f0100a92:	75 ef                	jne    f0100a83 <stab_binsearch+0xbf>
		     l--)
			/* do nothing */;
		*region_left = l;
f0100a94:	8b 55 e8             	mov    -0x18(%ebp),%edx
f0100a97:	89 02                	mov    %eax,(%edx)
	}
}
...
f0100aa4:	83 ec 58             	sub    $0x58,%esp
f0100aa7:	89 5d f4             	mov    %ebx,-0xc(%ebp)
f0100aaa:	89 75 f8             	mov    %esi,-0x8(%ebp)
f0100aad:	89 7d fc             	mov    %edi,-0x4(%ebp)
f0100ab0:	8b 75 08             	mov    0x8(%ebp),%esi
f0100ab3:	8b 5d 0c             	mov    0xc(%ebp),%ebx
...
f0100ab6:	c7 03 a4 1f 10 f0    	movl   $0xf0101fa4,(%ebx)
	info->eip_line = 0;
f0100abc:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
	info->eip_fn_name = "<unknown>";
f0100ac3:	c7 43 08 a4 1f 10 f0 	movl   $0xf0101fa4,0x8(%ebx)
	info->eip_fn_namelen = 9;
f0100aca:	c7 43 0c 09 00 00 00 	movl   $0x9,0xc(%ebx)
	info->eip_fn_addr = addr;
f0100ad1:	89 73 10             	mov    %esi,0x10(%ebx)
	info->eip_fn_narg = 0;
f0100ad4:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)

	// Find the relevant set of stabs
	if (addr >= ULIM) {
f0100adb:	81 fe ff ff 7f ef    	cmp    $0xef7fffff,%esi
f0100ae1:	76 12                	jbe    f0100af5 <debuginfo_eip+0x54>
...
f0100ae3:	b8 00 77 10 f0       	mov    $0xf0107700,%eax
f0100ae8:	3d b5 5d 10 f0       	cmp    $0xf0105db5,%eax
f0100aed:	0f 86 ca 01 00 00    	jbe    f0100cbd <debuginfo_eip+0x21c>
f0100af3:	eb 1c                	jmp    f0100b11 <debuginfo_eip+0x70>
		...
		// Can't search for user-level addresses yet!
  	        panic("User address");
f0100af5:	c7 44 24 08 ae 1f 10 	movl   $0xf0101fae,0x8(%esp)
f0100afc:	f0 
f0100afd:	c7 44 24 04 7f 00 00 	movl   $0x7f,0x4(%esp)
f0100b04:	00 
f0100b05:	c7 04 24 bb 1f 10 f0 	movl   $0xf0101fbb,(%esp)
f0100b0c:	e8 e7 f5 ff ff       	call   f01000f8 <_panic>
	}

	// String table validity checks
	if (stabstr_end <= stabstr || stabstr_end[-1] != 0)
f0100b11:	80 3d ff 76 10 f0 00 	cmpb   $0x0,0xf01076ff
f0100b18:	0f 85 a6 01 00 00    	jne    f0100cc4 <debuginfo_eip+0x223>
	...
	lfile = 0;
f0100b1e:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	rfile = (stab_end - stabs) - 1;
f0100b25:	b8 b4 5d 10 f0       	mov    $0xf0105db4,%eax
f0100b2a:	2d f0 21 10 f0       	sub    $0xf01021f0,%eax
f0100b2f:	c1 f8 02             	sar    $0x2,%eax
f0100b32:	69 c0 ab aa aa aa    	imul   $0xaaaaaaab,%eax,%eax
f0100b38:	83 e8 01             	sub    $0x1,%eax
f0100b3b:	89 45 e0             	mov    %eax,-0x20(%ebp)
	stab_binsearch(stabs, &lfile, &rfile, N_SO, addr);
f0100b3e:	89 74 24 04          	mov    %esi,0x4(%esp)
f0100b42:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
f0100b49:	8d 4d e0             	lea    -0x20(%ebp),%ecx
f0100b4c:	8d 55 e4             	lea    -0x1c(%ebp),%edx
f0100b4f:	b8 f0 21 10 f0       	mov    $0xf01021f0,%eax
f0100b54:	e8 6b fe ff ff       	call   f01009c4 <stab_binsearch>
	if (lfile == 0)
f0100b59:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0100b5c:	85 c0                	test   %eax,%eax
f0100b5e:	0f 84 67 01 00 00    	je     f0100ccb <debuginfo_eip+0x22a>
		return -1;

	// Search within that file's stabs for the function definition
	// (N_FUN).
	lfun = lfile;
f0100b64:	89 45 dc             	mov    %eax,-0x24(%ebp)
	rfun = rfile;
f0100b67:	8b 45 e0             	mov    -0x20(%ebp),%eax
f0100b6a:	89 45 d8             	mov    %eax,-0x28(%ebp)
	stab_binsearch(stabs, &lfun, &rfun, N_FUN, addr);
f0100b6d:	89 74 24 04          	mov    %esi,0x4(%esp)
f0100b71:	c7 04 24 24 00 00 00 	movl   $0x24,(%esp)
f0100b78:	8d 4d d8             	lea    -0x28(%ebp),%ecx
f0100b7b:	8d 55 dc             	lea    -0x24(%ebp),%edx
f0100b7e:	b8 f0 21 10 f0       	mov    $0xf01021f0,%eax
f0100b83:	e8 3c fe ff ff       	call   f01009c4 <stab_binsearch>

	if (lfun <= rfun) {
f0100b88:	8b 45 dc             	mov    -0x24(%ebp),%eax
f0100b8b:	8b 55 d8             	mov    -0x28(%ebp),%edx
f0100b8e:	39 d0                	cmp    %edx,%eax
f0100b90:	7f 3d                	jg     f0100bcf <debuginfo_eip+0x12e>
		// stabs[lfun] points to the function name
		// in the string table, but check bounds just in case.
		if (stabs[lfun].n_strx < stabstr_end - stabstr)
f0100b92:	6b c8 0c             	imul   $0xc,%eax,%ecx
f0100b95:	8d b9 f0 21 10 f0    	lea    -0xfefde10(%ecx),%edi
f0100b9b:	89 7d c4             	mov    %edi,-0x3c(%ebp)
f0100b9e:	8b 89 f0 21 10 f0    	mov    -0xfefde10(%ecx),%ecx
f0100ba4:	bf 00 77 10 f0       	mov    $0xf0107700,%edi
f0100ba9:	81 ef b5 5d 10 f0    	sub    $0xf0105db5,%edi
f0100baf:	39 f9                	cmp    %edi,%ecx
f0100bb1:	73 09                	jae    f0100bbc <debuginfo_eip+0x11b>
			info->eip_fn_name = stabstr + stabs[lfun].n_strx;
f0100bb3:	81 c1 b5 5d 10 f0    	add    $0xf0105db5,%ecx
f0100bb9:	89 4b 08             	mov    %ecx,0x8(%ebx)
		info->eip_fn_addr = stabs[lfun].n_value;
f0100bbc:	8b 7d c4             	mov    -0x3c(%ebp),%edi
f0100bbf:	8b 4f 08             	mov    0x8(%edi),%ecx
f0100bc2:	89 4b 10             	mov    %ecx,0x10(%ebx)
		addr -= info->eip_fn_addr;
f0100bc5:	29 ce                	sub    %ecx,%esi
		// Search within the function definition for the line number.
		lline = lfun;
f0100bc7:	89 45 d4             	mov    %eax,-0x2c(%ebp)
		rline = rfun;
f0100bca:	89 55 d0             	mov    %edx,-0x30(%ebp)
f0100bcd:	eb 0f                	jmp    f0100bde <debuginfo_eip+0x13d>
	} else {
		// Couldn't find function stab!  Maybe we're in an assembly
		// file.  Search the whole file for the line number.
		info->eip_fn_addr = addr;
f0100bcf:	89 73 10             	mov    %esi,0x10(%ebx)
		lline = lfile;
f0100bd2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0100bd5:	89 45 d4             	mov    %eax,-0x2c(%ebp)
		rline = rfile;
f0100bd8:	8b 45 e0             	mov    -0x20(%ebp),%eax
f0100bdb:	89 45 d0             	mov    %eax,-0x30(%ebp)
	}
	// Ignore stuff after the colon.
	info->eip_fn_namelen = strfind(info->eip_fn_name, ':') - info->eip_fn_name;
f0100bde:	c7 44 24 04 3a 00 00 	movl   $0x3a,0x4(%esp)
f0100be5:	00 
f0100be6:	8b 43 08             	mov    0x8(%ebx),%eax
f0100be9:	89 04 24             	mov    %eax,(%esp)
f0100bec:	e8 16 09 00 00       	call   f0101507 <strfind>
f0100bf1:	2b 43 08             	sub    0x8(%ebx),%eax
f0100bf4:	89 43 0c             	mov    %eax,0xc(%ebx)
	// Hint:
...
f0100bf7:	89 74 24 04          	mov    %esi,0x4(%esp)
f0100bfb:	c7 04 24 44 00 00 00 	movl   $0x44,(%esp)
f0100c02:	8d 4d d0             	lea    -0x30(%ebp),%ecx
f0100c05:	8d 55 d4             	lea    -0x2c(%ebp),%edx
f0100c08:	b8 f0 21 10 f0       	mov    $0xf01021f0,%eax
f0100c0d:	e8 b2 fd ff ff       	call   f01009c4 <stab_binsearch>
	if (lline <= rline) {
f0100c12:	8b 45 d4             	mov    -0x2c(%ebp),%eax
f0100c15:	3b 45 d0             	cmp    -0x30(%ebp),%eax
f0100c18:	0f 8f b4 00 00 00    	jg     f0100cd2 <debuginfo_eip+0x231>
		info->eip_line = stabs[lline].n_desc;
f0100c1e:	6b c0 0c             	imul   $0xc,%eax,%eax
f0100c21:	0f b7 80 f6 21 10 f0 	movzwl -0xfefde0a(%eax),%eax
f0100c28:	89 43 04             	mov    %eax,0x4(%ebx)
...
f0100c2e:	89 45 c4             	mov    %eax,-0x3c(%ebp)
...
int
debuginfo_eip(uintptr_t addr, struct Eipdebuginfo *info)
f0100c34:	6b d0 0c             	imul   $0xc,%eax,%edx
f0100c37:	81 c2 f0 21 10 f0    	add    $0xf01021f0,%edx
	// Search backwards from the line number for the relevant filename
	// stab.
	// We can't just use the "lfile" stab because inlined functions
	// can interpolate code from a different file!
	// Such included source files use the N_SOL stab type.
	while (lline >= lfile
f0100c3d:	eb 06                	jmp    f0100c45 <debuginfo_eip+0x1a4>
f0100c3f:	83 e8 01             	sub    $0x1,%eax
f0100c42:	83 ea 0c             	sub    $0xc,%edx
f0100c45:	89 c6                	mov    %eax,%esi
f0100c47:	39 45 c4             	cmp    %eax,-0x3c(%ebp)
f0100c4a:	7f 33                	jg     f0100c7f <debuginfo_eip+0x1de>
	       && stabs[lline].n_type != N_SOL
f0100c4c:	0f b6 4a 04          	movzbl 0x4(%edx),%ecx
f0100c50:	80 f9 84             	cmp    $0x84,%cl
f0100c53:	74 0b                	je     f0100c60 <debuginfo_eip+0x1bf>
	       && (stabs[lline].n_type != N_SO || !stabs[lline].n_value))
f0100c55:	80 f9 64             	cmp    $0x64,%cl
f0100c58:	75 e5                	jne    f0100c3f <debuginfo_eip+0x19e>
f0100c5a:	83 7a 08 00          	cmpl   $0x0,0x8(%edx)
f0100c5e:	74 df                	je     f0100c3f <debuginfo_eip+0x19e>
		lline--;
	if (lline >= lfile && stabs[lline].n_strx < stabstr_end - stabstr)
f0100c60:	6b f6 0c             	imul   $0xc,%esi,%esi
f0100c63:	8b 86 f0 21 10 f0    	mov    -0xfefde10(%esi),%eax
f0100c69:	ba 00 77 10 f0       	mov    $0xf0107700,%edx
f0100c6e:	81 ea b5 5d 10 f0    	sub    $0xf0105db5,%edx
f0100c74:	39 d0                	cmp    %edx,%eax
f0100c76:	73 07                	jae    f0100c7f <debuginfo_eip+0x1de>
		info->eip_file = stabstr + stabs[lline].n_strx;
f0100c78:	05 b5 5d 10 f0       	add    $0xf0105db5,%eax
f0100c7d:	89 03                	mov    %eax,(%ebx)


	// Set eip_fn_narg to the number of arguments taken by the function,
	// or 0 if there was no containing function.
	if (lfun < rfun)
f0100c7f:	8b 55 dc             	mov    -0x24(%ebp),%edx
f0100c82:	8b 4d d8             	mov    -0x28(%ebp),%ecx
		for (lline = lfun + 1;
	...
	return 0;
f0100c85:	b8 00 00 00 00       	mov    $0x0,%eax
		info->eip_file = stabstr + stabs[lline].n_strx;
	...
	// or 0 if there was no containing function.
	if (lfun < rfun)
f0100c8a:	39 ca                	cmp    %ecx,%edx
f0100c8c:	7d 50                	jge    f0100cde <debuginfo_eip+0x23d>
		for (lline = lfun + 1;
f0100c8e:	8d 42 01             	lea    0x1(%edx),%eax
f0100c91:	89 c2                	mov    %eax,%edx
//	instruction address, 'addr'.  Returns 0 if information was found, and
//	negative if not.  But even if it returns negative it has stored some
//	information into '*info'.
//
int
debuginfo_eip(uintptr_t addr, struct Eipdebuginfo *info)
f0100c93:	6b c0 0c             	imul   $0xc,%eax,%eax
f0100c96:	05 f0 21 10 f0       	add    $0xf01021f0,%eax
f0100c9b:	89 ce                	mov    %ecx,%esi
	...
	if (lfun < rfun)
		for (lline = lfun + 1;
f0100c9d:	eb 04                	jmp    f0100ca3 <debuginfo_eip+0x202>
		     lline < rfun && stabs[lline].n_type == N_PSYM;
		     lline++)
			info->eip_fn_narg++;
f0100c9f:	83 43 14 01          	addl   $0x1,0x14(%ebx)
...
f0100ca5:	7e 32                	jle    f0100cd9 <debuginfo_eip+0x238>
		     lline < rfun && stabs[lline].n_type == N_PSYM;
f0100ca7:	0f b6 48 04          	movzbl 0x4(%eax),%ecx
f0100cab:	83 c2 01             	add    $0x1,%edx
f0100cae:	83 c0 0c             	add    $0xc,%eax
f0100cb1:	80 f9 a0             	cmp    $0xa0,%cl
f0100cb4:	74 e9                	je     f0100c9f <debuginfo_eip+0x1fe>
		     lline++)
			info->eip_fn_narg++;

	return 0;
f0100cb6:	b8 00 00 00 00       	mov    $0x0,%eax
f0100cbb:	eb 21                	jmp    f0100cde <debuginfo_eip+0x23d>
  	        panic("User address");
	}
...
f0100cc2:	eb 1a                	jmp    f0100cde <debuginfo_eip+0x23d>
f0100cc4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
f0100cc9:	eb 13                	jmp    f0100cde <debuginfo_eip+0x23d>
	// Search the entire set of stabs for the source file (type N_SO).
	lfile = 0;
	rfile = (stab_end - stabs) - 1;
	stab_binsearch(stabs, &lfile, &rfile, N_SO, addr);
...
f0100cd0:	eb 0c                	jmp    f0100cde <debuginfo_eip+0x23d>
	// Your code here.
	stab_binsearch(stabs , &lline , &rline , N_SLINE , addr);
	if (lline <= rline) {
		info->eip_line = stabs[lline].n_desc;
...
f0100cd7:	eb 05                	jmp    f0100cde <debuginfo_eip+0x23d>
		for (lline = lfun + 1;
		     lline < rfun && stabs[lline].n_type == N_PSYM;
		     lline++)
			info->eip_fn_narg++;
...
f0100cde:	8b 5d f4             	mov    -0xc(%ebp),%ebx
f0100ce1:	8b 75 f8             	mov    -0x8(%ebp),%esi
f0100ce4:	8b 7d fc             	mov    -0x4(%ebp),%edi
f0100ce7:	89 ec                	mov    %ebp,%esp
f0100ce9:	5d                   	pop    %ebp
f0100cea:	c3                   	ret    
...
f0100dbf:	0f be 80 c9 1f 10 f0 	movsbl -0xfefe037(%eax),%eax
...
f0100eeb:	ff 24 8d 60 20 10 f0 	jmp    *-0xfefdfa0(,%ecx,4)
...
f0100fc9:	c7 44 24 08 ea 1f 10 	movl   $0xf0101fea,0x8(%esp)
f0100fd0:	f0 
...
f0100ffb:	b8 da 1f 10 f0       	mov    $0xf0101fda,%eax
...
f01012eb:	e8 ba f6 ff ff       	call   f01009aa <cprintf>
...
f0101312:	c7 04 24 e0 21 10 f0 	movl   $0xf01021e0,(%esp)
f0101319:	e8 8c f6 ff ff       	call   f01009aa <cprintf>
			return NULL;
